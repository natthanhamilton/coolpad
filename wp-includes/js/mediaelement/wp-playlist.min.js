!function (a, b, c) {
    ...
    var d = c.View.extend({
        ...
        renderTracks: function () {
            var b = this, c = 1, d = a('<div class="wp-playlist-tracks"></div>');
            this.tracks.each(function (a) {
                b.data.images || a.set("image", !1), a.set("artists", b.data.artists), a.set("index", b.data.tracknumbers ? c : !1), d.append(b.itemTemplate(a.toJSON())), c += 1
        ...
        loadCurrent: function () {
            var a = this.playerNode.attr("src") && this.playerNode.attr("src").split(".").pop(), b = this.current.get("src").split(".").pop();
    ...
    a(document).ready(function () {
        a(".wp-playlist").each(function () {
            return new d({el: this})
        })
    }), window.WPPlaylistView = d
}(jQuery, _, Backbone);