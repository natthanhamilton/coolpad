...
!function (e, t) {
    ...
    r(l, [], function () {
        ...
        x = e.support = {}, N = e.isXML = function (e) {
            ...
            return r !== D && 9 === r.nodeType && r.documentElement ? (D = r, M = r.documentElement, L = !N(r), o && o !== t(o) && (o.addEventListener ? o.addEventListener("unload", function () {
                B()
        ...
        return function (r) {
            ...
            var M, L, P, H = {state: {}, exec: {}, value: {}}, O = r.settings, I;
            r.on("PreInit", function () {
                M = r.dom, L = r.selection, O = r.settings, P = r.formatter
            }), d(this, {
                execCommand: c,
                queryCommandState: C,
                queryCommandValue: x,
                ...
                "mceResetDesignMode,mceBeginUndoLevel": function () {
                    ...
                    var t, n;
                    T(e), t = M.getParent(L.getNode(), "ol,ul"), t && (n = t.parentNode, /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (B(), M.split(n, t), D()))
                    ...
                    var e = L.getBookmark();
                    r.setContent(r.getContent({cleanup: v}), {cleanup: v}), L.moveToBookmark(e)
                }, mceRemoveNode: function (e, t, n) {
                    var i = n || L.getNode();
                    i != r.getBody() && (B(), r.dom.remove(i, v), D())
                }, mceSelectNodeDepth: function (e, t, n) {
                    var i = 0;
                    M.getParent(L.getNode(), function (e) {
                        return 1 == e.nodeType && i++ == n ? (L.select(e), y) : void 0
                    }, r.getBody())
                    ...
                    function c() {
                        var e, t, n;
                        e = L.getRng(!0), t = e.startContainer, n = e.startOffset, 3 == t.nodeType && e.collapsed && ("\xa0" === t.data[n] ? (t.deleteData(n, 1), /[\u00a0| ]$/.test(o) || (o += " ")) : "\xa0" === t.data[n - 1] && (t.deleteData(n - 1, 1), /[\u00a0| ]$/.test(o) || (o = " " + o)))
                    }
                    ...
                    function f() {
                        if (T) {
                            var e = r.getBody(), t = new i(M);
                            u(M.select("*[data-mce-new]"), function (n) {
                                n.removeAttribute("data-mce-new");
                                for (var r = n.parentNode; r && r != e; r = r.parentNode)t.compare(r, n) && M.remove(n, !0)
                            })
                        }
                    }
                    ...
                    function p(e) {
                        ...
                        var i, o, a;
                        if (e) {
                            if (L.scrollIntoView(e), i = t(e))return M.remove(e), void L.select(i);
                            N = M.createRng(), _ = e.previousSibling, _ && 3 == _.nodeType ? (N.setStart(_, _.nodeValue.length), m || (S = e.nextSibling, S && 3 == S.nodeType && (_.appendData(S.data), S.parentNode.removeChild(S)))) : (N.setStartBefore(e), N.setEndBefore(e)), o = M.getParent(e, M.isBlock), M.remove(e), o && M.isEmpty(o) && (r.$(o).empty(), N.setStart(o, 0), N.setEnd(o, 0),
                                !b(o) && (a = n(N)) ? (N = a, M.remove(o)) : M.add(o, M.create("br", {"data-mce-bogus": "1"}))), L.setRng(N)
                        }
                    }
                    ...
                    "string" != typeof o && (T = o.merge, R = o.data, o = o.content), /^ | $/.test(o) && (o = a(o)), g = r.parser, v = new e({validate: O.validate}, r.schema), k = '<span id="mce_marker" data-mce-type="bookmark">&#xFEFF;&#x200B;</span>', w = {
                        ...
                        format: "html",
                        selection: !0
                    }, r.fire("BeforeSetContent", w), o = w.content, -1 == o.indexOf("{$caret}") && (o += "{$caret}"), o = o.replace(/\{\$caret\}/, k), N = L.getRng();
                    var B = N.startContainer || (N.parentElement ? N.parentElement() : null), D = r.getBody();
                    B === D && L.isCollapsed() && M.isBlock(D.firstChild) && h(D.firstChild) && M.isEmpty(D.firstChild) && (N = M.createRng(), N.setStart(D.firstChild, 0), N.setEnd(D.firstChild, 0), L.setRng(N)), L.isCollapsed() || (r.selection.setRng(r.selection.getRng()), r.getDoc().execCommand("Delete", !1, null), c()), y = L.getNode();
                    var P = {context: y.nodeName.toLowerCase(), data: R};
                    if (x = g.parse(o, P), d(x), _ = x.lastChild, "mce_marker" == _.attr("id"))for (E = _, _ = _.prev; _; _ = _.walk(!0))if (3 == _.type || !M.isBlock(_.name)) {
                    ...
                    if (r._selectionOverrides.showBlockCaretContainer(y), P.invalid) {
                        for (L.setContent(k), y = L.getNode(), C = r.getBody(), 9 == y.nodeType ? y = _ = C : _ = y; _ !== C;)y = _, _ = _.parentNode;
                        o = y == C ? C.innerHTML : M.getOuterHTML(y), o = v.serialize(g.parse(o.replace(/<span (id="mce_marker"|id=mce_marker).+?<\/span>/i, function () {
                            return v.serialize(x)
                        }))), y == C ? M.setHTML(C, o) : M.setOuterHTML(y, o)
                    } else o = v.serialize(x), _ = y.firstChild, S = y.lastChild, !_ || _ === S && "BR" === _.nodeName ? M.setHTML(y, o) : L.setContent(o);
                    f(), p(M.get("mce_marker")), r.fire("SetContent", w), r.addVisual()
                }, mceInsertRawHTML: function (e, t, n) {
                    L.setContent("tiny_mce_marker"), r.setContent(r.getContent().replace(/tiny_mce_marker/g, function () {
                        return n
                    }))
                    ...
                    var t, n, i;
                    t = O.indentation, n = /[a-z%]+$/i.exec(t), t = parseInt(t, 10), C("InsertUnorderedList") || C("InsertOrderedList") ? T(e) : (O.forced_root_block || M.getParent(L.getNode(), M.isBlock) || P.apply("div"), u(L.getSelectedBlocks(), function (o) {
                        if ("false" !== M.getContentEditable(o) && "LI" != o.nodeName) {
                            var a = r.getParam("indent_use_margin", !1) ? "margin" : "padding";
                            a += "rtl" == M.getStyle(o, "direction", !0) ? "Right" : "Left", "outdent" == e ? (i = Math.max(0, parseInt(o.style[a] || 0, 10) - t), M.setStyle(o, a, i ? i + n : "")) : (i = parseInt(o.style[a] || 0, 10) + t + n, M.setStyle(o, a, i))
                        }
                    }))
                }, mceRepaint: function () {
                    ...
                    r.execCommand("mceInsertContent", !1, n.replace(/\{\$selection\}/g, L.getContent({format: "text"})))
                }, mceInsertLink: function (e, t, n) {
                    var r;
                    "string" == typeof n && (n = {href: n}), r = M.getParent(L.getNode(), "a"), n.href = n.href.replace(" ", "%20"), r && n.href || P.remove("link"), n.href && P.apply("link", n, r)
                }, selectAll: function () {
                    var e = M.getRoot(), t;
                    L.getRng().setStart ? (t = M.createRng(), t.setStart(e, 0), t.setEnd(e, e.childNodes.length), L.setRng(t)) : (t = L.getRng(), t.item || (t.moveToElementText(e), t.select()))
                }, "delete": function () {
                    T("Delete");
                    var e = r.getBody();
                    M.isEmpty(e) && (r.setContent(""), e.firstChild && M.isBlock(e.firstChild) ? r.selection.setCursorLocation(e.firstChild, 0) : r.selection.setCursorLocation(e, 0))
                    ...
                    var m = M.getParent(h, M.isBlock), y = m ? m.nodeName.toUpperCase() : "", b = m ? M.getParent(m.parentNode, M.isBlock) : null, C = b ? b.nodeName.toUpperCase() : "", x = s && s.ctrlKey;
                    "LI" != C || x || (m = b, y = C), h && 3 == h.nodeType && f >= h.nodeValue.length && (g || i() || (l = M.create("br"), d.insertNode(l), d.setStartAfter(l), d.setEndAfter(l), c = !0)), l = M.create("br"), d.insertNode(l);
                    var w = M.doc.documentMode;
                    return g && "PRE" == y && (!w || 8 > w) && l.parentNode.insertBefore(M.doc.createTextNode("\r"), l), u = M.create("span", {}, "&nbsp;"), l.parentNode.insertBefore(u, l), L.scrollIntoView(u), M.remove(u), c ? (d.setStartBefore(l), d.setEndBefore(l)) : (d.setStartAfter(l), d.setEndAfter(l)), L.setRng(d), r.undoManager.add(), v
                }
            }), w({
                "JustifyLeft,JustifyCenter,JustifyRight,JustifyFull": function (e) {
                    var t = "align" + e.substring(7), n = L.isCollapsed() ? [M.getParent(L.getNode(), M.isBlock)] : L.getSelectedBlocks(), r = f(n, function (e) {
                    ...
                    var e;
                    if (O.inline_styles) {
                        if ((e = M.getParent(L.getStart(), M.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0)return v;
                        if ((e = M.getParent(L.getEnd(), M.isBlock)) && parseInt(e.style.paddingLeft, 10) > 0)return v
                    }
                    return C("InsertUnorderedList") || C("InsertOrderedList") || !O.inline_styles && !!M.getParent(L.getNode(), "BLOCKQUOTE")
                }, "InsertUnorderedList,InsertOrderedList": function (e) {
                    var t = M.getParent(L.getNode(), "ul,ol");
                    return t && ("insertunorderedlist" === e && "UL" === t.tagName || "insertorderedlist" === e && "OL" === t.tagName)
                }
            }, "state"), w({
                "FontSize,FontName": function (e) {
                    var t = 0, n;
                    return (n = M.getParent(L.getNode(), "span")) && (t = "fontsize" == e ? n.style.fontSize : n.style.fontFamily.replace(/, /g, ",").replace(/[\'\"]/g, "").toLowerCase()), t
                }
            }, "value"), w({
                Undo: function () {
                    r.undoManager.undo()
        ...
        return function (u) {
            ...
            function v() {
                ...
                w || (E = !0, w = function () {
                    ...
                    this.observe = function (n) {
                        r = n, r.addEventListener("DOMSubtreeModified", e, !1), r.addEventListener("DOMNodeInsertedIntoDocument", e, !1), r.addEventListener("DOMNodeInserted", e, !1),
            ...
            return R(), y(), a.windowsPhone || O(), ae && (v(), C(), E(), D(), $(), S(), q(), a.iOS ? (F(), z(), U()) : b()), oe && a.ie < 11 && (x(), _(), k(), T(), M(), L(), P(), H()), a.ie >= 11 && (z(), S()), a.ie && (b(), V(), j()), ie && (x(), w(), N(), A(), B(), I(), W(), S()), {
        ...
        function y(c) {
            ...
            function H(e, t, n) {
                ...
                if (p = _(n), r = M(e, n), i = t(Q, a.isAboveLine(1), r), o = h.filter(i, a.isLine(1)), c = h.last(r.getClientRects()), N(r) && (p = r.getNode()), E(r) && (p = r.getNode(!0)), !c)return null;
            ...
            function q(e, t, n) {
                var r, i;
                return !n.collapsed && (r = _(n), x(r)) ? U($(r)) : (i = M(e, n), t(i) ? U($(i.getNode(-1 == e))) : void 0)
            }
            ...
            function j() {
                ...
                c.on("mouseup", function () {
                    ...
                    if (ie) {
                        ...
                        t = t.cloneRange(), t.selectNode(ie),
                            e.range = t
                    }
            ...
            function Y() {
                ...
                e.push(ne.getCss()), e.push(t + " .mce-offscreen-selection {position: absolute;left: -9999999999px;width: 100px;height: 100px;}" + t + " *[contentEditable=false] {cursor: default;}" + t + " *[contentEditable=true] {cursor: text;}")
            }
        ...
        return y
    }), r(Ge, [w, g, N, R, A, H, P, Y, J, Q, Z, ee, re, ie, E, d, Te, Me, B, M, Pe, h, m, u, He, Oe, Ie, Ue, Ke], function (e, n, r, i, o, a, s, l, c, u, d, f, h, p, m, g, v, y, b, C, x, w, E, N, _, S, k, T, R) {
        function A(e, t, i) {
            var o = this, a, s, l;
    ...
    }),a([l, c, u, d, f, h, m, g, v, y, C, w, E, N, T, A, B, D, M, L, P, H, I, F, j, Y, J, Q, re, ie, oe, ae, le, ue, de, me, ge, ve, ye, be, Ce, xe, we, Ee, Ne, _e, Se, ke, Te, Re, Ae, Be, De, Me, He, Ie, Ge, Je, Qe, Ze, tt, nt, rt, it, ot, at, st, lt, ct, ut, dt, ft, ht, pt, mt, gt, vt, yt, bt, Ct, xt, wt, Et, Nt, _t, St, kt, Tt, Rt, At, Bt, Dt, Mt, Lt, Pt, Ht, Ot, It, Ft, zt, Wt, Vt, Ut, $t, qt, jt, Yt])
}(this);