!function (a, b, c) {
    "use strict";
    var d = b(a), e = b(document), f = b("#wpadminbar"), g = b("#wpfooter");
    b(function () {
        function c() {
            var a = d.width();
            T = {
        ...
        function j(b) {
            if (!F || !F.settings.visible) {
                var f, h, j, k, l, m, n, o, q, r = d.scrollTop(), G = b && b.type, H = "scroll" !== G, N = p && !p.isHidden(), R = Q, U = E.offset().top, V = 1, W = s.width();
        ...
        function o(b) {
            var e, f = b && b.keyCode;
            return a.navigator.platform && (e = a.navigator.platform.indexOf("Mac") > -1), 27 === f || 87 === f && b.altKey && (!e && b.shiftKey || e && b.ctrlKey) ? void p(b) : void(b && (b.metaKey || b.ctrlKey && !b.altKey || b.altKey && b.shiftKey || f && (47 >= f && 8 !== f && 13 !== f && 32 !== f && 46 !== f || f >= 91 && 93 >= f || f >= 112 && 135 >= f || f >= 144 && 150 >= f || f >= 224)) || (w || (w = !0, clearTimeout(F), F = setTimeout(function () {
                M.show()
        ...
        H.append(M), M.css({
            ...
            left: 0,
            "z-index": 9997
        }), J.css({position: "relative"}), d.on("mousemove.focus", function (a) {
            C = a.pageY
