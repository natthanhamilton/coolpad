...
?>
    ...
    <div class="wrap">
        ...
        {
            echo '<div class="error"><p>' . sprintf(__('ERROR: %s'), $ct->errors()
                                                                        ->get_error_message()) . '</p></div>';
        }
                ...
                <table>
                    ...
                    <?php foreach ($broken_themes as $broken_theme) : ?>
                        <tr>
                            ...
                            <td><?php echo $broken_theme->errors()
                                                        ->get_error_message(); ?></td>
                            <?php
                            if ($can_delete)
                            {
                            ...
                            if ($can_install && 'theme_no_parent' === $broken_theme->errors()
                                                                                   ->get_error_code()
                            )
                            {
