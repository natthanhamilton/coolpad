...
<head>
    ...
    <style>
        ...
        .block-shortcode:hover .block-title a {
            opacity: 1
        }
    </style>
</head>
...
<div class="blocks-header"
     style="position:fixed;left:0;padding:50px 10px; width:160px; top:0; bottom:0; background-color:#eee;z-index:99;">
    <?php
        ...
        while ($wp_query->have_posts()) : $wp_query->the_post();
            ...
            <div class="block-shortcode">
                <div class="block-title">
                    <a href="<?php echo get_edit_post_link(); ?>" class="tip-top"
                       title="Edit Block"><?php echo the_title(); ?></a>
                </div>
