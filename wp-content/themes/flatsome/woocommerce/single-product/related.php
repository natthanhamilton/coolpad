...
if (! isset($flatsome_opt['max_related_products']))
{
    $flatsome_opt['max_related_products'] = '12';
}
...
if (! isset($flatsome_opt['related_products_pr_row']))
{
    $flatsome_opt['related_products_pr_row'] = '4';
}
