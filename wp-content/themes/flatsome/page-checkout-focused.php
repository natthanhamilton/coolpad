...
<div id="main-content" class="site-main box-shadow <?php echo $flatsome_opt['content_color']; ?>"
     style="max-width:960px;margin:60px auto 60px auto;">
    ...
    <div class="checkout-header" style="background-color:<?php echo $flatsome_opt['header_bg']; ?>">
        <a id="logo" href="<?php echo esc_url(home_url('/')); ?>"
           style="margin: 0 auto 0 auto;padding:30px 0px 15px;display:block;max-height:<?php echo $flatsome_opt['header_height']; ?>px; max-width:<?php echo $flatsome_opt['logo_width']; ?>px"
           rel="home">
    ...
    <div class="absolute-footer <?php echo $flatsome_opt['footer_bottom_style']; ?>"
         style="background-color:<?php echo $flatsome_opt['footer_bottom_color']; ?>">
        <div class="row">
