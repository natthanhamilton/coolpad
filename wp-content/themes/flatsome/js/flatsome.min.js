window.Modernizr = function (t, e, i) {
    ...
    function c(t, e, i) {
        var n = t.charAt(0).toUpperCase() + t.slice(1), o = (t + " " + w.join(n + " ") + n).split(" ");
        return r(e, "string") || r(e, "undefined") ? a(o, e) : (o = (t + " " + x.join(n + " ") + n).split(" "), l(o, e, i))
    }

    var h = "2.6.2", u = {}, d = e.documentElement, p = "modernizr", f = e.createElement(p), m = f.style, g, v = {}.toString, y = " -webkit- -moz- -o- -ms- ".split(" "), b = "Webkit Moz O ms", w = b.split(" "), x = b.toLowerCase().split(" "), C = {}, E = {}, k = {}, S = [], _ = S.slice, T, I = {}.hasOwnProperty, P;
    P = r(I, "undefined") || r(I.call, "undefined") ? function (t, e) {
        ...
        var i = _.call(arguments, 1), n = function () {
            if (this instanceof n) {
                var o = function () {
                };
                o.prototype = e.prototype;
                var r = new o, s = e.apply(r, i.concat(_.call(arguments)));
    ...
    for (var z in C)P(C, z) && (T = z.toLowerCase(), u[T] = C[z](), S.push((u[T] ? "" : "no-") + T));
    return u.addTest = function (t, e) {
        if ("object" == typeof t)for (var n in t)P(t, n) && u.addTest(n, t[n]); else {
            if (t = t.toLowerCase(), u[t] !== i)return u;
            e = "function" == typeof e ? e() : e, "undefined" != typeof enableClasses && enableClasses && (d.className += " " + (e ? "" : "no-") + t), u[t] = e
        }
        return u
    }, n(""), f = g = null, function (t, e) {
        function i(t, e) {
        ...
        function r(t, i, n) {
            ...
            n || (n = o(i));
            var r;
            return r = n.cache[t] ? n.cache[t].cloneNode() : u.test(t) ? (n.cache[t] = n.createElem(t)).cloneNode() : n.createElem(t), r.canHaveChildren && !h.test(t) ? n.frag.appendChild(r) : r
        }
        ...
        function l(t) {
            t || (t = e);
            var n = o(t);
            return v.shivCSS && !d && !n.hasCSS && (n.hasCSS = !!i(t, "article,aside,figcaption,figure,footer,header,hgroup,nav,section{display:block}mark{background:#FF0;color:#000}")), g || a(t, n), t
        }

        var c = t.html5 || {}, h = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, u = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, d, p = "_html5shiv", f = 0, m = {}, g;
        !function () {
            try {
                var t = e.createElement("a");
                t.innerHTML = "<xyz></xyz>", d = "hidden" in t, g = 1 == t.childNodes.length || function () {
                        e.createElement("a");
        ...
        t.html5 = v, l(e)
    }(this, e), u._version = h, u._prefixes = y, u._domPrefixes = x, u._cssomPrefixes = w, u.testProp = function (t) {
        return a([t])
    }, u.testAllProps = c, u
    ...
    !function (t) {
        ...
        function r(e) {
            ...
            function r(t) {
                if (n(), "string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                    ...
                    var v = r.paddingLeft + r.paddingRight, y = r.paddingTop + r.paddingBottom, b = r.marginLeft + r.marginRight, w = r.marginTop + r.marginBottom, x = r.borderLeftWidth + r.borderRightWidth, C = r.borderTopWidth + r.borderBottomWidth, E = s && u, k = i(e.width);
                    k !== !1 && (r.width = k + (E ? 0 : v + x));
                    var S = i(e.height);
                    return S !== !1 && (r.height = S + (E ? 0 : y + C)), r.innerWidth = r.width - (v + x), r.innerHeight = r.height - (y + C), r.outerWidth = r.width + b, r.outerHeight = r.height + w, r
                }
            }
        ...
        return i.prototype.pointerUp = function (i, o) {
            if (!this.isIgnoringMouseUp || "mouseup" != i.type) {
                var r = e.getPointerPoint(o), s = this.tapElement.getBoundingClientRect(), a = n ? t.pageXOffset : document.body.scrollLeft, l = n ? t.pageYOffset : document.body.scrollTop, c = r.x >= s.left + a && r.x <= s.right + a && r.y >= s.top + l && r.y <= s.bottom + l;
        ...
        var e, i, n, o, r, s, a = "Close", l = "BeforeClose", c = "AfterClose", h = "BeforeAppend", u = "MarkupParse", d = "Open", p = "Change", f = "mfp", m = "." + f, g = "mfp-ready", v = "mfp-removing", y = "mfp-prevent-close", b = function () {
        ...
        t.magnificPopup.registerModule(M, {
            options: {
                ...
                initAjax: function () {
                    e.types.push(M), L = e.st.ajax.cursor, C(a + "." + M, j), C("BeforeChange." + M, j)
                }, getAjax: function (i) {
        ...
        var B = "iframe", W = "//about:blank", H = function (t) {
            if (e.currTemplate[B]) {
        ...
        t.magnificPopup.registerModule(B, {
            options: {
                ...
                initIframe: function () {
                    e.types.push(B), C("BeforeChange", function (t, e, i) {
                        e !== i && (e === B ? H() : i === B && H(!0))
                    }), C(a + "." + B, function () {
                        H()
                    })
            ...
            options: {
                ...
                initRetina: function () {
                    if (window.devicePixelRatio > 1) {
                        ...
                        i = isNaN(i) ? i() : i, i > 1 && (C("ImageHasSize." + Y, function (t, e) {
                            e.img.css({"max-width": e.img[0].naturalWidth / i, width: "100%"})
                        }), C("ElementParse." + Y, function (e, n) {
        ...
        e.defaults = {axis: "xy", duration: parseFloat($.fn.$) >= 1.3 ? 0 : 1, limit: !0}, e.window = function (t) {
            return $(window)._scrollable()
        }, $.fn._scrollable = function () {
            return this.map(function () {
                var t = this, e = !t.nodeName || -1 != $.inArray(t.nodeName.toLowerCase(), ["iframe", "#document", "html", "body"]);
                if (!e)return t;
            ...
            return "object" == typeof n && (o = n, n = 0), "function" == typeof o && (o = {onAfter: o}), "max" == i && (i = 9e9), o = $.extend({}, e.defaults, o), n = n || o.duration, o.queue = o.queue && o.axis.length > 1, o.queue && (n /= 2), o.offset = t(o.offset), o.over = t(o.over), this._scrollable().each(function () {
                function r(t) {
                    a.animate(h, n, o.easing, t && function () {
                            t.call(this, i, o)
                        })
                }

                if (null != i) {
                    var s = this, a = $(s), l = i, c, h = {}, u = a.is("html,body");
                    switch (typeof l) {
                        case"number":
                        case"string":
                            if (/^([+-]=)?\d+(\.\d+)?(px|%)?$/.test(l)) {
                    ...
                    $.each(o.axis.split(""), function (t, i) {
                        var n = "x" == i ? "Left" : "Top", d = n.toLowerCase(), p = "scroll" + n, f = s[p], m = e.max(s, i);
                        if (c)h[p] = c[d] + (u ? 0 : f - a.offset()[d]), o.margin && (h[p] -= parseInt(l.css("margin" + n)) || 0, h[p] -= parseInt(l.css("border" + n + "Width")) || 0), h[p] += o.offset[d] || 0, o.over[d] && (h[p] += l["x" == i ? "width" : "height"]() * o.over[d]); else {
                            var g = l[d];
                            h[p] = g.slice && "%" == g.slice(-1) ? parseFloat(g) / 100 * m : g
                        }
                        o.limit && /^\d+$/.test(h[p]) && (h[p] = h[p] <= 0 ? 0 : Math.min(h[p], m)), !t && o.queue && (f != h[p] && r(o.onAfterFirst), delete h[p])
                    }), r(o.onAfter)
                }
            }).end()
        }, e.max = function (t, e) {
            var i = "x" == e ? "Width" : "Height", n = "scroll" + i;
            if (!$(t).is("html,body"))return t[n] - $(t)[i.toLowerCase()]();
            var o = "client" + i, r = t.ownerDocument.documentElement, s = t.ownerDocument.body;
            return Math.max(r[n], s[n]) - Math.min(r[o], s[o])
        }
    }($)
}(jQuery), function ($) {
    $.fn.hoverIntent = function (t, e, i) {
        var n = {interval: 50, sensitivity: 20, timeout: 200};
        n = "object" == typeof t ? $.extend(n, t) : $.isFunction(e) ? $.extend(n, {
            over: t,
            out: e,
            selector: i
        }) : $.extend(n, {over: t, out: t, selector: e});
    ...
    !function (t, e) {
        ...
        var o, r, s, a, l, c, h, u, d, p, f, m, g, v, y, b;
        return o = i(n), u = t.call(n, "ontouchstart") >= 0, a = {
            horizontal: {},
            vertical: {}
        }, l = 1, h = {}, c = "waypoints-context-id", f = "resize.waypoints", m = "scroll.waypoints", g = 1, v = "waypoints-waypoint-ids", y = "waypoint", b = "waypoints", r = function () {
            function t(t) {
                var e = this;
    ...
    function r(e) {
        if (o(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
            ...
            var m = a.paddingLeft + a.paddingRight, g = a.paddingTop + a.paddingBottom, v = a.marginLeft + a.marginRight, y = a.marginTop + a.marginBottom, b = a.borderLeftWidth + a.borderRightWidth, w = a.borderTopWidth + a.borderBottomWidth, x = h && s, C = t(r.width);
            C !== !1 && (a.width = C + (x ? 0 : m + b));
            var E = t(r.height);
            return E !== !1 && (a.height = E + (x ? 0 : g + w)), a.innerWidth = a.width - (m + b), a.innerHeight = a.height - (g + w), a.outerWidth = a.width + v, a.outerHeight = a.height + y, a
        }
    }
    ...
    return i.htmlInit = function (e, o) {
        i.docReady(function () {
            var r = i.toDashed(o), s = "data-" + r, a = document.querySelectorAll("[" + s + "]"), l = document.querySelectorAll(".js-" + r), c = i.makeArray(a).concat(i.makeArray(l)), h = s + "-options", u = t.jQuery;
    ...
    c._create = function () {
        ...
        var e = this._getItemsForLayout(this.items), i = this._getOption("horizontal"), n = i ? "y" : "x", o = i ? "height" : "width", r = i ? "rowHeight" : "columnWidth", s = i ? "innerHeight" : "innerWidth", a = this[r];
    ...
    n.prototype = {
        _init: function () {
            ...
            n.options.functionBefore.call(n.$el, n.$el, function () {
                if (n.enabled && null !== n.Content) {
                    ...
                    if ("hidden" !== n.Status) {
                        ...
                        var a = "tooltipster-" + n.options.animation, l = "-webkit-transition-duration: " + n.options.speed + "ms; -webkit-animation-duration: " + n.options.speed + "ms; -moz-transition-duration: " + n.options.speed + "ms; -moz-animation-duration: " + n.options.speed + "ms; -o-transition-duration: " + n.options.speed + "ms; -o-animation-duration: " + n.options.speed + "ms; -ms-transition-duration: " + n.options.speed + "ms; -ms-animation-duration: " + n.options.speed + "ms; transition-duration: " + n.options.speed + "ms; animation-duration: " + n.options.speed + "ms;", h = n.options.minWidth ? "min-width:" + Math.round(n.options.minWidth) + "px;" : "", u = n.options.maxWidth ? "max-width:" + Math.round(n.options.maxWidth) + "px;" : "", d = n.options.interactive ? "pointer-events: auto;" : "";
            ...
            function n(i, n) {
                a.offset.top - t(e).scrollTop() - h - M - 12 < 0 && n.indexOf("top") > -1 && (j = i), a.offset.top + a.dimension.height + h + 12 + M > t(e).scrollTop() + t(e).height() && n.indexOf("bottom") > -1 && (j = i, L = a.offset.top - h - M - 12)
            }

            var o = this;
            if (0 !== t("body").find(o.$tooltip).length) {
                o.$tooltip.css("width", ""), o.elProxyPosition = o._repositionInfo(o.$elProxy);
                var r = null, s = t(e).width(), a = o.elProxyPosition, l = o.$tooltip.outerWidth(!1), c = o.$tooltip.innerWidth() + 1, h = o.$tooltip.outerHeight(!1);
                if (o.$elProxy.is("area")) {
                    var u = o.$elProxy.attr("shape"), d = o.$elProxy.parent().attr("name"), p = t('img[usemap="#' + d + '"]'), f = p.offset().left, m = p.offset().top, g = void 0 !== o.$elProxy.attr("coords") ? o.$elProxy.attr("coords").split(",") : void 0;
                    if ("circle" == u) {
                        var v = parseInt(g[0]), y = parseInt(g[1]), b = parseInt(g[2]);
                        a.dimension.height = 2 * b, a.dimension.width = 2 * b, a.offset.top = m + y - b, a.offset.left = f + v - b
                    } else if ("rect" == u) {
                        var v = parseInt(g[0]), y = parseInt(g[1]), w = parseInt(g[2]), x = parseInt(g[3]);
                        a.dimension.height = x - y, a.dimension.width = w - v, a.offset.top = m + y, a.offset.left = f + v
                    } else if ("poly" == u) {
                        for (var C = [], E = [], k = 0, S = 0, _ = 0, T = 0, I = "even", P = 0; P < g.length; P++) {
                            var z = parseInt(g[P]);
                            "even" == I ? (z > _ && (_ = z, 0 === P && (k = _)), k > z && (k = z), I = "odd") : (z > T && (T = z, 1 == P && (S = T)), S > z && (S = z), I = "even")
                        }
                        a.dimension.height = T - S, a.dimension.width = _ - k, a.offset.top = m + S, a.offset.left = f + k
                    } else a.dimension.height = p.outerHeight(!1), a.dimension.width = p.outerWidth(!1), a.offset.top = m, a.offset.left = f
                }
                var A = 0, D = 0, L = 0, M = parseInt(o.options.offsetY), O = parseInt(o.options.offsetX), j = o.options.position;
                if ("top" == j) {
                    var F = a.offset.left + l - (a.offset.left + a.dimension.width);
                    A = a.offset.left + O - F / 2, L = a.offset.top - h - M - 12, i(), n("bottom", "top")
                }
                if ("top-left" == j && (A = a.offset.left + O, L = a.offset.top - h - M - 12, i(), n("bottom-left", "top-left")), "top-right" == j && (A = a.offset.left + a.dimension.width + O - l, L = a.offset.top - h - M - 12, i(), n("bottom-right", "top-right")), "bottom" == j) {
                    var F = a.offset.left + l - (a.offset.left + a.dimension.width);
                    A = a.offset.left - F / 2 + O, L = a.offset.top + a.dimension.height + M + 12, i(), n("top", "bottom")
                }
                if ("bottom-left" == j && (A = a.offset.left + O, L = a.offset.top + a.dimension.height + M + 12, i(), n("top-left", "bottom-left")), "bottom-right" == j && (A = a.offset.left + a.dimension.width + O - l, L = a.offset.top + a.dimension.height + M + 12, i(), n("top-right", "bottom-right")), "left" == j) {
                    A = a.offset.left - O - l - 12, D = a.offset.left + O + a.dimension.width + 12;
                    var N = a.offset.top + h - (a.offset.top + a.dimension.height);
                    if (L = a.offset.top - N / 2 - M, 0 > A && D + l > s) {
                        var q = 2 * parseFloat(o.$tooltip.css("border-width")), R = l + A - q;
                        o.$tooltip.css("width", R + "px"), h = o.$tooltip.outerHeight(!1), A = a.offset.left - O - R - 12 - q, N = a.offset.top + h - (a.offset.top + a.dimension.height), L = a.offset.top - N / 2 - M
                    } else 0 > A && (A = a.offset.left + O + a.dimension.width + 12, r = "left")
                }
                if ("right" == j) {
                    A = a.offset.left + O + a.dimension.width + 12, D = a.offset.left - O - l - 12;
                    var N = a.offset.top + h - (a.offset.top + a.dimension.height);
                    if (L = a.offset.top - N / 2 - M, A + l > s && 0 > D) {
                        var q = 2 * parseFloat(o.$tooltip.css("border-width")), R = s - A - q;
                        o.$tooltip.css("width", R + "px"), h = o.$tooltip.outerHeight(!1), N = a.offset.top + h - (a.offset.top + a.dimension.height), L = a.offset.top - N / 2 - M
                    } else A + l > s && (A = a.offset.left - O - l - 12, r = "right")
                }
                if (o.options.arrow) {
                    var B = "tooltipster-arrow-" + j;
                    if (o.options.arrowColor.length < 1)var W = o.$tooltip.css("background-color"); else var W = o.options.arrowColor;
                    if (r ? "left" == r ? (B = "tooltipster-arrow-right", r = "") : "right" == r ? (B = "tooltipster-arrow-left", r = "") : r = "left:" + Math.round(r) + "px;" : r = "", "top" == j || "top-left" == j || "top-right" == j)var H = parseFloat(o.$tooltip.css("border-bottom-width")), U = o.$tooltip.css("border-bottom-color"); else if ("bottom" == j || "bottom-left" == j || "bottom-right" == j)var H = parseFloat(o.$tooltip.css("border-top-width")), U = o.$tooltip.css("border-top-color"); else if ("left" == j)var H = parseFloat(o.$tooltip.css("border-right-width")), U = o.$tooltip.css("border-right-color"); else if ("right" == j)var H = parseFloat(o.$tooltip.css("border-left-width")), U = o.$tooltip.css("border-left-color"); else var H = parseFloat(o.$tooltip.css("border-bottom-width")), U = o.$tooltip.css("border-bottom-color");
                    H > 1 && H++;
                    var X = "";
                    if (0 !== H) {
                        var Y = "", Q = "border-color: " + U + ";";
                        -1 !== B.indexOf("bottom") ? Y = "margin-top: -" + Math.round(H) + "px;" : -1 !== B.indexOf("top") ? Y = "margin-bottom: -" + Math.round(H) + "px;" : -1 !== B.indexOf("left") ? Y = "margin-right: -" + Math.round(H) + "px;" : -1 !== B.indexOf("right") && (Y = "margin-left: -" + Math.round(H) + "px;"), X = '<span class="tooltipster-arrow-border" style="' + Y + " " + Q + ';"></span>'
                    }
                    o.$tooltip.find(".tooltipster-arrow").remove();
                    var G = '<div class="' + B + ' tooltipster-arrow" style="' + r + '">' + X + '<span style="border-color:' + W + ';"></span></div>';
                    o.$tooltip.append(G)
                }
        ...
        var r = [], s = e[0] && "undefined" != typeof e[0].multiple, a = s && e[0].multiple || !s && l.multiple, c = e[0] && "undefined" != typeof e[0].debug, h = c && e[0].debug || !c && l.debug;
        return this.each(function () {
...
}), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) || jQuery(function ($) {
    ...
    $(window).bind("resize.ux-parallax", function () {
        var t = $(window).height(), e = $(window).scrollTop();
        $elements.each(function (e) {
            var i = $(this), n = i.parents(".has-parallax");
        ...
        var e = $(window).height(), i = $(window).scrollTop();
        $elements.each(function (n) {
            var o = $(this), r = o.parents(".has-parallax"), s = r.offset().top - i;
            if (!(s > e || s + r.outerHeight() + t < 0)) {
                var a = 1 - o.data("velocity"), l = (s - t) / e * .7, c = -s + s * a, h = -s + t + (s - t) * a, u = o.hasClass("parallax_text") ? h : c;
                o.css({webkitTransform: "translate3d(0px, " + u + "px , 0px)"}), o.css({mozTransform: "translate3d(0px, " + u + "px , 0px)"}), o.css({Transform: "translate3d(0px, " + u + "px , 0px)"}), o.hasClass("parallax_text") && o.css("opacity", 1 - Math.abs(l))
            }
        })
    }), $(window).bind("DOMNodeInserted", function (t) {
        $(window).trigger("resize.ux-parallax")
    }), $(window).trigger("resize.ux-parallax"), $(window).trigger("scroll.ux-parallax")
}), !function (t) {
    "use strict";
    function e(e, i) {
    ...
    function t(t) {
        $(t).find("div.quantity:not(.buttons_added), td.quantity:not(.buttons_added)").addClass("buttons_added").append('<input type="button" value="+" class="plus" />').prepend('<input type="button" value="-" class="minus" />'), $(t).find("input.qty:not(.product-quantity input.qty)").each(function () {
            var t = parseFloat($(this).attr("min"));
            t && t > 0 && parseFloat($(this).val()) < t && $(this).val(t)
        }), $(t).on("click", ".plus, .minus", function () {
            var t = $(this).closest(".quantity").find(".qty"), e = parseFloat(t.val()), i = parseFloat(t.attr("max")), n = parseFloat(t.attr("min")), o = t.attr("step");
            e && "" !== e && "NaN" !== e || (e = 0), ("" === i || "NaN" === i) && (i = ""), ("" === n || "NaN" === n) && (n = 0), ("any" === o || "" === o || void 0 === o || "NaN" === parseFloat(o)) && (o = 1), $(this).is(".plus") ? i && (i == e || e > i) ? t.val(i) : t.val(e + parseFloat(o)) : n && (n == e || n > e) ? t.val(n) : e > 0 && t.val(e - parseFloat(o)), t.trigger("change")
        })
    }
    ...
    function S(t) {
        ...
        return new (e = i ? i : vt ? q : yt ? W : gt ? U : N)(t, _)
    }

    function _(t, e, i) {
        var n = i.pointers.length, o = i.changedPointers.length, r = e & kt && n - o === 0, s = e & (_t | Tt) && n - o === 0;
    ...
    function T(t, e) {
        ...
        e.timeStamp = pt(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = O(a, l), e.distance = M(a, l), I(i, e), e.offsetDirection = L(e.deltaX, e.deltaY), e.scale = s ? F(s.pointers, n) : 1, e.rotation = s ? j(s.pointers, n) : 0, P(i, e);
        var c = t.element;
    ...
    function U() {
        ...
        this.touch = new W(this.manager, t), this.mouse = new N(this.manager, t)
    }
    ...
    function rt(t, e) {
        e = e || {}, this.options = l(e, ot.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = S(this), this.touchAction = new X(this, this.options.touchAction), st(this, !0), s(e.recognizers, function (t) {
    ...
    var lt = ["", "webkit", "moz", "MS", "ms", "o"], ct = e.createElement("div"), ht = "function", ut = Math.round, dt = Math.abs, pt = Date.now, ft = 1, mt = /mobile|tablet|ip(ad|hone|od)|android/i, gt = "ontouchstart" in t, vt = x(t, "PointerEvent") !== n, yt = gt && mt.test(navigator.userAgent), bt = "touch", wt = "pen", xt = "mouse", Ct = "kinect", Et = 25, kt = 1, St = 2, _t = 4, Tt = 8, It = 1, Pt = 2, zt = 4, At = 8, Dt = 16, Lt = Pt | zt, Mt = At | Dt, Ot = Lt | Mt, $t = ["x", "y"], jt = ["clientX", "clientY"];
    k.prototype = {
        handler: function () {
        }, init: function () {
    ...
    var Rt = {pointerdown: kt, pointermove: St, pointerup: _t, pointercancel: Tt, pointerout: Tt}, Bt = {
        2: bt,
        3: wt,
        4: xt,
        5: Ct
    }, Wt = "pointerdown", Ht = "pointermove pointerup pointercancel";
    t.MSPointerEvent && (Wt = "MSPointerDown", Ht = "MSPointerMove MSPointerUp MSPointerCancel"), c(q, k, {
        handler: function (t) {
            var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Rt[n], r = Bt[t.pointerType] || t.pointerType, s = r == bt, a = y(e, t.pointerId, "pointerId");
    ...
    c(W, k, {
        handler: function (t) {
            var e = Qt[t.type], i = H.call(this, t, e);
    ...
    var Vt = x(ct.style, "touchAction"), Zt = Vt !== n, Kt = "compute", Jt = "auto", te = "manipulation", ee = "none", ie = "pan-x", ne = "pan-y";
    X.prototype = {
        set: function (t) {
    ...
    Q.prototype = {
        ...
        defaults: {
            ...
            if (n && r && i) {
                ...
                var s = this.pTime ? t.timeStamp - this.pTime < e.interval : !0, a = !this.pCenter || M(this.pCenter, t.center) < e.posThreshold;
        ...
        inputTarget: null,
        inputClass: null,
        preset: [[et, {enable: !1}], [J, {enable: !1}, ["rotate"]], [it, {direction: Lt}], [$, {direction: Lt}, ["swipe"]], [nt], [nt, {
            event: "doubletap",
            taps: 2
        }, ["tap"]], [tt]],
        cssProps: {
    ...
    var e = navigator.userAgent.indexOf("Windows Phone") >= 0, i = navigator.userAgent.indexOf("Android") > 0 && !e, n = /iP(ad|hone|od)/.test(navigator.userAgent) && !e, o = n && /OS 4_\d(_\d)?/.test(navigator.userAgent), r = n && /OS [6-7]_\d/.test(navigator.userAgent), s = navigator.userAgent.indexOf("BB10") > 0;
...
doc.setAttribute("data-useragent", navigator.userAgent), function ($) {
    "use strict";
    $(".ux-slider, .product-gallery-slider").on("cellSelect", function () {
        /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) || ($(this).find(".ux_banner:not(.is-selected) .ux-banner-video").trigger("pause"), $(this).find(".ux_banner.is-selected .ux-banner-video").trigger("play"));
        var t = $(this).find(".is-selected").outerHeight();
        t && $(this).find(".flickity-viewport").css("height", t)
        ...
        var e = $(this).find(".nav-dropdown").outerWidth(), i = $(this).find(".nav-dropdown > ul > li.menu-parent-item").width(), n = $(this).find(".nav-dropdown > ul > li.menu-parent-item").length + $(this).find(".nav-dropdown").find(".image-column").length, o = n * i;
        ...
        callbacks: {
            open: function () {
                var t = $.magnificPopup.instance, e = $(".mfp-wrap")[0], i = new Hammer(e);
    ...
    }), $("[data-lightbox]").click(function (t) {
        var e = $(this).data("lightbox");
        $.magnificPopup.open({midClick: !0, removalDelay: 300, items: {src: e, type: "inline"}}), t.preventDefault()
        ...
        callbacks: {
            beforeOpen: function () {
                ...
                var t = $(".mfp-wrap")[0], e = new Hammer(t);
                e.on("panleft", function (t) {
                    return $(t.target).parents(".widget_price_filter").length ? !1 : void(t.distance > 120 && t.isFinal && "panleft" === t.type && $.magnificPopup.close())
                })
    ...
    }, 100), $(".absolute-footer").waypoint(function () {
        $("#top-link").toggleClass("start-anim")
    }, {offset: "100%"});
    var t = -$(window).height() / 4;
    $(".sticky_header #masthead").waypoint("sticky", {offset: t}), $(".sticky_header .wide-nav").waypoint("sticky", {offset: t}), $("#main-content").waypoint(function () {
    ...
    }, {offset: t}), $("#top-link").click(function (t) {
        ...
        return $(this).next().is(":hidden") ? ($(this).parent().find(".accordion-title").removeClass("active").next().slideUp(200), $(this).toggleClass("active").next().slideDown(200), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) && $.scrollTo($(this), 300, {offset: -100})) : $(this).parent().find(".accordion-title").removeClass("active").next().slideUp(200), !1
        ...
        return $(this).parent().parent().parent().find("div.panel").removeClass("active"), $(e).addClass("active"), $(e).find("p script").unwrap(), $(this).parent().parent().parent().find(".js-flickity").flickity("resize"), !1
        ...
        var e = $(this).attr("href");
        return $(this).parent().parent().parent().parent().find("div.tabs-inner").removeClass("active"), $(e).addClass("active"), $(this).parent().parent().parent().parent().find(".js-flickity").flickity("resize"), !1
    ...
    }), $("#megaMenu").wrap("<li/>"), /Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent) && $(".select2-container, #megaMenu, .top-bar-nav .nav-top-link, .header-nav .nav-top-link, .menu-item-language-current, .search-dropdown, input.booking_calender").addClass("needsclick"), FastClick.attach(document.body), $(window).resize()
}(jQuery), function ($) {
    "use strict";
    function t(t) {
        $(t).click(function (t) {
            $(this).after('<div class="ux-loading dark"></div>');
            var e = $(this).attr("data-prod"), i = {action: "ux_quickview", product: e};
            $.post(ajaxURL.ajaxurl, i, function (t) {
                $.magnificPopup.open({
                    removalDelay: 300,
                    items: {src: '<div class="product-lightbox">' + t + "</div>", type: "inline"}
                }), $(".ux-loading").remove(), $(".product-lightbox .product-gallery-slider").flickity({
                    cellAlign: "center",
                    wrapAround: !0,
                    autoPlay: !1,
                    prevNextButtons: !0,
                    ...
                    $(".product-lightbox form").hasClass("variations_form") && $(".product-lightbox form.variations_form").wc_variation_form(), $(".product-lightbox form.variations_form").on("show_variation", function (t, e) {
                        e.image_src && ($(".product-lightbox .product-gallery-slider .slide.first img").attr("src", e.image_src), $(".product-lightbox .product-gallery-slider .slide.first a").attr("href", e.image_link), $(".product-lightbox .product-gallery-slider").flickity("select", 0))
    ...
    $(".product-info, table.cart").addQty(), $(".page-checkout").arrive(".shop_table", function () {
        $(".shop_table").addQty()
    });
    var e = $(".product-thumbnails .first img").attr("src");
    if ($("form.variations_form").on("show_variation", function (t, i) {
            i.image_src ? ($(".product-gallery-slider .slide.first img, .product-thumbnails .first img").attr("src", i.image_src), $(".product-gallery-slider .slide.first a, .product-thumbnails .first a").attr("href", i.image_link), $(".product-gallery-slider").flickity("select", 0)) : $(".product-thumbnails .first img").attr("src", e)
        }), t(".quick-view"), $(".woocommerce").arrive(".quick-view", function () {
            t($(this))
        }), $(".product-gallery-slider").on("cellSelect", function () {
            var t = $(this).find(".is-selected").outerHeight();
            t && $(this).find(".flickity-viewport").css("height", t)
        }), !/Android|webOS|iPhone|iPad|iPod|BlackBerry/i.test(navigator.userAgent)) {
        var i = $(".product-zoom .easyzoom").easyZoom({loadingNotice: ""}), n = i.filter(".product-zoom .easyzoom.first").data("easyZoom");
        n && setTimeout(function () {
            $('select[name*="attribute"]').change(function () {
                n.swap($(".easyzoom.first img").attr("src"), $(".easyzoom.first a").attr("href"))
            })
        }, 300)
    }
    $(".product-gallery-slider").magnificPopup({
        ...
        callbacks: {
            beforeOpen: function () {
                ...
                var t = $.magnificPopup.instance, e = $(".product-video-popup").attr("href");
                e && (t.items.push({src: e, type: "iframe"}), t.updateItemHTML());
                var i = $(".mfp-wrap")[0], n = new Hammer(i);
                n.on("panleft", function (e) {
                    e.isFinal && t.prev()
    ...
    }), $("a.product-video-popup").click(function (t) {
        $(".product-gallery-slider").find(".first a").click(), setTimeout(function () {
            var t = $.magnificPopup.instance;
            t.prev()
        }, 10), t.preventDefault()
    }), $(".zoom-button").click(function (t) {
        $(".product-gallery-slider").find(".is-selected a").click(), t.preventDefault()
