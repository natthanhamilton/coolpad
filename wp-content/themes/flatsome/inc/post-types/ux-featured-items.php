...
if (!class_exists('Featured_Item_Post_Type')) :
	class Featured_Item_Post_Type {
		public function __construct() {
			...
			add_theme_support('post-thumbnails', ['featured_item']);
			// Add thumbnails to column view
			add_filter('manage_edit-featured_item_columns', [$this, 'add_thumbnail_column'], 10, 1);
			add_action('manage_pages_custom_column', [$this, 'display_thumbnail'], 10, 1);
		...
		protected function get_taxonomies() {
			return ['featured_item_category', 'featured_item_tag'];
		}
		...
		protected function register_taxonomy_tag() {
			...
			register_taxonomy('featured_item_tag', ['featured_item'], $args);
		}
		...
		protected function register_taxonomy_category() {
			...
			register_taxonomy('featured_item_category', ['featured_item'], $args);
			global $flatsome_opt;
		...
		public function add_thumbnail_column($columns) {
			$column_thumbnail = ['thumbnail' => __('Thumbnail', 'featured_itemposttype')];
