...
function flatsome_woocommerce_integrations_scripts() {
	if (is_extension_activated('woocommerce_booking')) {
		wp_enqueue_style('flatsome-woocommerce-bookings-style',
		                 get_template_directory_uri() . '/inc/woocommerce/integrations/bookings.css',
		                 'flatsome-woocommerce-style');
	}
	if (is_extension_activated('TM_Extra_Product_Options')) {
		wp_enqueue_style('flatsome-woocommerce-extra-product-options',
		                 get_template_directory_uri() . '/inc/woocommerce/integrations/extra-product-options.css',
		                 'flatsome-woocommerce-style');
	}
	if (is_extension_activated('Fancy_Product_Designer')) {
		wp_enqueue_style('flatsome-fancy-product-designer',
		                 get_template_directory_uri() . '/inc/woocommerce/integrations/product-designer.css',
		                 'flatsome-woocommerce-style');
	}
	if (is_extension_activated('Woocommerce_Advanced_Product_Labels')) {
		wp_enqueue_style('flatsome-woocommerce-advanced-labels',
		                 get_template_directory_uri() . '/inc/woocommerce/integrations/advanced-product-labels.css',
		                 'flatsome-woocommerce-style');
	}
	if (function_exists('yith_wcwl_get_template')) {
		...
		wp_enqueue_style('flatsome-woocommerce-wishlist',
		                 get_template_directory_uri() . '/inc/woocommerce/integrations/wishlist.css',
		                 'flatsome-woocommerce-style');
	}
}
