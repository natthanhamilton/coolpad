	...
	function top_text_taxonomy_edit_meta_field($term) {
		...
		<tr class="form-field">
			...
			<td>
				...
				<p class="description"><?php _e('Enter a value for this field. Shortcodes are allowed. This will be displayed at top of the category.',
				                                'flatsome'); ?></p>
			</td>
		</tr>
		<?php
	...
	function bottom_text_taxonomy_edit_meta_field($term) {
		...
		<tr class="form-field">
			...
			<td>
				...
				<p class="description"><?php _e('Enter a value for this field. Shortcodes are allowed. This will be displayed at bottom of the category.',
				                                'flatsome'); ?></p>
			</td>
		</tr>
		<?php
