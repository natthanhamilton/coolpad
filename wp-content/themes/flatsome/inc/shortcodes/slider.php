...
function shortcode_ux_slider($atts, $content = NULL) {
	...
	<div class="ux-slider-wrapper relative">
		<div
			class="ux-slider iosSlider <?php echo $slider_classes; ?> slider-style-<?php echo $style; ?>  slider-nav-<?php echo $nav_color; ?> slider-nav-<?php echo $nav_pos; ?> slider-nav-<?php echo $arrows; ?> js-flickity"
