...
<div class="featured-box  <?php if ($pos) echo 'pos-' . $pos; ?>  <?php if ($tooltip) {
    echo 'tip-top';
} ?>" title="<?php echo $tooltip; ?>"
     style="<?php if ($pos == "left" && $img_width) echo 'padding-left:' . ($img_width + 15) . 'px;'; ?><?php echo $font_size; ?>">
    <div class="box-inner">
        <?php if ($link) {
            echo '<a href="' . $link . '">';
        } ?>
        ...
        {
        ?>
        <div class="featured-img <?php if ($animated) {
            echo 'scroll-animate';
        } ?> <?php if ($icon_border) { ?>featured-img-circle <?php } ?>" <?php if ($animated) echo 'data-animate="' . $animated . '"'; ?>
             style="<?php if ($img_width) { ?>width:<?php echo $img_width; ?>;max-height:<?php echo $img_width; ?>;<?php } ?> <?php if ($icon_border) { ?>border-width:<?php echo $icon_border; ?>; border-color:<?php echo $icon_color; ?><?php } ?>"><?php
