...
<div class="featured-box  <?php if ($pos) echo 'pos-' . $pos; ?>  <?php if ($tooltip)
{
    ...
    <div class="box-inner">
        ...
        { ?>featured-img-circle <?php } ?>" <?php if ($animated) echo 'data-animate="' . $animated . '"'; ?>
             style="<?php if ($img_width)
             { ?>width:<?php echo $img_width; ?>;max-height:<?php echo $img_width; ?>;<?php } ?> <?php if ($icon_border)
             { ?>border-width:<?php echo $icon_border; ?>; border-color:<?php echo $icon_color; ?><?php } ?>"><?php
