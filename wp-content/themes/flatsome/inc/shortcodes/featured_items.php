...
function ux_featured_items($atts, $content = NULL, $tag) {
    ...
    <div class="row">
        <div class="large-12 columns">
            <ul class="<?php if ($type == 'slider') { ?>js-flickity slider-nav-circle <?php if ($style == '1') {
                echo 'slider-nav-push';
            } ?> <?php } ?>  large-block-grid-<?php echo $columns; ?> small-block-grid-2"
                <?php if ($type == 'slider') { ?>
            ...
            >
                ...
                while ($wp_query->have_posts()) : $wp_query->the_post();
                    ...
                    if ($lightbox == 'true') {
                        $link = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()),
                        ...
                        <div class="inner">
                            <div class="inner-wrap">
                                <a href="<?php echo $link; ?>" title="<?php the_title(); ?>">
                                    <div class="ux-box-image" style="<?php if ($height) {
                                    ...
                                    <div class="ux-box-text">
                                        ...
                                        <p class="show-next smaller-font uppercase">
                                            <?php echo strip_tags(get_the_term_list(get_the_ID(),
