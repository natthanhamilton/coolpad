...
jQuery(document).ready(function ($) {
    ...
    $('[data-countdown]').each(function () {
        ...
        var t_hour = $(this).data('text-hour'), t_min = $(this).data('text-min'), t_week = $(this).data('text-week'), t_plural = $(this).data('text-plural'), t_day = $(this).data('text-day'), t_sec = $(this).data('text-sec');
        ...
        $this.countdown(finalDate).on('update.countdown', function (event) {
            ...
            if (event.offset.days > 0) {
                format = '<span>%-d<strong>' + t_day + '%!d:' + t_plural + ';</strong></span>' + format;
            }
            if (event.offset.weeks > 0) {
                format = '<span>%-w<strong>' + t_week + '%!w:' + t_plural + ';</strong></span>' + format;
            }
