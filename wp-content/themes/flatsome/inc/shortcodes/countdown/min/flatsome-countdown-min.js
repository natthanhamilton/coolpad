!function (t) {
    ...
    function n(t) {
        return function (e) {
            ...
            if (n)for (var i = 0, o = n.length; o > i; ++i) {
                var r = n[i].match(/%(-|!)?([a-zA-Z]{1})(:[^;]+;)?/), l = s(r[0]), c = r[1] || "", u = r[3] || "", f = null;
                r = r[2], h.hasOwnProperty(r) && (f = h[r], f = Number(t[f])), null !== f && ("!" === c && (f = a(u, f)), "" === c && 10 > f && (f = "0" + f.toString()), e = e.replace(l, f.toString()))
            }
            return e = e.replace(/%%/, "%")
        }
    }
    ...
    var i = [], o = [], r = {precision: 100, elapse: !1};
    ...
    t.extend(l.prototype, {
        ...
        return this.each(function () {
            ...
            if (void 0 !== s) {
                var n = i[s], a = e[0];
                l.prototype.hasOwnProperty(a) ? n[a].apply(n, e.slice(1)) : null === String(a).match(/^[$A-Z_][0-9A-Z_$]*$/i) ? (n.setFinalDate.call(n, a), n.start()) : t.error("Method %s does not exist on jQuery.countdown".replace(/\%s/gi, a))
    ...
    $("[data-countdown]").each(function () {
        var t = $(this), e = $(this).data("countdown"), s = $(this).data("text-hour"), n = $(this).data("text-min"), a = $(this).data("text-week"), i = $(this).data("text-plural"), o = $(this).data("text-day"), r = $(this).data("text-sec");
        t.countdown(e).on("update.countdown", function (t) {
            var e = "<span>%H<strong>" + s + "%!H:" + i + ";</strong></span><span>%M<strong>" + n + "</strong></span><span>%S<strong>" + r + "</strong></span>";
            t.offset.days > 0 && (e = "<span>%-d<strong>" + o + "%!d:" + i + ";</strong></span>" + e), t.offset.weeks > 0 && (e = "<span>%-w<strong>" + a + "%!w:" + i + ";</strong></span>" + e), $(this).html(t.strftime(e))
