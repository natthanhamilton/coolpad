...
function flatsome_countdown_shortcode_scripts() {
    wp_register_style('flatsome-countdown-style',
                      get_template_directory_uri() . '/inc/shortcodes/countdown/flatsome-countdown.css',
                      'flatsome-style');
    wp_register_script('flatsome-countdown-script',
                       get_template_directory_uri() . '/inc/shortcodes/countdown/flatsome-countdown.js', 'jQuery');
}
...
function ux_countdown_shortcode($atts) {
    ...
    // Texts
    $translations
        = 'data-text-plural="' . $t_plural . '" data-text-hour="' . $t_hour . '" data-text-day="' . $t_day . '" data-text-week="' . $t_week . '" data-text-min="' . $t_min . '" data-text-sec="' . $t_sec . '"';
    if ($style == 'clock') {
