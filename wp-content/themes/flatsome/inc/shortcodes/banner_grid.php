    ...
    <?php if ($padding && $grid)
{
    $padding_w = $padding / 2; ?>
    <style>
        #banner_grid_<?php echo $shortcode_id; ?> .ux_banner-grid {
            margin-left: -<?php echo $padding_w; ?>px !important;
            margin-right: -<?php echo $padding_w ?>px !important;
        }

        #banner_grid_<?php echo $shortcode_id; ?> .ux_banner-grid .columns {
            margin-bottom: <?php echo $padding; ?> !important
        }

        #banner_grid_<?php echo $shortcode_id; ?> .ux_banner-grid .columns > .column-inner {
