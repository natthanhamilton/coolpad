...
$text_align = ['Left' => 0, 'Center' => 'center', 'Right' => 'right'];
// Shortcode options
$options = [];
switch ($shortcode_id) {
    case 'section':
    ...
    case 'featured_box':
        $options = [
            ...
            [
                ...
                "value"      => ["0px" => "0", "1px" => "1px", "2px" => "2px", "3px" => "3px", "4px" => "4px", "5px" => "5px", "6px" => "6px",]
            ],
            [
                "type"       => "colorpicker",
    ...
    case 'lightbox':
        $options = [
            ...
            [
                ...
                "value"       => ['Always' => 'always', 'Only Once' => 'once'],
            ]
        ];
        break;
    case 'message_box':
    ...
    case 'testimonial':
        $options = [
            ...
            [
                ...
                "heading"     => "Text align",
                "param_name"  => "text_align",
                "value"       => ['Left' => 'text-left', 'Center' => 'text-center'],
                "admin_label" => TRUE,
            ]
        ];
        break;
    ...
    <?php } // dropdown
        ...
        <?php } // colorpicker
            ...
            if ($option['type'] == 'colorpicker') { ?>
                <h3><?php echo $option['heading']; ?></h3>
                <div class="ux-option">
                    <input type="text" data-id="<?php echo $option['param_name'] ?>" value=""
                           placeholder="Default: <?php echo $option['value']; ?>" class="ux-color-picker"/>
                    <small><?php if (isset($option['description'])) echo $option['description']; ?></small>
                </div>
            <?php } // colorpicker
            // imageselect
                ...
                if ($option['type'] == 'attach_image') { ?>
                    ...
                    <div class="ux-option">
                        <div class="attach-image-upload" data-upload="<?php echo $option['param_name'] ?>">
                            <input data-id="<?php echo $option['param_name'] ?>"
                                   placeholder="Enter image url or #hexcode"/><a
                                href="#" class="button">Select</a>
                        </div>
                        <small><?php if (isset($option['description'])) echo $option['description']; ?></small>
                ...
                //checkbox
                    ...
                    <?php } //block
                        ...
                        if ($option['type'] == 'select_block') { ?>
                            ...
                            $data
                                        = '<select id="block-select" data-id="' . $option['param_name'] . '" style="margin-bottom:15px">';
                        ...
                        //product category
                            ...
                            if ($option['type'] == 'product_category') { ?>
                                <h3><?php echo $option['heading']; ?></h3>
                                <div class="ux-option">
                                    <?php
                                    $categories = get_terms('product_cat');
                                    $data
                                                = '<select name="' . $option['param_name'] . '" data-id="' . $option['param_name'] . '">';
                            ...
                            <?php } //product category by ID
                            else {
                                if ($option['type'] == 'product_category_id') { ?>
                                    <h3><?php echo $option['heading']; ?></h3>
                                    <div class="ux-option">
                                ...
                                <?php } //Featured items
                                    ...
                                    if ($option['type'] == 'featured_items_category') { ?>
                                        <h3><?php echo $option['heading']; ?></h3>
                                        <div class="ux-option">
                                            <?php
                                    ...
                                    <?php } //IMAGE SELECT
                                        ...
                                        if ($option['type'] == 'image_select') { ?>
                                            <h3><?php echo $option['heading']; ?></h3>
                                            <div class="ux-option">
                                                <div class="ux-image-select"
                                                     data-images="<?php echo $option['param_name'] ?>">
                                                    <input data-id="<?php echo $option['param_name'] ?>"
                                                           style="display:none;"/>
                                                    <?php foreach ($option['value'] as $value => $key) {
                                                        $title = '';
