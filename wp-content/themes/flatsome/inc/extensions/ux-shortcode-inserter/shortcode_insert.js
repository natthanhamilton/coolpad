            ...
            body: [
                ...
                },
                {
                    ...
                    'values': [
                        ...
                        {
                            text: 'Text Left',
                            value: 'text_align="left" text_pos="left center" text_width="40%" text_bg=""',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="left center" text_width="40%" text_bg=""',
                        ...
                        {
                            text: 'Text Right',
                            value: 'text_align="right" text_pos="right center" text_width="40%" text_bg=""',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="right center" text_width="40%" text_bg=""',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="bottom center" text_width="40%" text_bg=""',
                        ...
                        {
                            text: 'Text Top Left',
                            value: 'text_align="left" text_pos="left top" text_width="40%" text_bg=""',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="top center" text_width="70%" text_bg=""',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="left" text_pos="left center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="left" text_pos="right center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="center" text_width="40%" text_bg="#000" text_bg_opacity=0.8" padding="30px"',
                        ...
                        },
                        {
                            ...
                            value: 'text_align="center" text_pos="bottom full-width" text_bg="#000" text_bg_opacity=0.8" padding="10px"',
                ...
                },
                {
                    ...
                    'values': [
                        {
                            text: 'Default',
                            value: '<h4 class="alt-font">Smaller On Top</h4><p>___</p><h1>BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style="alt-button white"]</p>',
                        ...
                        {
                            text: 'Big banner',
                            value: '<h3 class="alt-font">Smaller On Top</h3><p>____</p><h1 class="h-large">BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style="alt-button white"] <br>[button text="button" link="#" size="medium" style="alt-button white"] <br>[button text="button" link="#" size="medium" style="alt-button white"]</p>',
                        ...
                        {
                            text: 'Simple',
                            value: '<h1>BIG HEADLINE</h1><h4 class="thin-font">A smaller text under headline</h4>',
                        ...
                        },
                        {
                            ...
                            value: '<h2>BIG HEADLINE</h2><h4 class="thin-font">A smaller text under headline</h4><p>[button text="button" link="#" size="medium" style=""] <br>[button text="button" link="#" size="medium" style="alt-button"]</p>',
                        ...
                        },
                        {
                            ...
                            value: '<h2 class="text-bordered-white">BIG HEADLINE</h2><h4 class="thin-font">A smaller text under headline</h4>',
            ...
            body: [
                ...
                },
                {
                    ...
                    'values': [
                        ...
                        {
                            text: 'Text',
                            value: '<h3>Add a title here</h3>[divider]<p>Neque porro quisquam est qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit.</p>'
                        },
                        {
                            text: 'Featured Box - Icon Top',
                            value: '[featured_box title="Title text" img="http://iconurl" img_width="" pos="center" link=""]<p>Featured box text</p>[/featured_box]<br>'
                        },
                        {
                            text: 'Featured Box - Icon Left',
                            value: '[featured_box title="Title text" img="http://iconurl" img_width="" pos="left" link=""]<p>Featured box text</p>[/featured_box]<br>'
                        },
                        {
                            text: 'Team Members',
                            value: '[team_member name="Name" title="Title" facebook="http://" twitter="http://" pinterest="http://"  img="http://imageurl"]<br>Team member description<br>[/team_member]<br>'
                        },
                        {
                            text: 'Price Table',
                            value: '[ux_price_table title="Awesome title" featured="false" description="This is a description" button_text="Order Now" button_link="#"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[bullet_item text="This is a bullet item"]<br>[/ux_price_table]<br>'
                        },
                        {
                            text: 'Testimonial',
                            value: '[testimonial image="http://imageurl" name="Author name" company="Company name" stars="5"]<br> Add testimonial text here <br>[/testimonial]<br>'
                        },
                    ]
                }
