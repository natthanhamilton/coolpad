...
class flatsome_Welcome {
    ...
    public function __construct() {
        add_action('admin_menu', [$this, 'flatsome_welcome_register_menu']);
        add_action('load-themes.php', [$this, 'flatsome_activation_admin_notice']);
        add_action('admin_enqueue_scripts', [$this, 'flatsome_welcome_style']);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_intro'], 10);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_tabs'], 20);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_getting_started'], 30);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_addons'], 40);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_child_themes'], 50);
        add_action('flatsome_welcome', [$this, 'flatsome_welcome_who'], 60);
    } // end constructor
    ...
    public function flatsome_activation_admin_notice() {
        ...
        if (is_admin() && 'themes.php' == $pagenow && isset($_GET['activated'])) { // input var okay
            add_action('admin_notices', [$this, 'flatsome_welcome_admin_notice'], 99);
        }
    }
    ...
    public function flatsome_welcome_admin_notice() {
        ...
        <div class="updated notice is-dismissible">
            <p><?php echo sprintf(esc_html__('Thanks for choosing Flatsome! You can read hints and tips on how get the most out of your new theme on the %swelcome screen%s.',
                                             'flatsome'),
                                  '<a href="' . esc_url(admin_url('themes.php?page=flatsome-welcome')) . '">',
                                  '</a>'); ?></p>
            <p><a href="<?php echo esc_url(admin_url('themes.php?page=flatsome-welcome')); ?>" class="button"
                  style="text-decoration: none;"><?php _e('Get started with flatsome', 'flatsome'); ?></a></p>
        </div>
        <?php
    }
    ...
    public function flatsome_welcome_style() {
        ...
        wp_enqueue_style('flatsome-welcome-screen',
                         get_template_directory_uri() . '/inc/welcome-screen/css/welcome.css', $flatsome_version);
    }
    ...
    public function flatsome_welcome_register_menu() {
        add_theme_page('Flatsome ★', 'Welcome', 'read', 'flatsome-welcome', [$this, 'flatsome_welcome_screen']);
    }
