...
<div id="add_ons" class="storefront-add-ons panel" style="padding-top: 1.618em; clear: both;">
    ...
    <div class="add-on">
        ...
        <div class="content">
            ...
            { ?>
                <p>
                    <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=jetpack'), 'install-plugin_jetpack')); ?>"
            ...
            { ?>
                <p>
                    <a href="https://www.woothemes.com/products/storefront-designer?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons"
                       class="button button-primary"><?php printf(__('Buy %sStorefront Designer%s now', 'storefront'), '<span class="screen-reader-text">', '</span>'); ?></a>
                </p>
            <?php } ?>
        </div>
    </div>
            ...
            { ?>
                <p>
                    <a href="https://www.woothemes.com/products/storefront-product-hero?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons"
                       class="button button-primary"><?php printf(__('Buy %sStorefront Product Hero%s now', 'storefront'), '<span class="screen-reader-text">', '</span>'); ?></a>
                </p>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="add-on image-vertical share">
        ...
        <div class="content">
            ...
            { ?>
                <p>
                    <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=storefront-product-sharing'), 'install-plugin_storefront-product-sharing')); ?>"
                       class="button button-primary"><?php _e('Install Storefront Product Sharing', 'storefront'); ?></a>
                </p>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="add-on image-horizontal footer-bar">
        ...
        <div class="content">
            ...
            { ?>
                <p>
                    <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=storefront-footer-bar'), 'install-plugin_storefront-footer-bar')); ?>"
    ...
    <div class="add-on image-horizontal product-pagination">
        ...
        <div class="content">
            ...
            { ?>
                <p>
                    <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=storefront-product-pagination'), 'install-plugin_storefront-product-pagination')); ?>"
                       class="button button-primary"><?php _e('Install Storefront Product Pagination', 'storefront'); ?></a>
                </p>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="add-on image-vertical wc-customiser">
        <h4><?php _e('Refine your shop archives and product pages with the Storefront WooCommerce Customiser', 'storefront'); ?>
            ...
            { ?>
                <p>
                    <a href="https://www.woothemes.com/products/storefront-woocommerce-customiser?utm_source=product&utm_medium=upsell&utm_campaign=storefrontaddons"
                       class="button button-primary"><?php printf(__('Buy %sStorefront WooCommerce Customiser%s now', 'storefront'), '<span class="screen-reader-text">', '</span>'); ?></a>
                </p>
            <?php } ?>
        </div>
    </div>
    ...
    <div class="add-on">
        ...
        <div class="content">
            ...
            { ?>
                <p>
                    <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=storefront-top-bar'), 'install-plugin_storefront-top-bar')); ?>"
