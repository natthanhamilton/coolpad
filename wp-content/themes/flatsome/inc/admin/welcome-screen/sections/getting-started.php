...
<div id="getting_started" class="col two-col panel"
    ...
    <div class="col-1">
        ...
        { ?>
            ...
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=woocommerce'), 'install-plugin_woocommerce')); ?>"
    ...
    <div class="col-2 last-feature">
        ...
        { ?>
            <p>
                <a href="<?php echo esc_url(wp_nonce_url(self_admin_url('update.php?action=install-plugin&plugin=homepage-control'), 'install-plugin_homepage-control')); ?>"
