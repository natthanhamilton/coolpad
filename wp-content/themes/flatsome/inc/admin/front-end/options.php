			...
			<div id="of-nav">
				...
				<div class="save_bar">
					<button id="of_save" type="button"
					        class="button-primary"><?php _e('Save All Changes', 'ux-admin'); ?></button>
				...
				<?php if (function_exists('pll_get_post')) {
					...
					<div style="padding:18px">
						...
						<small>NB: You need to translate Theme Options strings once more if you have changed them.
						</small>
					</div>
				<?php } ?>
			...
			<div id="content">
				...
				<div class="save_bar" style="padding-left:0;">
					...
					<button id="of_reset" type="button"
					        class="button submit-button reset-button"><?php _e('Options Reset', 'ux-admin'); ?></button>
					<img style="display:none" src="<?php echo ADMIN_DIR; ?>assets/images/loading-bottom.gif"
