...
function optionsframework_add_admin() {
    $of_page = add_theme_page(THEMENAME, 'Theme Options', 'edit_theme_options', 'optionsframework',
...
function of_load_only() {
    ...
    wp_enqueue_script('jquery-input-mask', ADMIN_DIR . 'assets/js/jquery.maskedinput-1.2.2.js', ['jquery']);
    wp_enqueue_script('tipsy', ADMIN_DIR . 'assets/js/jquery.tipsy.js', ['jquery']);
    ...
    if (!wp_script_is('wp-color-picker', 'registered')) {
        wp_register_script('iris', ADMIN_DIR . 'assets/js/iris.min.js',
                           ['jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch'], FALSE, 1);
        wp_register_script('wp-color-picker', ADMIN_DIR . 'assets/js/color-picker.min.js', ['jquery', 'iris']);
    }
