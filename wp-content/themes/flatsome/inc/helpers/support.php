...
function flatsome_support_helper()
{
    ...
    <script>!function (e, o, n) {
            ...
            t.userConfig = {}, t.readyQueue = [], t.config = function (e) {
                ...
                docs: {enabled: !0, baseUrl: "//uxthemes.helpscoutdocs.com/"},
                contact: {enabled: !0, formId: "ed63939e-62f5-11e5-8846-0e599dc12a51"}
            };
    ...
    <style>
        #wpadminbar #wp-admin-bar-flatsome-beacon > .ab-item:before {
            content: "\f223";
            top: 2px;
        }

        #wpadminbar #wp-admin-bar-theme_options > .ab-item:before {
            content: "\f111";
            top: 2px;
        }
    </style>
