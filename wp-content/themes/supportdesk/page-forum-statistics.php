                            ...
                            <dl role="main">
                                ...
                                <?php if (! empty($topic_count_hidden)) : ?>
                                    ...
                                    <dd>
                                        <strong>
                                            <abbr
                                                title="<?php echo esc_attr($hidden_topic_title); ?>"><?php echo $topic_count_hidden; ?></abbr>
                                        </strong>
                                    </dd>
                                ...
                                <?php if (! empty($reply_count_hidden)) : ?>
                                    ...
                                    <dd>
                                        <strong>
                                            <abbr
                                                title="<?php echo esc_attr($hidden_reply_title); ?>"><?php echo $reply_count_hidden; ?></abbr>
                                        </strong>
                                    </dd>
