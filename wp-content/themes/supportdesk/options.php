...
function optionsframework_options() {
    ...
    $options = [];
    $options[] = ["name" => __("Homepage Options", "framework"),
                  "type" => "heading"];
    $options[] = [
    ...
    $options[] = [
        ...
        'desc' => __('', 'framework'),
        'type' => 'info'];
    $options[] = ["name"    => __("Homepage Blocks Layout", "framework"),
    ...
    $options[] = ["name"    => __("Homepage Sidebar Position", "framework"),
    ...
    $options[] = ["name" => __("Blog Options", "framework"),
                  "type" => "heading"];
    $options[] = [
    ...
    $options[] = [
        ...
        'desc' => __('Check to show an author box at the end of blog posts. (Note: The author must have a bio for the box to show).',
                     'framework'),
        'id'   => 'st_single_authorbox',
        'std'  => '1',
        'type' => 'checkbox'];
    $options[] = ["name" => __("Knowledgebase Options", "framework"),
                  "type" => "heading"];
    $options[] = ['name'  => __('Knowledgebase Slug', 'framework'),
                  'desc'  => __('Enter the slug for your Knowledgebase articles. (Important: Set and resave your permalinks when you change this option).',
                                'framework'),
                  'id'    => 'st_kb_slug',
                  'std'   => 'knowledgebase',
                  'class' => 'mini',
                  'type'  => 'text'];
    $options[] = ['name'  => __('Number of articles displayed below category', 'framework'),
                  'desc'  => __('The number of articles to show below each category.', 'framework'),
                  'id'    => 'st_kb_category_articles',
                  'std'   => '5',
                  'class' => 'mini',
                  'type'  => 'text'];
    $options[] = ['name'  => __('Articles per page', 'framework'),
                  'desc'  => __('The number of articles to show', 'framework'),
                  'id'    => 'st_kb_articles_per_page',
                  'std'   => '8',
                  'class' => 'mini',
                  'type'  => 'text'];
    $options[] = ["name"    => __("Sidebar Position", "framework"),
                  "desc"    => __("Select the sidebar position for Knowledge Base pages.", "framework"),
                  "id"      => "st_kb_sidebar",
                  "std"     => "right",
                  "type"    => "images",
    ...
    $options[] = ["name" => __("Forum Options", "framework"),
                  "type" => "heading"];
    $options[] = [
    ...
    $options[] = ["name" => __("Advanced Options", "framework"),
                  "type" => "heading"];
    $options[] = ['name' => __('Disable Live Search', 'framework'),
                  'desc' => __('Globally disable live search. Applies to Knowledge Base & Forums', 'framework'),
                  'id'   => 'st_live_search',
                  'std'  => '0',
                  'type' => 'checkbox'];
    $options[] = ["name" => __("Custom CSS", "framework"),
