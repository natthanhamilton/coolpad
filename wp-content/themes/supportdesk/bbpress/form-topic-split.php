                    ...
                    <div>
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <label
                                    for="bbp_topic_split_option_reply"><?php printf(__('New topic in <strong>%s</strong> titled:', 'bbpress'), bbp_get_forum_title(bbp_get_topic_forum_id(bbp_get_topic_id()))); ?></label>
                            ...
                            <?php if (bbp_has_topics(array('show_stickies' => FALSE, 'post_parent' => bbp_get_topic_forum_id(bbp_get_topic_id()), 'post__not_in' => array(bbp_get_topic_id())))) : ?>
                                ...
                                <div>
                                    ...
                                    <label
                                        for="bbp_topic_split_option_existing"><?php _e('Use an existing topic in this forum:', 'bbpress'); ?></label>
                        ...
                        <fieldset class="bbp-form">
                            ...
                            <div>
                                ...
                                <?php if (bbp_is_subscriptions_active()) : ?>
                                    ...
                                    <label
                                        for="bbp_topic_subscribers"><?php _e('Copy subscribers to the new topic', 'bbpress'); ?></label>
                                    <br/>
                                ...
                                <label
                                    for="bbp_topic_favoriters"><?php _e('Copy favoriters to the new topic', 'bbpress'); ?></label><br/>
                                ...
                                <?php if (bbp_allow_topic_tags()) : ?>
                                    ...
                                    <input name="bbp_topic_tags" id="bbp_topic_tags" type="checkbox" value="1"
                                           checked="checked" tabindex="<?php bbp_tab_index(); ?>"/>
                                    <label
                                        for="bbp_topic_tags"><?php _e('Copy topic tags to the new topic', 'bbpress'); ?></label>
                                    <br/>
