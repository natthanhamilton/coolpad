...
<div class="bbp-forum-header">
    ...
    <div class="bbp-meta">
        ...
        <span
            class="bbp-forum-post-date"><?php printf(__('Last updated %s', 'bbpress'), bbp_get_forum_last_active_time()); ?></span>

        <a href="<?php bbp_forum_permalink(); ?>" title="<?php bbp_forum_title(); ?>"
           class="bbp-forum-permalink">#<?php bbp_forum_id(); ?></a>
    ...
    <div class="bbp-forum-title">
        ...
        <h3><?php _e('Forum: ', 'bbpress'); ?><a href="<?php bbp_forum_permalink(); ?>"
                                                 title="<?php bbp_forum_title(); ?>"><?php bbp_forum_title(); ?></a>
        </h3>
