...
if (!function_exists('optionsframework_media_scripts')) :
    ...
    function optionsframework_media_scripts($hook) {
        ...
        wp_register_script('of-media-uploader', OPTIONS_FRAMEWORK_DIRECTORY . 'js/media-uploader.js', ['jquery']);
        wp_enqueue_script('of-media-uploader');
        wp_localize_script('of-media-uploader', 'optionsframework_l10n', [
