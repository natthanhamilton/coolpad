...
function optionsframework_init() {
    ...
    $location    = apply_filters('options_framework_location', ['options.php']);
...
if (!function_exists('optionsframework_add_page')) {
    function optionsframework_add_page() {
        $of_page = add_theme_page(__('Theme Options', 'options_framework_theme'),
                                  __('Theme Options', 'options_framework_theme'), 'edit_theme_options',
                                  'options-framework', 'optionsframework_page');
...
function optionsframework_load_scripts($hook) {
    ...
    if (!wp_script_is('wp-color-picker', 'registered')) {
        wp_register_script('iris', OPTIONS_FRAMEWORK_DIRECTORY . 'js/iris.min.js',
                           ['jquery-ui-draggable', 'jquery-ui-slider', 'jquery-touch-punch'], FALSE, 1);
        wp_register_script('wp-color-picker', OPTIONS_FRAMEWORK_DIRECTORY . 'js/color-picker.min.js',
                           ['jquery', 'iris']);
        $colorpicker_l10n = [
    ...
    wp_enqueue_script('options-custom', OPTIONS_FRAMEWORK_DIRECTORY . 'js/options-custom.js',
                    ...
                    <form action="options.php" method="post">
                        ...
                        <div id="optionsframework-submit">
                            <input type="submit" class="button-primary" name="update"
                                   value="<?php esc_attr_e('Save Options', 'options_framework_theme'); ?>"/>
                            <input type="submit" class="reset-button button-secondary" name="reset"
                                   value="<?php esc_attr_e('Restore Defaults', 'options_framework_theme'); ?>"
...
function optionsframework_validate($input) {
    ...
    if (isset($_POST['reset'])) {
        add_settings_error('options-framework', 'restore_defaults',
...
function optionsframework_save_options_notice() {
    add_settings_error('options-framework', 'save_options', __('Options saved.', 'options_framework_theme'),
                       'updated fade');
}
