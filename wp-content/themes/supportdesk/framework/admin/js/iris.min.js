        ...
        fromCSS: function (e) {
            ...
            if (e.match(r) && e.match(/\)$/)) {
                ...
                return e.match(/^rgb/) ? this.fromRgb({
                    ...
                    g: n[1],
                    b: n[2]
                }) : e.match(/^hsv/) ? this.fromHsv({h: n[0], s: n[1], v: n[2]}) : this.fromHsl({
                    h: n[0],
                    s: n[1],
                    l: n[2]
                })
