    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <select id="<?php echo $this->get_field_id('order'); ?>"
                    name="<?php echo $this->get_field_name('order'); ?>" class="widefat" style="width:100%;">
        ...
        <p>
            ...
            <select id="<?php echo $this->get_field_id('order_by'); ?>"
                ...
                <option <?php if ('popularity' == $instance['order_by']) echo 'selected="selected"'; ?>>popularity
                </option>
                <option <?php if ('comments' == $instance['order_by']) echo 'selected="selected"'; ?>>comment_count
                </option>
            </select>
        </p>
