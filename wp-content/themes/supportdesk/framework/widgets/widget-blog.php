...
class st_blog_widget extends WP_Widget {
    ...
    function st_blog_widget() {
        /* Widget settings. */
        $widget_ops
            = ['classname' => 'st_blog_widget', 'description' => __('A widget that displays your latest posts with image.',
                                                                    'framework')];
        /* Widget control settings. */
        $control_ops = ['id_base' => 'st_blog_widget'];
        /* Create the widget. */
    ...
    function form($instance) {
        ...
        <p>
            <label
                for="<?php echo $this->get_field_id('number'); ?>"><?php _e('Amount to show:', 'framework') ?></label>
