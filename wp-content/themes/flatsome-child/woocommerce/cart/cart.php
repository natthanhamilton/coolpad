    ...
    <script type="application/javascript">
        $(document).ready(function () {
            function updateShipping() {
                var total = $(".cart-subtotal").find('.amount').text().replace('$','').replace('.00','').replace(',','');
                if (total >= 14920) {
                    $("#shipping_method").html(
                        '<li>' +
                        '<input type="radio" name="shipping_method[0]" data-index="0" id="shipping_method_0_free_shipping3" value="free_shipping:3" class="shipping_method" checked>' +
                        '<label for="shipping_method_0_free_shipping3">Free Shipping <br> <small>Ships FedEx Ground. 2-5 Handling Days.</small></label>' +
                        '</li>'
                    );
                }
                console.log(total);
                ...
                <table class="shop_table shop_table_responsive cart" cellspacing="0">
                                    ...
                                    if (!$product_permalink) {
                                        ...
                                        echo apply_filters('woocommerce_cart_item_name',
                                                           sprintf('<a href="%s">%s</a>', esc_url($product_permalink),
                                                                   $_product->get_title()), $cart_item, $cart_item_key);
                                    }
                                    // Meta data
                    ...
                    <tr>
                        <td colspan="6" class="actions clear">
                            ...
                            <input type="submit" class="button left small" name="update_cart"
                    ...
                    <form class="checkout_coupon" method="post">
                        <div class="coupon">
                            ...
                            <input type="text" name="coupon_code" class="input-text" id="coupon_code" value=""
                                ...
                                type="submit" class="button small expand" name="apply_coupon"
