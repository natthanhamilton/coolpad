...
if (!class_exists("Ultimate_Info_Table")) {
	class Ultimate_Info_Table {
		function __construct() {
			add_action("init", [$this, "ultimate_it_init"]);
			add_shortcode("ultimate_info_table", [$this, "ultimate_it_shortcode"]);
			add_action('wp_enqueue_scripts', [$this, 'info_table_assets'], 1);
		}
		...
		function info_table_assets() {
			...
			wp_register_style('ultimate-pricing', plugins_url($css_path . 'pricing' . $ext . '.css', __FILE__), [],
					...
					[
						...
						"params"      => [
							...
							[
								...
								"dependency"  => ["element" => "color_scheme", "value" => ["custom"]],
							],
							[
								"type"        => "colorpicker",
								"class"       => "",
							...
							[
								...
								"dependency"  => ["element" => "use_cta_btn", "value" => ["true"]],
							],
							[
								"type"        => "vc_link",
								"class"       => "",
								...
								"dependency"  => ["element" => "use_cta_btn", "value" => ["true", "box"]],
							],
							/* typoraphy - heading */
							[
							...
							[
								"type"             => "ult_param_heading",
								"text"             => "<span style='display: block;'><a href='http://bsf.io/t9vlh' target='_blank'>" . __("Watch Video Tutorial",
