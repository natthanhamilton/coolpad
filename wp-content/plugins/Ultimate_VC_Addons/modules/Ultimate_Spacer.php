...
if (!class_exists("Ultimate_Spacer")) {
	class Ultimate_Spacer {
		function __construct() {
			add_action("init", [$this, "ultimate_spacer_init"]);
			add_shortcode("ultimate_spacer", [$this, "ultimate_spacer_shortcode"]);
		}
					...
					[
						...
						"params"      => [
							[
								"type"        => "number",
								"class"       => "",
								"heading"     => __("<i class='dashicons dashicons-desktop'></i> Desktop",
								                    "ultimate_vc"),
								"param_name"  => "height",
								"admin_label" => TRUE,
								"value"       => 10,
							...
							[
								"type"             => "number",
								"class"            => "",
								"heading"          => __("<i class='dashicons dashicons-tablet' style='transform: rotate(90deg);'></i> Tabs",
								                         "ultimate_vc"),
							...
							[
								"type"             => "number",
								"class"            => "",
								"heading"          => __("<i class='dashicons dashicons-tablet'></i> Tabs",
								                         "ultimate_vc"),
							...
							[
								"type"             => "number",
								"class"            => "",
								"heading"          => __("<i class='dashicons dashicons-smartphone' style='transform: rotate(90deg);'></i> Mobile",
								                         "ultimate_vc"),
							...
							[
								"type"             => "number",
								"class"            => "",
								"heading"          => __("<i class='dashicons dashicons-smartphone'></i> Mobile",
								                         "ultimate_vc"),
