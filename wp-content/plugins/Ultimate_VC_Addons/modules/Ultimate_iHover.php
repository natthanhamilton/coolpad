...
if (!class_exists('ULT_iHover')) {
    class ULT_iHover {
        function __construct() {
            add_shortcode("ult_ihover", [$this, "ult_ihover_callback"]);
            add_shortcode("ult_ihover_item", [$this, "ult_ihover_item_callback"]);
            add_action('init', [$this, 'ult_ihover_init']);
            add_action('wp_enqueue_scripts', [$this, 'ult_ihover_scripts'], 1);
        }

        function ult_ihover_callback($atts, $content = NULL) {
            /*	global variables */
            global $glob_gutter_width, $glob_thumb_height_width, $glob_ihover_shape;
            $glob_gutter_width  = $glob_thumb_height_width = $glob_ihover_shape
                = /* $glob_ihover_effect = $glob_ihover_effectdirection = $glob_ihover_effectscale */
                '';
        ...
        function ult_ihover_item_callback($atts, $content = NULL) {
            ...
            $title_margin = $divider_margin
                ...
                = $desc_font
                = $desc_font_style
                = $desc_font_size = $desc_font_line_height = $desc_font_color = $itemOutput = $title = $itemOutput = '';
            extract(shortcode_atts([
                                       'thumb_img'                    => '',
                                       'title'                        => '',
                                       'title_text_typography'        => '',
            ...
            switch ($effect) {
                case 'effect6':
                    if ($effect_scale != '') : $Scale = 'ult-ih-' . $effect_scale; endif;
                    break;
            }
            ...
            switch ($effect) {
                ...
                case 'effect14':
                case 'effect18':
                    if ($effect_direction != '') : $Direction = 'ult-ih-' . $effect_direction; endif;
                    break;
            }
            $TopBottom = '';
            switch ($effect) {
            ...
            switch ($effect) {
                case 'effect8':
                    ...
                    $itemOutput .= $this->commonStructure($desc_responsive, $title_responsive, $heading_block,
                                                          $title_style, $title, $spacer_style, $spacer_line_style,
                                                          $description_block, $desc_style, $content);
                    $itemOutput .= '	</div>';
                    $itemOutput .= '</div>';
                    break;
                case 'effect1':
        ...
        function commonStructure($desc_responsive, $title_responsive, $heading_block, $title_style, $title,
                                 $spacer_style, $spacer_line_style, $description_block, $desc_style, $content) {
            $itemOutput = '';
        ...
        function ult_ihover_init() {
            ...
            if (function_exists("vc_map")) {
                vc_map([
                           ...
                           "base"                    => "ult_ihover",
                           "as_parent"               => ['only' => 'ult_ihover_item'], // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
                           ...
                           "params"                  => [
                               ...
                               [
                                   ...
                                   "suffix"     => "px",
                                   "value"      => "",
                                   "dependency" => ["element" => "responsive_size", "value" => "on"],
                               ],
                               [
                                   "type"       => "number",
                ...
                vc_map([
                           ...
                           "icon"            => "ult_ihover",
                           "class"           => "ult_ihover",
                           "as_child"        => ['only' => 'ult_ihover'], // Use only|except attributes to limit parent (separate multiple values with comma)
                           "is_container"    => FALSE,
                           "params"          => [
                               // General
                               [
                               ...
                               [
                                   ...
                                   "dependency"  => ["element" => "hover_effect", "value" => ["effect2", "effect3", "effect4", "effect7", "effect8", "effect9", "effect11", "effect12", "effect13", "effect14", "effect18"]],
                                   /*"group" => "Effects",*/
                               ],
                               [
                                   "type"        => "dropdown",
                                   ...
                                   "dependency"  => ["element" => "hover_effect", "value" => "effect6"],
                                   /*"group" => "Effects",*/
                               ],
                               [
                                   "type"        => "dropdown",
                                   ...
                                   "description" => __("Select the Hover Effect Direction for iHover.", "ultimate_vc"),
                                   "dependency"  => ["element" => "hover_effect", "value" => ["effect10", "effect20"]],
                                   /*"group" => "Effects",*/
                               ],
                               [
                                   "type"        => "dropdown",
                                   ...
                                   "description" => __("Select the Hover Effect Direction for iHover.", "ultimate_vc"),
                                   "dependency"  => ["element" => "hover_effect", "value" => "effect16"],
                                   /*"group" => "Effects",*/
                               ],
                               [
                                   "type"       => "dropdown",
                               ...
                               [
                                   ...
                                   "dependency"  => ["element" => "block_click", "value" => "link"],
                               ],
                               [
                                   "type"       => "colorpicker",
                               ...
                               [
                                   ...
                                   "dependency" => ["element" => "thumbnail_border_styling", "value" => "solid"],
                                   "group"      => "Design",
                               ],
                               [
                                   "type"       => "number",
                               ...
                               [
                                   ...
                                   "description" => __("Select Heading & Description's Divider Border Style.",
                                                       "ultimate_vc"),
                                   "group"       => "Design"
                               ],
                               [
                                   ...
                                   "dependency"  => ["element" => "spacer_border", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
                                   "group"       => "Design"
                               ],
                               [
                                   "type"        => "number",
                               ...
                               [
                                   ...
                                   "value"            => "",
                                   "description"      => __("Add Space Between Title, Divider and Description. Just put only numbers in textbox. All values will consider in px.",
                                                            "ultimate_vc"),
                                   "group"            => "Design",
                                   'edit_field_class' => 'ult-param-heading-wrapper vc_column vc_col-sm-12',
                               ],
        ...
        function ult_ihover_scripts() {
            ...
            wp_register_script('ult_ihover_js', plugins_url($js_path . 'ihover' . $ext . '.js', __FILE__), ['jquery'],
