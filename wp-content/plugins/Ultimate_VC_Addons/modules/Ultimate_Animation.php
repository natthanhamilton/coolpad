...
if (!class_exists('Ultimate_Animation')) {
    class Ultimate_Animation {
        function __construct() {
            add_shortcode('ult_animation_block', [$this, 'animate_shortcode']);
            add_action('init', [$this, 'animate_shortcode_mapper']);
        }/* end constructor*/
        function animate_shortcode($atts, $content = NULL) {
            //wp_enqueue_script('ultimate-appear');
            //wp_enqueue_script('ultimate-custom');
            $output
                                       = $animation = $opacity = $opacity_start_effect
                = $animation_duration = $animation_delay = $animation_iteration_count = $inline_disp = $el_class = '';
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "as_parent"               => ['except' => 'ult_animation_block'],
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "options"     => [
                                    "set" => [
                                        "label" => __("If set to yes, the elements inside block will stay hidden until animation starts (depends on delay settings above).",
                                                      'ultimate_vc'),
                                        "on"    => "Yes",
                                        "off"   => "No",
                                    ],
                            ...
                            [
                                ...
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/pd-ct' target='_blank'>" . __("Watch Video Tutorial",
