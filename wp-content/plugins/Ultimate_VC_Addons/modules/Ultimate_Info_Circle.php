...
if (!class_exists('Ultimate_Info_Circle')) {
    class Ultimate_Info_Circle {
        function __construct() {
            add_action('init', [$this, 'add_info_circle']);
            add_action("wp_enqueue_scripts", [$this, "register_info_circle_assets"], 1);
            add_shortcode('info_circle', [$this, 'info_circle']);
            add_shortcode('info_circle_item', [$this, 'info_circle_item']);
        }
        ...
        function register_info_circle_assets() {
            ...
            wp_register_script("info-circle", plugins_url($js_path . "info-circle" . $ext . ".js", __FILE__),
                               ['jquery'], ULTIMATE_VERSION);
            wp_register_script("info-circle-ui-effect",
                               plugins_url($js_path . "jquery-ui-effect" . $ext . ".js", __FILE__), ['jquery'],
                               ULTIMATE_VERSION);
            wp_register_style("info-circle", plugins_url($css_path . "info-circle" . $ext . ".css", __FILE__), [],
        ...
        function info_circle($atts, $content = NULL) {
            ...
            $edge_radius
                         = $visible_circle = $start_degree = $eg_padding = $circle_type = $icon_position = $eg_br_width
                = $eg_br_style = $eg_border_color = $cn_br_style = $highlight_style = $responsive_breakpoint = '';
            $icon_size
                         = $cn_br_width
                = $cn_border_color = $icon_diversion = $icon_show = $content_bg = $content_color = $el_class = '';
            $icon_launch = $icon_launch_duration = $icon_launch_delay = $clipped_circle = '';
            $title_font
                         = $title_font_style = $title_font_size
                = $title_line_height = $desc_font = $desc_font_style = $desc_font_size = $desc_line_height = '';
            ...
            $output
                = '<div class="info-wrapper ' . $is_vc_49_plus . '"><div id="info-circle-wrapper-' . $uniq . '" data-uniqid="' . $uniq . '" class="info-circle-wrapper ' . $ex_class . ' ' . $clipped_circle . '" data-half-percentage="' . $visible_circle . '" data-circle-type="' . $circle_type_extended . '">';
        ...
        function info_circle_item($atts, $content = NULL) {
            ...
            // Do nothing
            $info_title
                = $info_icon = $icon_color = $icon_bg_color = $info_img
                = $icon_type = $contents = $radius = $icon_size = $icon_html = $style = $output = $style = $ilink = '';
            extract(shortcode_atts([
                                       'info_title'        => '',
                                       'info_icon'         => '',
                                       'icon_color'        => '',
            ...
            if (function_exists('vc_map')) {
                ...
                vc_map(
                    [
                        ...
                        "as_parent"               => ['only' => 'info_circle_item'],
                        ...
                        "params"                  => [
                            ...
                            */
                            ...
                            [
                                ...
                                "value"      => "70",
                                "suffix"     => "%",
                                "dependency" => ["element" => "icon_position", "value" => ["180", "270", "90", "0"]]
                                //"description" => __("Select area to display thumbnail icon .","smile")
                            ],
                            /*array(
                                "type" => "number",
                            ...
                            [
                                ...
                                "max"         => 360,
                                "suffix"      => "&deg; degree",
                                "description" => __("The degree from where Info Circle will be displayed.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "icon_position", "value" => ["full"]],
                                "group"       => $thumbnail_tab
                            ],
                            [
                                "type"       => "dropdown",
                            ...
                            [
                                ...
                                "description" => __("Select whether you want to show icon in information circle.",
                                                    "ultimate_vc"),
                            ...
                            [
                                ...
                                "value"      => 32,
                                "suffix"     => "px",
                                "dependency" => ["element" => "icon_show", "value" => ["show"]],
                                "group"      => $information_tab
                            ...
                            [
                                ...
                                "dependency" => ["element" => "eg_br_style", "value" => ["solid", "dashed", "dotted"]],
                                "group"      => $connector_tab
                            ],
                            [
                                "type"       => "colorpicker",
                            ...
                            [
                                ...
                                "dependency" => ["element" => "cn_br_style", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
                                "group"      => $information_tab
                            ],
                            [
                                "type"       => "colorpicker",
                            ...
                            [
                                ...
                                "description" => __("Select on which event information should appear in information circle.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"       => "dropdown",
                            ...
                            [
                                ...
                                "value"       => 3,
                                "suffix"      => "seconds",
                                "description" => __("Duration before info circle should display next information on thumbnails.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "auto_slide", "value" => ["on"]],
                            ],
                            [
                                "type"        => "dropdown",
                                "class"       => "",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "icon_launch", "not_empty" => TRUE],
                                "group"       => $thumbnail_tab
                            ],
                            [
                                "type"        => "number",
                            ...
                            [
                                ...
                                "description" => __("Select true to change its display style on low resolution.",
                                                    "ultimate_vc"),
                                //"group" => $reponsive_tab
                            ],
                            [
                                ...
                                "value"       => 800,
                                "suffix"      => "px",
                                "description" => __("Break point is the point of screen resolution from where you can set your info-circle style into list style to the minimum screen resolution.",
                                                    "smile"),
                                "dependency"  => ["element" => "responsive", "value" => ["on"]],
                                //"group" => $reponsive_tab
                            ],
                            [
                                "type"        => "textfield",
                            ...
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/z-dpz' target='_blank'>" . __("Watch Video Tutorial",
                    ...
                    [
                        ...
                        "params"          => [
                            ...
                            [
                                ...
                                "dependency" => ["element" => "icon_br_style", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
                                "group"      => __("Design")
                            ],
                            [
                                "type"       => "colorpicker",
