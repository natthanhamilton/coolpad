...
if (!class_exists('AIO_Stats_Counter')) {
    class AIO_Stats_Counter {
        ...
        function __construct() {
            add_action('init', [$this, 'counter_init']);
            add_action("wp_enqueue_scripts", [$this, "register_counter_assets"], 1);
            add_shortcode('stat_counter', [$this, 'counter_shortcode']);
        }
        ...
        function register_counter_assets() {
            ...
            wp_register_script("ult-stats-counter-js", plugins_url($js_path . "countUp" . $ext . ".js", __FILE__),
                               ['jquery'], ULTIMATE_VERSION);
            wp_register_style("ult-stats-counter-style",
                              plugins_url($css_path . "stats-counter" . $ext . ".css", __FILE__), [], ULTIMATE_VERSION);
        }
                    ...
                    [
                        ...
                        "params"      => [
                            ...
                            [
                                ...
                                "value"       => "1250",
                                "description" => __("Enter number for counter without any special character. You may enter a decimal number. Eg 12.76",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "textfield",
                                ...
                                "value"       => ",",
                                "description" => __("Enter character for thousanda separator. e.g. ',' will separate 125000 into 125,000",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "textfield",
                                ...
                                "value"       => ".",
                                "description" => __("Did you enter a decimal number (Eg - 12.76) The decimal point '.' will be replaced with value that you will enter above.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"        => "textfield",
                            ...
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/t23kn' target='_blank'>" . __("Watch Video Tutorial",
        ...
        function counter_shortcode($atts) {
            ...
            $icon_type
                ...
                = $icon_border_spacing
                = $icon_link = $el_class = $icon_animation = $counter_title = $counter_value = $icon_position
                = $counter_style = $font_size_title = $font_size_counter = $counter_font = $title_font = $speed
                = $counter_sep = $counter_suffix = $counter_prefix
                = $counter_decimal = $counter_color_txt = $desc_font_line_height = $title_font_line_height = '';
            $title_font
                = $title_font_style = $title_font_size = $title_font_color = $desc_font = $desc_font_style
                = $desc_font_size = $desc_font_color = $suf_pref_typography = $suf_pref_font
                = $suf_pref_font_style = $suf_pref_font_color = $suf_pref_font_size = $suf_pref_line_height = '';
            ...
            $css_stat_counter = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                              vc_shortcode_custom_css_class($css_stat_counter, ' '), "stat_counter",
                                              $atts);
