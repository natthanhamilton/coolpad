...
if (!class_exists("Ultimate_Google_Trends")) {
	class Ultimate_Google_Trends {
		function __construct() {
			add_action("init", [$this, "google_trends_init"]);
			add_shortcode("ultimate_google_trends", [$this, "display_ultimate_trends"]);
		}
				...
				vc_map([
					       ...
					       "params"                  => [
						       ...
						       [
							       ...
							       "value"       => "",
							       "description" => __("Enter maximum 5 terms separated by comma. Example:",
							                           "ultimate_vc") . " <em>" . __("Google, Facebook, LinkedIn",
							                                                         "ultimate_vc") . "</em>",
						       ...
						       [
							       ...
							       "admin_label" => TRUE,
							       "value"       => [__("Interest over time",
							                            "ultimate_vc") => "TIMESERIES_GRAPH_0", __("Interest over time with average",
							                                                                       "ultimate_vc") => "TIMESERIES_GRAPH_AVERAGES_CHART", __("Regional interest in map",
							                                                                                                                               "ultimate_vc") => "GEO_MAP_0_0", __("Regional interest in table",
							                                                                                                                                                                   "ultimate_vc") => "GEO_TABLE_0_0", __("Related searches (Topics)",
							                                                                                                                                                                                                         "ultimate_vc") => "TOP_ENTITIES_0_0", __("Related searches (Queries)",
							                                                                                                                                                                                                                                                  "ultimate_vc") => "TOP_QUERIES_0_0"],
							       //"dependency" => Array("element" => "search_by","value" => array("q"))
						       ],
						       /*array(
								   "type" => "dropdown",
						       ...
						       [
							       ...
							       "text"             => "<span style='display: block;'><a href='http://bsf.io/skwuz' target='_blank'>" . __("Watch Video Tutorial",
		...
		function display_ultimate_trends($atts, $content = NULL) {
			$width
				              = $height
				=
			$graph_type = $graph_type_2 = $search_by = $location_by = $gtrend_query = $gtrend_query_2 = $el_class = '';
			$css_design_style = '';
			...
			$css_design_style = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
			                                  vc_shortcode_custom_css_class($css_gtrend_design, ' '),
			                                  "ultimate_google_trends", $atts);
			...
			$id = uniqid('vc-trends-');
			$output
			    = '<div id="' . $id . '" class="ultimate-google-trends ' . $is_vc_49_plus . ' ' . $el_class . ' ' . $css_design_style . '">
