...
if (!class_exists('AIO_Interactive_Banners')) {
    class AIO_Interactive_Banners {
        function __construct() {
            ...
            add_shortcode('interactive_banner', [$this, 'banner_shortcode']);
            add_action('wp_enqueue_scripts', [$this, 'register_ib_banner_assets'], 1);
        }
        ...
        function register_ib_banner_assets() {
            ...
            wp_register_style('ult-interactive-banner',
                              plugins_url($css_path . 'interactive-styles' . $ext . '.css', __FILE__), [],
                    ...
                    [
                        ...
                        "params"      => [
                                ...
                                "description" => __("Click and select icon of your choice. If you can't find the one that suits for your purpose",
                                                    "ultimate_vc") . ", " . __("you can",
                                                                               "ultimate_vc") . " <a href='admin.php?page=bsf-font-icon-manager' target='_blank'>" . __("add new here",
                                                                                                                                                                        "ultimate_vc") . "</a>.",
                                "dependency"  => ["element" => "icon_disp", "value" => ["with_heading", "with_description", "both"]],
                            ],
                            [
                                "type"        => "ult_img_single",
                                "class"       => "",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "banner_height", "value" => ["ult-banner-block-custom-height"]]
                            ],
                            [
                                "type"        => "dropdown",
                                "class"       => "",
                            ...
                            [
                                ...
                                "description" => __("Add link / select existing page to link to this banner",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "link_opts", "value" => ["box", "more"]],
                            ],
                            [
                                "type"        => "textfield",
                                "class"       => "",
                                ...
                                "dependency"  => ["element" => "link_opts", "value" => ["more"]],
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
        ...
        function banner_shortcode($atts) {
            $banner_title
                = $banner_title_line_height = $banner_desc = $banner_desc_line_height = $banner_icon = $banner_image
                = $banner_link = $banner_link_text = $banner_style = $banner_bg_color = $el_class = $animation
                = $icon_disp
                = $link_opts = $banner_title_location = $banner_title_style_inline = $banner_desc_style_inline
                = $banner_overlay_bg_color = $banner_link_text_color = $banner_link_bg_color = $css_ibanner = '';
            ...
            $css_ibanner_styles = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                                vc_shortcode_custom_css_class($css_ibanner, ' '), "interactive_banner",
                                                $atts);
            ...
            $interactive_banner_desc_1_args = [
            ...
            $interactive_banner_desc_1_data_list
                                            = get_ultimate_vc_responsive_media_css($interactive_banner_desc_1_args);
            if ($desc_color != '') {
