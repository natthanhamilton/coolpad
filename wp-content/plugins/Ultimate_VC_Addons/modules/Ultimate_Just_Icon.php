...
if (!class_exists('AIO_Just_Icon')) {
    class AIO_Just_Icon {
        function __construct() {
            add_action('init', [$this, 'just_icon_init']);
            add_shortcode('just_icon', [$this, 'just_icon_shortcode']);
        }
        ...
        function just_icon_shortcode($atts) {
            $icon_type
                ...
                = $icon_border_spacing
                = $icon_link = $el_class = $icon_animation = $tooltip_disp = $tooltip_text = $icon_align = '';
            ...
            $css_just_icon = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                           vc_shortcode_custom_css_class($css_just_icon, ' '), "just_icon", $atts);
            ...
            $output
                = '<div class="ult-just-icon-wrapper ' . $el_class . ' ' . $css_just_icon . '">' . $output . '</div>';
            if ($is_preset) {
                $text = 'array ( ';
