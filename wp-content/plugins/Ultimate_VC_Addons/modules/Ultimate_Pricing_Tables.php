...
if (!class_exists("Ultimate_Pricing_Table")) {
	class Ultimate_Pricing_Table {
		function __construct() {
			add_action("init", [$this, "ultimate_pricing_init"]);
			add_shortcode("ultimate_pricing", [$this, "ultimate_pricing_shortcode"]);
			add_action('wp_enqueue_scripts', [$this, 'price_table_assets'], 1);
		}
					...
					[
						...
						"params"      => [
							...
							[
								...
								"value"       => "",
								"description" => __("Enter the price unit for this package. e.g. per month",
								                    "ultimate_vc"),
							],
							[
								"type"             => "textarea_html",
								...
								"param_name"       => "content",
								"value"            => "",
								"description"      => __("Create the features list using un-ordered list elements.",
								                         "ultimate_vc"),
							...
							[
								...
								"value"      => ["Make this pricing box as featured" => "enable"],
							],
							[
								"type"        => "number",
								"class"       => "",
