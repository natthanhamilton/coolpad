                            ...
                            if (! empty($selected_fonts))
                            {
                                foreach ($selected_fonts as $key => $sfont)
                                {
                                    ...
                                    <div class="selected-font">
                                        <div
                                            class="selected-font-top <?php echo (! empty($sfont['variants']) || ! empty($sfont['subsets'])) ? 'have-variants' : ''; ?>">
                                        ...
                                        if (! empty($sfont['variants']) || ! empty($sfont['subsets'])) :
                                            ...
                                            <div class="selected-font-content">
                                                        ...
                                                        foreach ($sfont['variants'] as $svkey => $svariants)
                                                        {
                                                            ...
                                                            <span class="font-variant">
                                                                            <input type="checkbox"
                                                                                   ...
                                                                                   class="selected-variant-checkbox" <?php echo ($svariants['variant_selected'] == 'true') ? 'checked' : ''; ?> />
                                                ...
                                                if (! empty($sfont['subsets'])) :
                                                    ?>
                                                    <div
                                                        class="<?php echo ($is_varients) ? 'selected-font-subset-wrapper' : '' ?>">
                                                        <?php
                                                        foreach ($sfont['subsets'] as $sbkey => $ssubset)
                                                        {
                                                            ...
                                                            <span class="font-subset">
                                                                            <input type="checkbox"
                                                                                   ...
                                                                                   class="selected-subset-checkbox" <?php echo ($ssubset['subset_selected'] == 'true') ? 'checked' : '' ?> />
                                                                            <label style=""
