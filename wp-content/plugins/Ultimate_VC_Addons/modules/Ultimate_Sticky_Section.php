...
if (!class_exists('Ultimate_Sticky_Section')) {
    ...
    class Ultimate_Sticky_Section {
        function __construct() {
            add_shortcode('ult_sticky_section', [$this, 'sticky_shortcode']);
            add_action('init', [$this, 'sticky_shortcode_mapper']);
            add_action('wp_enqueue_scripts', [$this, 'ult_sticky_section_scripts'], 1);
        ...
        function sticky_shortcode($atts, $content = NULL) {
            ...
            if ($sticky_offset_class != '') {
                ...
                if (strpos($sticky_offset_class, ',') !== FALSE) {
                    $sticky_classes_data = explode(',',
                                                   $sticky_offset_class); //str_replace( ',', '', trim( $sticky_offset_class ) );
            ...
            if ($sticky_width == 'customwidth') {
                ...
                if ($sticky_custom_width != '') {
                    if (strpos($sticky_custom_width, 'px') !== FALSE || strpos($sticky_custom_width,
                                                                               'em') !== FALSE || strpos($sticky_custom_width,
                                                                                                         '%') !== FALSE
                    ) {
            ...
            //sticky bahviour
            $stick_behaviour_data = $stick_behaviour != '' ? " data-stick_behaviour= '" . $stick_behaviour . "'"
                : " data-stick_behaviour= 'stick_with_scroll_row'";
            //permanent data
            if ($stick_behaviour == 'stick_permanent') {
                $left_right_postion = " data-lr_position= '" . $sticky_position_lr . "' ";
                //$left_right_postion .=
                if ($permanent_lr != "") {
                    if (strpos($permanent_lr, 'px') !== FALSE || strpos($permanent_lr,
                                                                        'em') !== FALSE || strpos($permanent_lr,
                                                                                                  '%') !== FALSE
                    ) {
            ...
            $custom_data .= $sticky_position != '' ? " data-sticky_position= '" . $sticky_position . "'"
                : " data-sticky_position= 'top'";
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "class"                   => "",
                        "as_parent"               => ['except' => 'ult_sticky_section'],
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "dependency"  => [
                                    ...
                                    "value"   => ['stick_with_scroll', 'stick_permanent']
                                ]
                            ],
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "stick_behaviour", "value" => ['stick_with_scroll_row', 'stick_with_scroll', 'stick_permanent']],
                            ],
                            [
                                "type"        => "ult_switch",
                                "class"       => "",
                                ...
                                "dependency"  => ["element" => "stick_behaviour", "value" => ['stick_with_scroll']],
                            ],
                            [
                                "type"        => "textfield",
        ...
        function ult_sticky_section_scripts() {
            ...
            wp_register_script('ult_sticky_js', plugins_url($script_path . 'fixto.js', __FILE__), ['jquery'],
                               ULTIMATE_VERSION, TRUE);
            wp_register_script('ult_sticky_section_js',
                               plugins_url($js_path . 'sticky-section' . $ext . '.js', __FILE__), ['ult_sticky_js'],
                               ULTIMATE_VERSION, TRUE);
            wp_register_style('ult_sticky_section_css',
                              plugins_url($css_path . 'sticky-section' . $ext . '.css', __FILE__), [],
                              ULTIMATE_VERSION);
