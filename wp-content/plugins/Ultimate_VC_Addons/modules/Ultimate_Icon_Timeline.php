...
if (!class_exists('Ultimate_Icon_Timeline')) {
    class Ultimate_Icon_Timeline {
        function __construct() {
            add_action('init', [$this, 'add_icon_timeline']);
            add_shortcode('icon_timeline', [$this, 'icon_timeline']);
            add_shortcode('icon_timeline_item', [$this, 'icon_timeline_item']);
            add_shortcode('icon_timeline_sep', [$this, 'icon_timeline_sep']);
            add_shortcode('icon_timeline_feat', [$this, 'icon_timeline_feat']);
            add_action('wp_enqueue_scripts', [$this, 'register_timeline_assets'], 1);
        }
        ...
        function register_timeline_assets() {
            ...
            wp_register_style('ultimate-timeline-style', plugins_url($css_path . 'timeline' . $ext . '.css', __FILE__),
                              [], ULTIMATE_VERSION);
        }
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "as_parent"               => ['only' => 'icon_timeline_item,icon_timeline_sep,icon_timeline_feat',],
                        "content_element"         => TRUE,
                        "show_settings_on_create" => TRUE,
                        //"is_container"    => true,
                        "front_enqueue_css"       => preg_replace('/\s/', '%20',
                                                                  plugins_url('../assets/css/advacne_carosal_front.css',
                                                                              __FILE__)),
                        "params"                  => [
                            [
                                "type"        => "dropdown",
                            ...
                            [
                                ...
                                "description" => __("Select the style of line that connects timeline items.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "colorpicker",
                                ...
                                "value"       => "",
                                "description" => __("Select the color for the line that connects timeline items.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
                                "heading"     => __("Background color for timeline item block / container:",
                                                    "ultimate_vc"),
                                "param_name"  => "time_block_bg_color",
                                "value"       => "",
                                "description" => __("Give a background color to the timeline item block.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"        => "colorpicker",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "timeline_layout", "value" => ["timeline-custom-width"]],
                            ],
                            [
                                "type"        => "dropdown",
                                "class"       => "",
                                ...
                                "description" => __("Hover animation can be given to the timeline item blocks.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"        => "textfield",
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Add extra class name that will be applied to the timeline, and you can use this class for your customizations.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/agey7' target='_blank'>" . __("Watch Video Tutorial",
                                                                                                                                          "ultimate_vc") . " &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
                    ...
                    [
                        ...
                        "params"          => [
                            ...
                            [
                                ...
                                "dependency" => ["element" => "line_style", "not_empty" => TRUE],
                            ],
                            [
                                "type"       => "number",
                    ...
                    [
                        ...
                        "params"          => [
                            ...
                            [
                                ...
                                "description" => __("Use an existing font icon</a> or upload a custom image.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "icon_manager",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "icon_type", "value" => ["selector", "custom"]],
                            ...
                            [
                                ...
                                "max"         => 500,
                                "suffix"      => "px",
                                "description" => __("0 pixel value will create a square border. As you increase the value, the shape convert in circle slowly. (e.g 500 pixels).",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "icon_border_style", "not_empty" => TRUE],
                            ],
                            [
                                ...
                                "max"         => 500,
                                "suffix"      => "px",
                                "description" => __("Spacing from center of the icon till the boundary of border / background",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "icon_style", "value" => ["advanced"]],
                            ],
                            [
                                ...
                                "dependency"  => ["element" => "icon_type", "value" => ["selector", "custom"]],
                                "description" => __("Like CSS3 Animations? We have several options for you!",
                                                    "ultimate_vc")
                            ],
                            /*array(
								"type" => "dropdown",
                            ...
                            [
                                ...
                                "value"       => "",
                                "dependency"  => ["element" => "time_link_apply", "value" => ["more", "title", "box"]],
                                "description" => __("Provide the link that will be applied to this timeline.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "textfield",
                                ...
                                "dependency"  => ["element" => "time_link_apply", "value" => ["more"]],
                            ],
                            // Customize everything
                            [
                                "type"        => "textfield",
                    ...
                    [
                        ...
                        "params"          => [
                            ...
                            [
                                ...
                                "description" => __("Use an existing font icon or upload a custom image.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "icon_manager",
        ...
        function icon_timeline_sep($atts, $content = NULL) {
            $time_sep_title
                = $time_sep_color = $time_sep_bg_color = $animation
                = $el_class = $line_style = $line_color = $icon_style = $seperator_style = $seperator_line_ht = '';
            extract(shortcode_atts([
                                       'time_sep_title'             => '. . .',
                                       'time_sep_color'             => '',
                                       'time_sep_bg_color'          => '',
        ...
        function icon_timeline_feat($atts, $content = NULL) {
            $icon_type
                           = $icon_img = $img_width = $icon = $icon_color = $icon_color_bg = $icon_size = $icon_style
                = $icon_border_style = $icon_border_radius = $icon_color_border = $icon_border_size
                = $icon_border_spacing
                = $icon_link = $el_class = $icon_animation = $time_title = $time_link = $time_link_apply
                = $time_read_text
                = $time_icon = $time_icon_color = $time_icon_bg_color = $time_position = $font_size = $line_color
                = $animation = $icon_border_style = $icon_border_size = $border_color = $title_style = $desc_style = '';
            ...
            $li_prefix
                       = '<div class="timeline-block ' . $el_class . '"><div class="timeline-dot"></div><div class="ult-timeline-arrow"><s></s><l></l></div>';
            $li_suffix = '</div>';
            ...
            $header_block_style = '';
            $icon
                                = '<div class="timeline-icon-block"' . $icon_pad . '><div class="ult-timeline-icon ' . $bg_cls . '" style="' . $style . '">';
            if ($icon_type != 'noicon') {
                $icon .= $box_icon;
        ...
        function icon_timeline_item($atts, $content = NULL) {
            $icon_type
                               = $icon_img = $img_width = $icon = $icon_color = $icon_color_bg = $icon_size
                = $icon_style = $icon_border_style = $icon_border_radius = $icon_color_border = $icon_border_size
                = $icon_border_spacing = $icon_link = $el_class = $icon_animation = $time_title = $time_link
                = $time_link_apply = $time_read_text = $time_icon = $time_icon_color = $time_icon_bg_color
                = $time_position
            ...
            $header_block_style = '';
            $icon
                                = '<div class="timeline-icon-block"><div class="ult-timeline-icon ' . $bg_cls . '" style="' . $style . '">';
            if ($icon_type != 'noicon') {
                $icon .= $box_icon;
            }//'<i  style="'.$icon_style.'" class="'.$time_icon.'" ></i>';
            $icon .= '</div> <!-- icon --></div>';
