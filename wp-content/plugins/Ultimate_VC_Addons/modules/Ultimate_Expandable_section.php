...
if (!class_exists('AIO_ultimate_exp_section')) {
    class AIO_ultimate_exp_section {
        function __construct() {
            add_shortcode('ultimate_exp_section', [$this, 'ultimate_exp_section_shortcode']);
            add_action('init', [$this, 'ultimate_ultimate_exp_section']);
            add_action('wp_enqueue_scripts', [$this, 'ultimate_exp_scripts'], 1);
        }
        ...
        function ultimate_exp_scripts() {
            ...
            wp_register_style('style_ultimate_expsection',
                              plugins_url($css_path . 'expandable-section' . $ext . '.css', __FILE__), [],
                              ULTIMATE_VERSION, FALSE);
            wp_register_script("jquery_ultimate_expsection",
                               plugins_url($js_path . "expandable-section" . $ext . ".js", __FILE__),
                               ['jquery', 'jquery_ui'], ULTIMATE_VERSION);
            wp_register_script("jquery_ui", plugins_url($js_path . "jquery-ui" . $ext . ".js", __FILE__), ['jquery'],
                               ULTIMATE_VERSION);
        }
        ...
        function ultimate_exp_section_shortcode($atts, $content) {
            ...
            $css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class($css, ' '),
                                       "ultimate_exp_section", $atts);
            $css_class = esc_attr($css_class);
            /*---------------desc padding---------------------*/
            $desc_css_class = '';
            $desc_css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                            vc_shortcode_custom_css_class($cont_css, ' '), "ultimate_exp_section",
                                            $atts);
            $desc_css_class = esc_attr($desc_css_class);
            /*---------------desc padding---------------------*/
            $icon_css_class = '';
            $icon_css_class = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                            vc_shortcode_custom_css_class($iconmargin_css, ' '), "ultimate_exp_section",
                                            $atts);
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "as_parent"               => ['except' => 'ultimate_exp_section'],
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("Keep empty if you want to dispaly same title as previous.",
                                                    "ultimate_vc"),
                                //"group" => "Title Setting",
                            ],
                            /*-----------general------------*/
                            ...
                            [
                                ...
                                "description" => __("By default, the section will be given to the Visual Composer row. However, in some cases depending on your theme's CSS - it may not fit well to the container you are wishing it would. In that case you will have to select the appropriate value here that gets you desired output..",
                                                    "ultimate_vc"),
                            ...
                            [
                                ...
                                "max"         => 1200,
                                "suffix"      => "px",
                                "description" => __("Adjust width of your content. Keep empty for full width.",
                                                    "ultimate_vc"),
                                'group'       => __('Design ', 'ultimate_vc'),
                            ],
                            [
                                ...
                                "max"         => 1200,
                                "suffix"      => "px",
                                "description" => __("After click distance between viewport top & expandable section.",
                                                    "ultimate_vc"),
                                'group'       => __('Design ', 'ultimate_vc'),
                            ],
                            [
