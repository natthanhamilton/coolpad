...
if (!class_exists('Ultimate_Modals')) {
    class Ultimate_Modals {
        function __construct() {
            ...
            add_shortcode('ultimate_modal', [&$this, 'modal_shortcode']);
            // Initialize the modal popup component for Visual Composer
            add_action('init', [$this, 'ultimate_modal_init']);
            add_action("wp_enqueue_scripts", [$this, "register_modal_assets"], 1);
        }

        public static function register_modal_assets() {
            ...
            wp_register_script("ultimate-modal-all", plugins_url("../assets/min-js/modal-all.min.js", __FILE__),
            ...
            wp_register_style("ultimate-modal", plugins_url($css_path . "modal" . $ext . ".css", __FILE__), [],
                              ULTIMATE_VERSION);
        }

        // Add shortcode for icon-box
        public static function modal_shortcode($atts, $content = NULL) {
            $row_setting = '';
            // enqueue js
            $icon
                = $modal_on = $modal_contain = $btn_size = $btn_bg_color = $btn_txt_color = $btn_text
                = $read_text = $txt_color = $modal_title = $modal_size = $el_class = $modal_style = $icon_type
                = $icon_img
                = $btn_img = $overlay_bg_color = $overlay_bg_opacity = $modal_on_align = $content_bg_color
                = $content_text_color = $header_bg_color = $header_text_color
                = $modal_border_style = $modal_border_width = $modal_border_color = $modal_border_radius = '';
            $header_font
                = $header_font_style = $header_font_size = $header_line_height = $content_font = $content_font_style
                = $content_font_size = $content_line_height = $trigger_typography = $trigger_text_font
                = $trigger_text_font_style = $trigger_text_font_size = $trigger_text_line_height
                = $button_text_font = $button_text_font_style = $button_text_font_size = $button_text_line_height = '';
            ...
            $css_modal_box = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                           vc_shortcode_custom_css_class($css_modal_box, ' '), "ultimate_modal", $atts);
            $css_modal_box = esc_attr($css_modal_box);
            $vc_version    = (defined('WPB_VC_VERSION')) ? WPB_VC_VERSION : 0;
            $is_vc_49_plus = (version_compare(4.9, $vc_version, '<=')) ? 'ult-adjust-bottom-margin' : '';
            $html
                = $style = $box_icon = $modal_class = $modal_data_class = $uniq = $overlay_bg
                = $trigger_text_style = $content_style = $header_style = $border_style = $button_text_style = '';
            ...
            if ($icon_type == 'custom') {
                ...
                $box_icon
                         = '<div class="modal-icon"><img src="' . $ico_img . '" class="ult-modal-inside-img" alt="' . $ico_alt . '"></div>';
                    ...
                    [
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "param_name"       => "content",
                                "value"            => "",
                                "description"      => __("Content that will be displayed in Modal Popup.",
                                                         "ultimate_vc"),
                                "group"            => "General",
                            ...
                            [
                                ...
                                "description" => __("Add .Class and/or #ID to open your modal. Multiple ID or Classes separated by comma",
                                                    "ultimate_vc"),
                                "value"       => "",
                                "dependency"  => ["element" => "modal_on", "value" => ["custom-selector"]],
                                "group"       => "General",
                            ],
                            [
                                "type"        => "number",
                                ...
                                "value"       => "2",
                                "suffix"      => "seconds",
                                "description" => __("Time delay before modal popup on page load (in seconds)",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "modal_on", "value" => ["onload"]],
                                "group"       => "General",
                            ],
                            [
                                "type"        => "ult_img_single",
                                ...
                                "dependency"  => ["element" => "modal_on", "value" => ["image"]],
                                "group"       => "General",
                            ],
                            [
                                "type"        => "dropdown",
                                ...
                                "dependency"  => ["element" => "modal_on", "value" => ["ult-button"]],
                                "group"       => "General",
                            ],
                            [
                                "type"        => "colorpicker",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "modal_on", "value" => ["ult-button", "image", "text"]],
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("Enter the text on which the modal box will be triggered.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "modal_on", "value" => ["text"]],
                                "group"       => "General",
                            ],
                            // Modal box size
                            [
                            ...
                            [
                                ...
                                "description" => __("Do you want to give border to the modal content box?",
                                                    "ultimate_vc"),
                                "group"       => "General",
                            ],
                            [
                                ...
                                "dependency"  => ["element" => "modal_border_style", "not_empty" => TRUE],
                                "group"       => "General",
                            ],
                            [
                                "type"        => "colorpicker",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "modal_on", "value" => ["ult-button", "image"]],
                                "group"       => "General",
                            ],
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Add extra class name that will be applied to the modal popup, and you can use this class for your customizations.",
                                                    "ultimate_vc"),
                                "group"       => "General",
                            ],
                            [
                                ...
                                "text"             => "<span style='display: block;'><a href='https://goo.gl/1kCZkG' target='_blank'>" . __("Need More Features?",
                                                                                                                                            "ultimate_vc") . " &nbsp;&nbsp;&nbsp;</a></span>",
                            ...
                            [
                                ...
                                "dependency"       => ["element" => "modal_on", "value" => ["image", "text", "ult-button"]],
                            ],
                        ] // end params array
                    ] // end vc_map array
                ); // end vc_map
