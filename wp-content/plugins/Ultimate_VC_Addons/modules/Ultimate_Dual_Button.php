...
if (!class_exists('AIO_Dual_Button')) {
    class AIO_Dual_Button {
        function __construct() {
            add_shortcode('ult_dualbutton', [$this, 'ultimate_dualbtn_shortcode']);
            add_action('init', [$this, 'ultimate_dual_button']);
            add_action('wp_enqueue_scripts', [$this, 'dualbutton_scripts']);
            add_action('admin_enqueue_scripts', [$this, 'dualbutton_backend_scripts']);
        }
        ...
        function dualbutton_backend_scripts($hook) {
            if ($hook == "post.php" || $hook == "post-new.php") {
                ...
                if ($bsf_dev_mode === 'enable') {
                    wp_register_script("jquery_dualbtn_new", plugins_url("../admin/js/dualbtnbackend.js ", __FILE__),
        ...
        function dualbutton_scripts() {
            ...
            wp_register_script("jquery.dualbtn", plugins_url($js_path . "dual-button" . $ext . ".js", __FILE__),
                               ['jquery'], ULTIMATE_VERSION);
            if (isset($_SERVER['HTTP_REFERER'])) {
                ...
                if ($vc_is_inline) {
                    ...
                    wp_enqueue_style('ult-dualbutton',
                                     plugins_url($css_path . 'dual-button' . $ext . '.css', __FILE__));
                    wp_enqueue_script("jquery.dualbtn", plugins_url($js_path . "dual-button" . $ext . ".js", __FILE__),
                                      ['jquery'], ULTIMATE_VERSION);
                }
            }
        }
        ...
        function ultimate_dualbtn_shortcode($atts) {
            $button1_text
                = $icon_type = $icon
                =
            $icon_img = $img_width = $icon_size = $icon_color = $icon_hover_color = $icon_style = $icon_color_bg = '';
            $icon_border_style
                = $icon_color_border = $icon_border_size = $icon_border_radius = $icon_border_spacing
                = $icon_link
                = $icon_align = $btn1_background_color = $btn1_bghovercolor
                = $btn2_font_family = $btn2_heading_style = $btn1_text_color = $btn1_text_hovercolor = '';
            $button2_text
                = $btn_icon_type = $btn_icon = $btn_icon_img = $btn_img_width = $btn_icon_size = $btn_icon_color
                = $btn_icon_style = $btn_icon_color_bg = $btn_icon_border_style
                = $btn_icon_color_border = $btn_icon_border_size
                = $btn_icon_border_radius
                = $btn_icon_border_spacing = $btn_icon_link = $btn2_icon_align = $btn2_background_color
                = $btn2_bghovercolor
                = $btn2_font_family = $btn2_heading_style = $btn2_text_color = $btn2_text_hovercolor = '';
            $divider_style
                = $divider_text = $divider_text_color = $divider_bg_color = $divider_icon
                = $divider_icon_img = $btn_border_style = $btn_color_border = $btn_border_size
                = $btn_border_radius = $btn_hover_style = $title_font_size = $title_line_ht = $el_class = '';
            ...
            $el_class1
                                   =
            $css_trans = $button2_bstyle = $button1_bstyle = $target1 = $url1 = $btn_color_hoverborder = '';
            $iconoutput            = $style = $link_sufix = $link_prefix = $target = $href = $icon_align_style = '';
            $secicon               = $style1 = $dual_design_style_css = '';
            $dual_design_style_css = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                                   vc_shortcode_custom_css_class($css_dualbtn_design, ' '),
                                                   "ult_dualbutton", $atts);
...
background-color:' . $divider_bg_color . ';';
                        ...
                        $text
                              = '<img class="img-icon" alt="' . $alt3 . '" src="' . $img3 . '" style="' . $text_style . '" />';
                    }
                }
            }
            /*-----------responsive mode --------*/
                    ...
                    [
                        ...
                        "params"      => [
                            ...
                            [
                                ...
                                "dependency"       => ["element" => "btn_border_style", "not_empty" => TRUE],
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Ran out of options? Need more styles? Write your own CSS and mention the class name here.",
                                                    "ultimate_vc"),
                            ],
                            /*---bt1----*/
                            /*array(
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("Add a custom link or select existing page. You can remove existing link as well.",
                                                    "ultimate_vc"),
                                "group"       => "Button1",
                            ],
                            [
                            ...
                            [
                                ...
                                /*"dependency" => Array("element" => "btn_hover_style", "not_empty" => true),*/
                                "dependency"  => ["element" => "btn_hover_style", "value" => ["Style 1", "Style 2", "Style 3"]],
                                "group"       => "Button1",
                            ],
                            [
                                "type"             => "ult_param_heading",
...
*/
                            ...
                            [
                                ...
                                "description" => __("Click and select icon of your choice. If you can't find the one that suits for your purpose",
                                                    "ultimate_vc") . ", " . __("you can",
                                                                               "ultimate_vc") . " <a href='admin.php?page=bsf-font-icon-manager' target='_blank'>" . __("add new here",
                                                                                                                                                                        "ultimate_vc") . "</a>.",
                                "dependency"  => ["element" => "btn_icon_type", "value" => ["selector"]],
                                "group"       => "Button2",
                            ],
                            [
                                "type"        => "ult_img_single",
                                ...
                                "value"       => "",
                                "description" => __("Upload the custom image icon.", "ultimate_vc"),
                                "dependency"  => ["element" => "btn_icon_type", "value" => ["custom"]],
                                "group"       => "Button2",
                            ],
                            [
                                "type"        => "number",
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("Select background color for icon.", "ultimate_vc"),
                                "dependency"  => ["element" => "btn_icon_style", "value" => ["circle", "square", "advanced"]],
                                "group"       => "Button2",
                            ],
                            [
                                "type"        => "colorpicker",
                            ...
                            [
                                ...
                                "description" => __("Select the border style for Button.", "ultimate_vc"),
                                "dependency"  => ["element" => "btn_icon_style", "value" => ["advanced"]],
                                "group"       => "Button2",
                            ],
                            [
                                "type"        => "colorpicker",
                                ...
                                "value"       => "",
                                "description" => __("Select border color for icon.", "ultimate_vc"),
                                "dependency"  => ["element" => "btn_icon_border_style", "not_empty" => TRUE],
                                "group"       => "Button2",
                            ],
                            [
                                "type"        => "colorpicker",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "divider_style", "value" => ["text"]],
                                "group"       => "Divider",
                            ],
                            [
                                "type"        => "colorpicker",
                                ...
                                "dependency"  => ["element" => "divider_style", "value" => ["text", "icon"]],
                                "group"       => "Divider",
                            ],
                            [
                                "type"        => "colorpicker",
                                ...
                                "dependency"  => ["element" => "divider_style", "not_empty" => TRUE],
                                "group"       => "Divider",
                            ],
                            [
                                "type"        => "icon_manager",
                                ...
                                "description" => __("Click and select icon of your choice. If you can't find the one that suits for your purpose",
                                                    "ultimate_vc") . ", " . __("you can",
                                                                               "ultimate_vc") . " <a href='admin.php?page=bsf-font-icon-manager' target='_blank'>" . __("add new here",
                                                                                                                                                                        "ultimate_vc") . "</a>.",
                                "dependency"  => ["element" => "divider_style", "value" => ["icon"]],
                                "group"       => "Divider",
                            ],
                            [
                                "type"        => "ult_img_single",
                                ...
                                "value"       => "",
                                "description" => __("Upload the custom image icon.", "ultimate_vc"),
                                "dependency"  => ["element" => "divider_style", "value" => ["image"]],
                                "group"       => "Divider",
                            ],
                            [
                                "type"        => "dropdown",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "divider_border_style", "not_empty" => TRUE],
                                //'edit_field_class' => 'vc_column vc_col-sm-4',
                                "group"       => "Divider",
                            ],
                            [
                            ...
                            [
                                ...
                                "description" => __("Select the font of your choice. ",
                                                    "ultimate_vc") . ", " . __("you can",
                                                                               "ultimate_vc") . " <a href='admin.php?page=bsf-google-font-manager' target='_blank'>" . __("add new in the collection here",
                                                                                                                                                                          "ultimate_vc") . "</a>.",
                                "group"       => "Typography",
                            ],
                            [
