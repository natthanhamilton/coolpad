...
if (!class_exists('AIO_Info_list')) {
    class AIO_Info_list {
        ...
        function __construct() {
            ...
            $this->icon_style        = '';
            $this->icon_style        = '';
            add_action('init', [$this, 'add_info_list']);
            if (function_exists('vc_is_inline')) {
                if (!vc_is_inline()) {
                    add_shortcode('info_list', [$this, 'info_list']);
                    add_shortcode('info_list_item', [$this, 'info_list_item']);
                }
            } else {
                add_shortcode('info_list', [$this, 'info_list']);
                add_shortcode('info_list_item', [$this, 'info_list_item']);
        ...
        function info_list($atts, $content = NULL) {
            ...
            $position
                              = $style = $icon_color = $icon_bg_color = $connector_animation = $font_size_icon
                = $icon_border_style
                = $icon_border_size = $connector_color = $border_color = $el_class = $info_list_link_html = '';
            ...
            $css_info_list = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                           vc_shortcode_custom_css_class($css_info_list, ' '), "info_list", $atts);
            ...
            $output
                = '<div class="smile_icon_list_wrap ' . $is_vc_49_plus . ' ' . $el_class . ' ' . $css_info_list . '">';
        ...
        function info_list_item($atts, $content = NULL) {
            // Do nothing
            $list_title
                = $list_icon = $animation = $icon_color
                = $icon_bg_color = $icon_img = $icon_type = $desc_font_line_height = $title_font_line_height = '';
            $title_font
                = $title_font_style = $title_font_size
                = $title_font_color = $desc_font = $desc_font_style = $desc_font_size = $desc_font_color = '';
            extract(shortcode_atts([
                                       'list_title'             => '',
                                       'animation'              => '',
                                       'list_icon'              => '',
            ...
            $css_trans
                =
            $style = $ico_col = $connector_trans = $icon_html = $title_style = $desc_style = $info_list_link_html = '';
            //$font_args = array();
            $is_link = FALSE;
            if ($info_list_link != '') {
            ...
            $output .= '<div class="icon_description_text ult-responsive" ' . $info_list_desc_data_list . ' style="' . $desc_style . '">' . wpb_js_remove_wpautop($content,
                                                                                                                                                                  TRUE) . '</div>';
            $output .= '</div>';
        ...
        function front_info_list($atts, $content = NULL) {
            ...
            $position
                = $style = $icon_color = $icon_bg_color = $connector_animation = $font_size_icon
                = $icon_border_style = $icon_border_size = $connector_color = $border_color = $el_class = '';
            extract(shortcode_atts([
                                       'position'            => 'left',
                                       'style'               => 'square with_bg',
                                       'connector_animation' => '',
                    ...
                    [
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "style", "value" => ["square with_bg", "circle with_bg", "hexagon"]],
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "style", "value" => ["square with_bg", "circle with_bg"]],
                            ],
                            [
                                "type"        => "number",
                                "class"       => "",
                                ...
                                "dependency"  => ["element" => "icon_border_style", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Add extra class name that will be applied to the info list, and you can use this class for your customizations.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/v9k0x' target='_blank'>" . __("Watch Video Tutorial",
                    ...
                    [
                        ...
                        "params"          => [
                            ...
                            [
                                ...
                                "dependency" => ["element" => "info_list_link_apply", "value" => ["container", "title", "icon"]]
                            ],
                            [
                                "type"             => "ult_param_heading",
