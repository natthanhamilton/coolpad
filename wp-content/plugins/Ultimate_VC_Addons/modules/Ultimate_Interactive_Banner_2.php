...
if (!class_exists('Ultimate_Interactive_Banner')) {
	class Ultimate_Interactive_Banner {
		function __construct() {
			...
			add_shortcode('interactive_banner_2', [$this, 'banner_shortcode']);
			add_action('wp_enqueue_scripts', [$this, 'register_ib2_banner_assets'], 1);
		}
		...
		function register_ib2_banner_assets() {
			...
			wp_register_style('ult-ib2-style', plugins_url($css_path . 'ib2-style' . $ext . '.css', __FILE__), [],
					...
					[
						...
						"params"      => [
							...
							[
								...
								"value"       => "",
								"description" => __("Add link / select existing page to link to this banner",
								                    "ultimate_vc"),
							],
							[
								"type"        => "ult_select2",
							...
							[
								...
								"dependency" => ["element" => "banner_min_height_op", "value" => ['custom']],
							],
							[
								"type"        => "colorpicker",
								"class"       => "",
								...
								"value"       => "",
								"description" => "",
								"dependency"  => ["element" => "banner_style", "value" => ['style5']],
							],
							[
								"type"        => "textfield",
								"class"       => "",
							...
							[
								...
								"value"       => ["Enable Responsive Behaviour" => "yes"],
								"description" => __("If the description text is not suiting well on specific screen sizes, you may enable this option - which will hide the description text.",
								                    "ultimate_vc"),
								"group"       => "Responsive",
							],
							[
								...
								"max"         => 1000,
								"suffix"      => "px",
								"dependency"  => ["element" => "enable_responsive", "value" => "yes"],
								"description" => __("Provide the range of screen size where you would like to hide the description text.",
								                    "ultimate_vc"),
								"group"       => "Responsive",
							],
							[
							...
							[
								"type"             => "ult_param_heading",
								"text"             => "<span style='display: block;'><a href='http://bsf.io/n8o33' target='_blank'>" . __("Watch Video Tutorial",
		...
		function banner_shortcode($atts) {
			$banner_title
				= $banner_desc = $banner_image = $banner_link = $banner_style = $el_class = $heading_tag = '';
			$banner_title_font_family
				= $banner_title_style
				= $banner_title_font_size = $banner_title_line_height
				=
			$banner_desc_font_family = $banner_desc_style = $banner_desc_font_size = $banner_desc_line_height = '';
			$banner_title_style_inline
				= $banner_desc_style_inline
				= $banner_color_bg = $banner_color_title = $banner_color_desc = $banner_title_bg = '';
			$image_opacity
				= $image_opacity_on_hover
				= $enable_responsive = $responsive_min = $banner_min = $banner_min_height_op = $responsive_max = '';
			...
			$css_ib2_styles = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
			                                vc_shortcode_custom_css_class($css_ib2, ' '), "interactive_banner_2",
			                                $atts);
			$css_ib2_styles = esc_attr($css_ib2_styles);
			$output
				= $style = $target = $link = $banner_style_inline = $title_bg = $img_style = $responsive = $target = '';
