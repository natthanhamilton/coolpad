...
if (!class_exists("Ultimate_Headings")) {
    class Ultimate_Headings {
        ...
        function __construct() {
            add_action("init", [$this, "ultimate_headings_init"]);
            add_shortcode("ultimate_heading", [$this, "ultimate_headings_shortcode"]);
            add_action("wp_enqueue_scripts", [$this, "register_headings_assets"], 1);
        }
        ...
        function register_headings_assets() {
            ...
            wp_register_style("ultimate-headings-style", plugins_url($css_path . "headings" . $ext . ".css", __FILE__),
                              [], ULTIMATE_VERSION);
            wp_register_script("ultimate-headings-script", plugins_url($js_path . "headings" . $ext . ".js", __FILE__),
                ...
                vc_map(
                    [
                        ...
                        "params"      => [
                            ...
                            [
                                "type"       => "text",
                                "heading"    => "<h4>" . __("Enter values with respective unites. Example - 10px, 10em, 10%, etc.",
                                                            "ultimate_vc") . "</h4>",
                            ...
                            [
                                ...
                                "dependency" => ["element" => "spacer", "value" => ["line_with_icon", "line_only", "icon_only", "image_only"]],
                            ],
                            [
                                "type"       => "ult_img_single",
                                ...
                                "dependency" => ["element" => "spacer", "value" => ["image_only"]],
                            ],
                            [
                                "type"        => "number",
                                "class"       => "",
                            ...
                            [
                                ...
                                "dependency" => ["element" => "spacer", "value" => ["line_with_icon", "line_only"]],
                            ],
                            [
                                "type"       => "number",
                                "class"      => "",
                            ...
                            [
                                ...
                                "description" => __("Use an existing font icon or upload a custom image.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "spacer", "value" => ["line_with_icon", "icon_only"]],
                            ],
                            [
                                "type"        => "icon_manager",
                                "class"       => "",
                            ...
                            [
                                ...
                                "value"      => "10",
                                "suffix"     => "px",
                                "dependency" => ["element" => "spacer", "value" => ["line_with_icon"]],
                            ],
                            [
                                "type"        => "textfield",
                            ...
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/8v9sy' target='_blank'>" . __("Watch Video Tutorial",
        ...
        function ultimate_headings_shortcode($atts, $content = NULL) {
            $wrapper_style
                ...
                = $sub_heading_style_inline = $line_style_inline = $icon_inline = $output = $el_class = '';
                    ...
                    if ($spacer == 'icon_only') {
                        ...
                        if ($spacer == 'image_only') {
                            if (!empty($spacer_img_width)) {
                                $siwidth = [$spacer_img_width, $spacer_img_width];
                            } else {
                                $siwidth = 'full';
                            }
                            $spacer_inline = '';
                            ...
                            $icon_inline
                                = '<img src="' . $icon_inline . '" class="ultimate-headings-icon-image" alt="' . $alt . '" style="' . $spacer_inline . '"/>';
                        }
                    }
                }
            }
            ...
            if ($spacer == 'line_with_icon') {
                $data
                    = 'data-hline_width="' . $wrap_width . '" data-hicon_type="' . $icon_type . '" data-hborder_style="' . $line_style . '" data-hborder_height="' . $line_height . '" data-hborder_color="' . $line_color . '"';
                if ($icon_type == 'selector') {
            ...
            $output
                = '<div id="' . $id . '" class="uvc-heading ' . $is_vc_49_plus . ' ' . $id . ' ' . $uid . ' ' . $el_class . '" data-hspacer="' . $spacer . '" ' . $data . ' data-halign="' . $alignment . '" style="text-align:' . $alignment . '">';
        ...
        function ultimate_heading_spacer($wrapper_class, $wrapper_style, $icon_inline) {
            $spacer
                = '<div class="uvc-heading-spacer ' . $wrapper_class . '" style="' . $wrapper_style . '">' . $icon_inline . '</div>';
