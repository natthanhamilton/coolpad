...
if (!class_exists("Ultimate_Team")) {
    class Ultimate_Team {
        function __construct() {
            add_action('init', [$this, 'init_team']);
            add_shortcode('ult_team', [$this, 'ult_team_shortcode']);
            //add_action('admin_enqueue_scripts',array($this,'admin_scripts'));
            add_action("wp_enqueue_scripts", [$this, "register_team_assets"], 1);
        }
        ...
        function register_team_assets() {
            ...
            wp_register_script("ultimate-team", plugins_url($js_path . "teams" . $ext . ".js", __FILE__), ['jquery'],
                               ULTIMATE_VERSION);
            ...
            wp_register_style("ultimate-team", plugins_url($css_path . "teams" . $ext . ".css", __FILE__), [],
                              ULTIMATE_VERSION);
        }
        ...
        function admin_scripts($hook) {
            if ($hook == "post.php" || $hook == "post-new.php" || $hook == 'visual-composer_page_vc-roles') {
                $bsf_dev_mode = bsf_get_option('dev_mode');
                if ($bsf_dev_mode === 'enable') {
                    wp_enqueue_script('ult-team-admin', plugins_url('../admin/js/team-admin.js', __FILE__), ['jquery'],
        ...
        function ult_team_shortcode($atts, $content) {
            ...
            $team_member_name_font
                                    = $team_member_name_font_style = $team_member_name_font_size
                = $team_member_name_line_height = $team_member_position_font = $team_member_position_font_style
                = $team_member_position_font_size = $team_member_position_line_height = $team_member_description_font
                = $team_member_description_font_style
                =
            $team_member_description_font_size = $team_member_description_line_height = $team_member_name_tag = '';
            $team_member_name_color = '';
            $team_member_org_color  = '';
            $team_member_desc_color
                                    = $team_img_bg_color = $team_img_opacity = $team_img_grayscale
                = $team_img_hover_opacity = $team_img_hover_opacity_style3 = $img_hover_eft = $img_hover_color
                = $img_border_style
                = $img_border_width = $img_border_color = $img_border_radius = $staff_link = $link_switch = '';
            /* Declaration for style-1 for team */
            $team_member_style
                = $divider_effect = $team_member_divider_color = $team_member_divider_width
                = $team_member_divider_height = $social_links = $selected_team_icon = $social_icon_url
                = $social_link_title
                = $social_icon_color = $social_icon_hover_color = $team_member_bg_color = $team_member_align_style
                = $social_icon_size = $social_icon_space = $social_icon_effect = $custom_team_class = '';
            $title_box_padding
                = $title_box_margin = $team_css = $team_member_responsive_enable = $team_responsive_width = '';
            ...
            $team_img_opacity       = (isset($team_img_opacity) && trim($team_img_opacity) !== '') ? $team_img_opacity
                : '1';
            $team_img_hover_opacity = (isset($team_img_hover_opacity) && trim($team_img_hover_opacity) !== '')
                ? $team_img_hover_opacity : '0.65';
            $team_img_hover_opacity_style3
                                    = (isset($team_img_hover_opacity_style3) && trim($team_img_hover_opacity_style3) !== '')
                ? $team_img_hover_opacity_style3 : '0.1';
            $team_img_bg_color = (isset($team_img_bg_color) && trim($team_img_bg_color) !== '') ? $team_img_bg_color
                : 'inherit';
            $team_member_style = (isset($team_member_style) && trim($team_member_style) !== '') ? $team_member_style
                : 'style-1';
            $custom_team_class = (isset($custom_team_class) && trim($custom_team_class) !== '') ? $custom_team_class
                : '';
            // Set responsive width
            $team_responsive_width = (isset($team_responsive_width) && trim($team_responsive_width) !== '')
                ? $team_responsive_width : '';
            $team_responsive_width
                                   = (isset($team_member_responsive_enable) && trim($team_member_responsive_enable) == 'on')
                ? $team_responsive_width : '';
            // Set typography colors
            $team_member_name_color = (isset($team_member_name_color) && trim($team_member_name_color) !== '')
                ? $team_member_name_color : 'inherit';
            $team_member_org_color  = (isset($team_member_org_color) && trim($team_member_org_color) !== '')
                ? $team_member_org_color : 'inherit';
            $team_member_desc_color = (isset($team_member_desc_color) && trim($team_member_desc_color) !== '')
                ? $team_member_desc_color : 'inherit';
            // Set team Member name's tag element
            $team_member_name_tag = (isset($team_member_name_tag) && trim($team_member_name_tag) !== '')
                ? $team_member_name_tag : 'h2';
            $team_css = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, vc_shortcode_custom_css_class($team_css, ' '),
                                      "ult_team", $atts);
            //title box style
            $title_box_style = "";
            ...
            if (!$team_member_name_font == '') {
                $team_member_font_family = function_exists("get_ultimate_font_family")
                    ? get_ultimate_font_family($team_member_name_font) : '';
            ...
            if (!$team_member_position_font == '') {
                $team_member_font_family = function_exists("get_ultimate_font_family")
                    ? get_ultimate_font_family($team_member_position_font) : '';
                $team_member_font_family = ($team_member_font_family != '') ? $team_member_font_family : 'inherit';
            ...
            if (!$team_member_description_font == '') {
                $team_member_font_family = function_exists("get_ultimate_font_family")
                    ? get_ultimate_font_family($team_member_description_font) : '';
                $team_member_font_family = ($team_member_font_family != '') ? $team_member_font_family : 'inherit';
            ...
            if ($img_hover_eft == 'on') {
                ...
                $img_hover_color = (isset($img_hover_color) && trim($img_hover_color) != "") ? $img_hover_color
            ...
            $team_member_divider_color = (isset($team_member_divider_color) && trim($team_member_divider_color) !== '')
                ? $team_member_divider_color : '';
            //$team_member_bg_color = ( isset( $team_member_bg_color ) && trim( $team_member_bg_color ) !== '' ) ? $team_member_bg_color : '#ffffff';
            $team_member_align_style = (isset($team_member_align_style) && trim($team_member_align_style) !== '')
                ? $team_member_align_style : 'center';
            $social_icon_size  = (isset($social_icon_size) && trim($social_icon_size) !== '') ? $social_icon_size . "px"
                : '16px';
            $social_icon_space = (isset($social_icon_space) && trim($social_icon_space) !== '')
                ? ($social_icon_space / 2) . "px" : '5px';
            $team_member_divider_width = (isset($team_member_divider_width) && trim($team_member_divider_width) !== '')
                ? $team_member_divider_width : '80';
            $team_member_divider_width = ($team_member_divider_width <= 100) ? $team_member_divider_width : '100';
            $team_member_divider_height
                                       = (isset($team_member_divider_height) && trim($team_member_divider_height) !== '')
                ? $team_member_divider_height : '1';
            ...
            if ($team_member_style == 'style-3') {
                ...
                if (count($social_icons) > 0 && $social_icon_effect == 'on') {
                    $icon_styling
                        = 'font-size:' . $social_icon_size . ' ; margin-left:' . $social_icon_space . ';margin-right:' . $social_icon_space . ';';
                    ...
                    foreach ($social_icons as $social_link) {
                        if (isset($social_link->selected_team_icon) && $social_link->selected_team_icon !== '') {
                            $social_icon_url
                                                = (isset($social_link->social_icon_url) && $social_link->social_icon_url !== '')
                                ? $social_link->social_icon_url : '#';
                            $social_link_title
                                                = (isset($social_link->social_link_title) && $social_link->social_link_title !== '')
                                ? $social_link->social_link_title : '';
                            $social_icon_color
                                                = (isset($social_link->social_icon_color) && $social_link->social_icon_color !== '')
                                ? $social_link->social_icon_color : 'inherit';
                            $default_icon_color = ($social_icon_color != 'inherit')
                                ? 'color:' . $social_icon_color . ';' : '';
                            $social_icon_hover_color
                                                = (isset($social_link->social_icon_hover_color) && $social_link->social_icon_hover_color !== '')
                                ? $social_link->social_icon_hover_color : 'inherit';
            ...
            if (function_exists("vc_map")) {
                vc_map(
                    [
                        ...
                        "admin_enqueue_js" => preg_replace('/\s/', '%20',
                                                           plugins_url('../admin/js/team-admin.js', __FILE__)),
                        "params"           => [
                            ...
                            [
                                ...
                                "default_set" => TRUE,
                                "description" => "",
                                "dependency"  => ["element" => "team_member_style", "value" => ['style-1', 'style-3']],
                                "group"       => "Image",
                            ],
                            [
                                "type"        => "dropdown",
                            ...
                            [
                                ...
                                "value"       => "",
                                "suffix"      => "",
                                "dependency"  => ["element" => "img_border_style", "not_empty" => TRUE],
                                "description" => __("", "ultimate_vc"),
                                "group"       => "Image",
                            ],
                            [
                            ...
                            [
                                ...
                                "description" => "",
                                "dependency"  => ["element" => "team_member_style", "value" => 'style-1'],
                                "group"       => "Image",
                            ],
                            [
                                "type"        => "colorpicker",
                                ...
                                "description" => "",
                                "group"       => "Image",
                                "dependency"  => ["element" => "img_hover_eft", "value" => 'on'],
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
                                ...
                                "description" => "",
                                "group"       => "Image",
                                "dependency"  => ["element" => "team_member_style", "value" => ['style-2', 'style-3']],
                            ],
                            [
                                "type"        => "number",
                                "class"       => "",
                                ...
                                "description" => __("Enter value between 0.0 to 1 (0 is maximum transparency, while 1 is lowest)",
                                                    "ultimate_vc"),
                                "group"       => "Image",
                                "dependency"  => ["element" => "team_member_style", "value" => ['style-2']],
                            ],
                            [
                                "type"        => "number",
                                "class"       => "",
                            ...
                            [
                                ...
                                "description" => __("Enter value between 0.0 to 1 (0 is maximum transparency, while 1 is lowest)",
                                                    "ultimate_vc"),
                                "group"       => "Image",
                                "dependency"  => ["element" => "team_member_style", "value" => ['style-3']],
                            ],
                            [
                                "type"        => "textfield",
                            ...
                            [
                                ...
                                "options"     => [
                                    "on" => [
                                        "label" => __("Add Social Icon links to connect on social network",
                                                      "ultimate_vc"),
                                        "on"    => "Yes",
                                        "off"   => "No",
                                    ],
                            ...
                            [
                                ...
                                "dependency" => ["element" => "social_icon_effect", "value" => 'on'],
                                'callbacks'  => [
                            ...
                            [
                                ...
                                "description" => "",
                                "group"       => "Social Links",
                                "dependency"  => ["element" => "divider_effect", "value" => 'on'],
                            ],
                            [
                                "type"       => "number",
                                "class"      => "",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "team_member_responsive_enable", "value" => 'on'],
                                "group"       => "Advanced"
                            ],
                            [
                                "type"        => "ult_switch",
                            ...
                            [
                                ...
                                "group"      => __("Advanced", "ultimate_vc"),
                                "dependency" => ["element" => "link_switch", "value" => 'on'],
                            ],
                            /*array(
                                "type"        => "colorpicker",
                                "class"       => "",
