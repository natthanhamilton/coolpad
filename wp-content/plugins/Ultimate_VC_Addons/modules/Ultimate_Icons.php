...
if (!class_exists('Ultimate_Icons')) {
    class Ultimate_Icons {
        function __construct() {
            add_action('init', [$this, 'ultimate_icon_init']);
            add_shortcode('ultimate_icons', [$this, 'ultimate_icons_shortcode']);
            add_shortcode('single_icon', [$this, 'single_icon_shortcode']);
        }
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "description"             => __("Add a set of multiple icons and give some custom style.",
                                                        "ultimate_vc"),
                        "as_parent"               => ['only' => 'single_icon'], // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
                ...
                vc_map(
                    [
                        ...
                        "description"             => __("Add a set of multiple icons and give some custom style.",
                                                        "ultimate_vc"),
                        "as_child"                => ['only' => 'ultimate_icons'], // Use only|except attributes to limit child shortcodes (separate multiple values with comma)
                        "show_settings_on_create" => TRUE,
                        "is_container"            => FALSE,
                        "params"                  => [
                            // Play with icon selector
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "tooltip_disp", "not_empty" => TRUE],
                                "group"       => "Other Settings"
                            ],
                            [
                                "type"        => "textfield",
        ...
        function ultimate_icons_shortcode($atts, $content = NULL) {
            ...
            $icon_design_css = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                             vc_shortcode_custom_css_class($css_icon, ' '), "ultimate_icons", $atts);
