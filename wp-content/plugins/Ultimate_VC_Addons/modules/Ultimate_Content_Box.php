...
if (!class_exists('Ult_Content_Box')) {
    class Ult_Content_Box {
        function __construct() {
            add_shortcode("ult_content_box", [$this, "ult_content_box_callback"]);
            add_action('init', [$this, 'ult_content_box_init']);
            add_action('wp_enqueue_scripts', [$this, 'ult_content_box_scripts'], 1);
        }
        ...
        function ult_content_box_callback($atts, $content = NULL) {
            ...
            $style
                =
            $url = $link_title = $target = $responsive_margins = $normal_margins = $hover = $shadow = $data_attr = '';
            if ($bg_type != '') {
                switch ($bg_type) {
        ...
        function ult_content_box_init() {
            if (function_exists("vc_map")) {
                vc_map([
                           ...
                           "as_parent"               => ['except' => 'ult_content_box'],
                           //"as_parent" => '',
                           ...
                           "params"                  => [
                               ...
                               [
                                   ...
                                   "dependency"  => ["element" => "bg_type", "value" => "bg_image"],
                               ],
                               [
        ...
        function ult_content_box_scripts() {
            ...
            wp_register_script('ult_content_box_js', plugins_url($js_path . 'content-box' . $ext . '.js', __FILE__),
