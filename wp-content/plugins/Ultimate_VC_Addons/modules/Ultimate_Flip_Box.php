...
if (!class_exists('AIO_Flip_Box')) {
    class AIO_Flip_Box {
        function __construct() {
            ...
            add_shortcode('icon_counter', [$this, 'block_shortcode']);
            add_action('wp_enqueue_scripts', [$this, 'flip_box_scripts'], 1);
        }
                    ...
                    [
                        ...
                        "params"      => [
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "flip_box_style", "value" => ["simple"]],
                            ],
                            [
                                "type"        => "colorpicker",
                                "class"       => "",
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "flip_box_style", "value" => ["advanced"]],
                            ],
                            [
                                "type"        => "number",
                                "class"       => "",
                                ...
                                "suffix"      => "px",
                                "description" => __("Enter value in pixels.", "ultimate_vc"),
                                "dependency"  => ["element" => "box_border_style", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
                            ],
                            [
                                "type"        => "dropdown",
                                "class"       => "",
                            ...
                            [
                                ...
                                "param_name"  => "icon",
                                "value"       => "",
                                "description" => __("Click and select icon of your choice. If you can't find the one that suits for your purpose, you can",
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("Text here will be followed by a button. So make it catchy!",
                                                    "ultimate_vc"),
                                "group"       => "Back"
                            ],
                            [
                            ...
                            [
                                ...
                                "value"       => "",
                                "description" => __("You can link or remove the existing link on the button from here.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "custom_link", "not_empty" => TRUE, "value" => ["1"]],
                            ],
                            [
                                "type"        => "textfield",
                                "class"       => "",
                            ...
                            [
                                ...
                                "value"       => "#333333",
                                "description" => __("Color of the button. Make sure it'll match with Back Side Box Color.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "custom_link", "not_empty" => TRUE, "value" => ["1"]],
                            ],
                            [
                            ...
                            [
                                ...
                                "value"       => [
                                    __("Display full the content and adjust height of box accordingly",
                                       "ultimate_vc")                                                             => "ifb-jq-height",
                                    __("Hide extra content that doesn't fit in height of the box",
                                       "ultimate_vc")                                                             => "ifb-auto-height",
                                    __("Give a custom height of your choice to the box",
                                       "ultimate_vc")                                                             => "ifb-custom-height",
                                ],
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "height_type", "value" => ["ifb-custom-height"]],
                            ],
                            [
                                "type"        => "ult_switch",
                                "class"       => "",
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Add extra class name that will be applied to the icon process, and you can use this class for your customizations.",
                                                    "ultimate_vc"),
                            ],
                            [
                                "type"             => "text",
                            ...
                            [
                                ...
                                "description" => __("Select the font of your choice.",
                                                    "ultimate_vc") . " " . __("You can",
                                                                              "ultimate_vc") . " <a target='_blank' href='" . admin_url('admin.php?page=bsf-google-font-manager') . "'>" . __("add new in the collection here",
                                                                                                                                                                                              "ultimate_vc") . "</a>.",
                                "value"       => "",
                                "group"       => "Typography"
                            ],
                            ...
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/1qnl6' target='_blank'>" . __("Watch Video Tutorial",
        ...
        function block_shortcode($atts) {
            $icon_type
                ...
                = $block_desc_front
                = $block_title_back = $block_desc_back = $button_text = $button_link = $block_text_color
                = $block_front_color = $block_back_color = $block_back_text_color = $animation = $font_size_icon
                = $box_border_style = $box_border_size = $box_border_color = $border_size = $border_color
                = $box_border_color_back = $custom_link = $button_bg = $button_txt = $height_type = $box_height
                = $flip_type
                =
            $flip_box_style = $text_color = $bg_color = $front_text = $back_text = $box_border_color_advanced = '';
            $desc_font_line_height
                = $title_font_line_height
                =
            $title_font = $title_font_style = $title_font_size = $desc_font = $desc_font_style = $desc_font_size = '';
            ...
            $output
                          = $f_style = $b_style = $ico_color
                = $box_border = $icon_border = $link_style = $height = $link_sufix = $link_prefix = $link_style = '';
        ...
        function flip_box_scripts() {
            ...
            wp_register_script('flip_box_js', plugins_url($js_path . 'flip-box' . $ext . '.js', __FILE__), ['jquery'],
                               ULTIMATE_VERSION, TRUE);
            wp_register_style('ult-flip-style', plugins_url($css_path . 'flip-box' . $ext . '.css', __FILE__), [],
