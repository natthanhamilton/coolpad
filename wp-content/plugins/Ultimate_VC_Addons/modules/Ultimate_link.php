...
if (!class_exists('AIO_creative_link')) {
	class AIO_creative_link {
		function __construct() {
			add_shortcode('ult_createlink', [$this, 'ult_createlink_shortcode']);
			add_action('init', [$this, 'ultimate_createlink']);
			add_action('wp_enqueue_scripts', [$this, 'creative_link_scripts'], 1);
		...
		function creative_link_scripts() {
			...
			wp_register_style('ult_cllink', plugins_url($css_path . 'creative-link' . $ext . '.css', __FILE__), [],
			                  ULTIMATE_VERSION);
			wp_register_script("jquery.ult_cllink", plugins_url($js_path . "creative-link" . $ext . ".js", __FILE__),
		...
		function ult_createlink_shortcode($atts) {
			...
			$css_class         = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
			                                   vc_shortcode_custom_css_class($css, ' '), "ult_createlink", $atts);
...
//$colorstyle .='font-size:'.$title_font_size.'px;';
				...
				if ($link_hover_style == 'Style_2') {              //style2
					$class .= 'ult_cl_link_2';
//$id .='ult_cl_link_2';
				} else {
					if ($link_hover_style == 'Style_3') {               //style3
						$class .= 'ult_cl_link_3';
//$id .='ult_cl_link_3';
						$data_border = '';
						$data_border .= 'border-color:' . $border_color . ';';
...
//$colorstyle .='font-size:'.$title_font_size.'px;';
						...
						if ($link_hover_style == 'Style_4') {               //style4
							$class .= 'ult_cl_link_4';
//$id .='ult_cl_link_4';
							$data_border = '';
							$data_border .= 'border-color:' . $border_color . ';';
...
///$colorstyle .='font-size:'.$title_font_size.'px;';
							...
							if ($link_hover_style == 'Style_6') {               //style6
								$class .= 'ult_cl_link_6';
//$id .='ult_cl_link_6';//
...
//$colorstyle .='font-size:'.$title_font_size.'px;';
								...
								if ($link_hover_style == 'Style_5') {               //style5
									$class .= 'ult_cl_link_5';
//$id .='ult_cl_link_5';//
									if ($title_font_size != '') {
//$colorstyle .='font-size:'.$title_font_size.'px;';
									...
									if ($link_hover_style == 'Style_7') {               //style7
										$class .= 'ult_cl_link_7';
//$id .='ult_cl_link_7';//
//$colorstyle .='font-size:'.$title_font_size.'px;';
										...
										$before
											= '<span class="ult_link_top btn7_link_top " style="' . $borderstyle . '"></span>';
										$after .= '<span class="ult_link_btm  btn7_link_btm" style="' . $borderstyle . '"></span>';
									} else {
										if ($link_hover_style == 'Style_8') {               //style8
											$class .= 'ult_cl_link_8';
//$id .='ult_cl_link_8';//
											if ($title_font_size != '') {
//$colorstyle .='font-size:'.$title_font_size.'px;';
											...
											$before
												= '<span class="ult_link_top ult_btn8_link_top " style="' . $borderstyle . '"></span>';
											$after .= '<span class="ult_link_btm  ulmt_btn8_link_btm" style="' . $borderhover . '"></span>';
										} else {
											if ($link_hover_style == 'Style_9') {               //style9
												$class .= 'ult_cl_link_9';
//$id .='ult_cl_link_9';//
												if ($title_font_size != '') {
//$colorstyle .='font-size:'.$title_font_size.'px;';
...
//$borderstyle .='height:'; //text color for btm border
												$before
													= '<span class="ult_link_top ult_btn9_link_top " style="' . $borderstyle . '"></span>';
												$after .= '<span class="ult_link_btm  ult_btn9_link_btm" style="' . $borderstyle . '"></span>';
											} else {
												if ($link_hover_style == 'Style_10') {               //style10
...
//padding
														...
														$before
															= '<span class="ult_link_top ult_btn11_link_top " style="' . $span_style1 . ';' . $ult_style11css . '">' . $text . '</span>';
													}
												}
											}
										}
					...
					[
						...
						"params"      => [
							...
							[
								...
								//"group" => "Title Setting",
								"dependency"  => ["element" => "link_hover_style", "value" => ["Style_2", "Style_10", "Style_11"]],
							],
							[
								"type"        => "colorpicker",
								"class"       => "",
							...
							[
								...
								"dependency"  => ["element" => "link_hover_style", "value" => ["Style_3", "Style_4", "Style_5", "Style_7", "Style_8", "Style_9", "Style_10"]],
							],
							[
								"type"        => "colorpicker",
								"class"       => "",
								...
								"dependency"  => ["element" => "border_style", "value" => ["solid", "dashed", "dotted", "double", "inset", "outset"]],
							],
							[
								"type"        => "colorpicker",
								"class"       => "",
								...
								"dependency"  => [
									"element" => "link_hover_style", "value" => ["Style_8"],
							...
							[
								...
								"dependency"  => ["element" => "link_hover_style", "value" => ["Style_6"]],
							],
							[
								"type"        => "dropdown",
								"class"       => "",
