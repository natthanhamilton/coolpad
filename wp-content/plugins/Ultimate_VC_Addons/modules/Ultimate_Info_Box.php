...
if (!class_exists('AIO_Icons_Box')) {
    class AIO_Icons_Box {
        function __construct() {
            ...
            add_shortcode('bsf-info-box', [&$this, 'icon_boxes']);
            // Initialize the icon box component for Visual Composer
            add_action('init', [&$this, 'icon_box_init']);
            add_action('wp_enqueue_scripts', [$this, 'icon_box_scripts'], 1);
        }
        ...
        function icon_boxes($atts, $content = NULL) {
            $icon_type
                ...
                = $icon_border_spacing
                = $el_class = $icon_animation = $title = $link = $hover_effect = $pos = $read_more = $read_text
                = $box_border_style = $box_border_width = $box_border_color
                = $box_bg_color = $pos = $css_class = $desc_font_line_height = $title_font_line_height = '';
            $title_font
                = $title_font_style = $title_font_size = $title_font_color
                = $desc_font = $desc_font_style = $desc_font_size = $desc_font_color = $box_min_height = '';
            ...
            $inf_design_style = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                              vc_shortcode_custom_css_class($css_info_box, ' '), "bsf-info-box", $atts);
            ...
            if ($link !== 'none') {
                if ($read_more == 'box') {
                    ...
                    $output
                        = $prefix . '<a class="aio-icon-box-link" href="' . $href['url'] . '" ' . $target . '>' . $html . '</a>' . $suffix;
                } else {
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "description" => __("Add a custom link or select existing page. You can remove existing link as well.",
                                                    "ultimate_vc"),
                                "dependency"  => ["element" => "read_more", "value" => ["box", "title", "more"]],
                            ],
                            ...
                            [
                                ...
                                "dependency"  => ["element" => "read_more", "value" => ["more"]],
                            ],
                            // Hover Effect type
                            [
                                "type"        => "dropdown",
                            ...
                            [
                                ...
                                "description" => __("Select icon position. Icon box style will be changed according to the icon position.",
                                                    "ultimate_vc")
                            ],
                            [
                                "type"        => "number",
                                ...
                                "value"       => "",
                                "suffix"      => "px",
                                "dependency"  => ["element" => "pos", "value" => ["square_box"]],
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Add extra class name that will be applied to the icon box, and you can use this class for your customizations.",
                                                    "ultimate_vc"),
                            ],
                            [
                            ...
                            */
                            ...
                            [
                                "type"             => "ult_param_heading",
                                "text"             => "<span style='display: block;'><a href='http://bsf.io/kqzzi' target='_blank'>" . __("Watch Video Tutorial",
        ...
        function icon_box_scripts() {
            ...
            wp_register_script('info_box_js', plugins_url($js_path . 'info-box' . $ext . '.js', __FILE__), ['jquery'],
                               ULTIMATE_VERSION, TRUE);
            wp_register_style('info-box-style', plugins_url($css_path . 'info-box' . $ext . '.css', __FILE__), [],
