...
if (!class_exists('Ultimate_List_Icon')) {
    class Ultimate_List_Icon {
        function __construct() {
            add_action('init', [$this, 'list_icon_init']);
            add_shortcode('ultimate_icon_list', [$this, 'ultimate_icon_list_shortcode']);
            add_shortcode('ultimate_icon_list_item', [$this, 'icon_list_item_shortcode']);
        }
            ...
            if (function_exists('vc_map')) {
                vc_map(
                    [
                        ...
                        "description"             => __("Add a set of multiple icons and give some custom style.",
                                                        "ultimate_vc"),
                        "as_parent"               => ['only' => 'ultimate_icon_list_item'],
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "param_name"  => "el_class",
                                "value"       => "",
                                "description" => __("Write your own CSS and mention the class name here.",
                                                    "ultimate_vc"),
                            ],
                            [
                                'type'             => 'css_editor',
                ...
                vc_map(
                    [
                        ...
                        "icon"                    => "icon_list_item",
                        "category"                => "Ultimate VC Addons",
                        "description"             => __("Add a list of icons with some content and give some custom style.",
                                                        "ultimate_vc"),
                        "as_child"                => ['only' => 'ultimate_icon_list'],
                        "show_settings_on_create" => TRUE,
                        "is_container"            => FALSE,
                        "params"                  => [
                            // Play with icon selector
        ...
        function ultimate_icon_list_shortcode($atts, $content = NULL) {
            ...
            $css_icon_list = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                           vc_shortcode_custom_css_class($css_icon_list, ' '), "ultimate_icon_list",
                                           $atts);
            ...
            $output
                = '<div class="uavc-list-icon uavc-list-icon-wrapper ' . $is_vc_49_plus . ' ' . $el_class . ' ' . $css_icon_list . ' ' . $css_icon_list . '">';
        ...
        function icon_list_item_shortcode($atts, $content = NULL) {
            $icon_type
                ...
                = $icon_border_spacing
                = $icon_link = $el_class = $icon_animation = $tooltip_disp = $tooltip_text = $icon_margin = '';
            $content_font_family
                = $content_font_style = $content_font_size = $content_line_ht = $content_font_color = '';
            extract(shortcode_atts([
                                       'icon_type'           => 'selector',
                                       'icon'                => '',
                                       'icon_img'            => '',
