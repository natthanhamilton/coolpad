window.bsfmodernizr = function (a, b, c) {
    ...
    var j, k, l, m = "2.7.1", n = {}, o = !0, p = b.documentElement, q = "bsfmodernizr", r = b.createElement(q), s = r.style, t = ({}.toString, "Webkit Moz O ms"), u = t.split(" "), v = t.toLowerCase().split(" "), w = {}, x = [], y = x.slice, z = {}.hasOwnProperty;
...
!function (a) {
    ...
    var c = function (b) {
        ...
        function u(a) {
            ...
            if (this.node = a, b && (this.paper = new y(b)), this.type = a.tagName, this.anims = {}, this._ = {transform: []}, a.snap = c, ha[c] = this, "g" == this.type) {
                this.add = t;
        ...
        function y(a, b) {
            ...
            if (a && "svg" == a.tagName) {
                ...
                c.paper = c.root = c
            } else c = x("svg", I.doc.body), e(c.node, {height: b, version: 1.1, width: a, xmlns: ga});
            return c
        }
        ...
        function G(a) {
            return function (c) {
                if (b.stop(), c instanceof w && 1 == c.node.childNodes.length && ("radialGradient" == c.node.firstChild.tagName || "linearGradient" == c.node.firstChild.tagName || "pattern" == c.node.firstChild.tagName) && (c = c.node.firstChild, r(this).appendChild(c), c = z(c)), c instanceof u)if ("radialGradient" == c.type || "linearGradient" == c.type || "pattern" == c.type) {
                    ...
                    var g = D(r(this), c);
                    g ? (g.node.id || e(g.node, {id: g.id}), f = ia(g.node.id)) : f = c
                } else f = K(f);
                var h = {};
        ...
        d._.clone = h, d._.cacher = j, d.rad = l, d.deg = m, d.angle = k, d.is = f, d.snapTo = function (a, b, c) {
            ...
            if (!a || (a = K(a)).indexOf("-") + 1)return {r: -1, g: -1, b: -1, hex: "none", error: 1, toString: na};
            if ("none" == a)return {r: -1, g: -1, b: -1, hex: "none", toString: na};
        ...
        var ka = function (a) {
            ...
            var g = {r: a, g: b, b: c, opacity: f(e, "finite") ? e : 1, hex: d.rgb(a, b, c), toString: na};
        ...
        d.color = function (a) {
            ...
            return f = O(a, b, c), g = f - P(a, b, c), d = 0 == g ? null : f == a ? (b - c) / g : f == b ? (c - a) / g + 2 : (a - b) / g + 4,
                d = 60 * ((d + 360) % 6) / 360, e = 0 == g ? 0 : g / f, {h: d, s: e, b: f, toString: la}
        ...
        d._.getSomeDefs = r, d.select = function (a) {
            ...
            a.el = function (a, b) {
                ...
                a.gradient = function (a) {
                    ...
                    return b.appendChild(c), c.appendChild(d), e(d, {xmlns: ga}), a = c.innerHTML, b.removeChild(b.firstChild), a
                }, a.clear = function () {
        ...
        b.on("snap.util.attr", function (a) {
            ...
            function c(a) {
                return function (c) {
                    ...
                    if ("marker" == c.type) {
                        var f = c.node.id;
                        return f || e(c.node, {id: c.id}), void(this.node.style[d] = ia(f))
                    }
                }
            }
    ...
    function b(b) {
        ...
        if (joverlay = document.querySelector(c), i = a(c), i.hasClass("ult-open")) {
            ...
            support.transitions ? (joverlay.addEventListener(transEndEventName, d), i.removeClass("ult-close"), e > f && a("html").css({overflow: "auto"})) : d()
        } else i.hasClass("ult-close") || i.addClass("ult-open");
        var e = i.find(".ult_modal").outerHeight(), f = a(window).outerHeight();
        e > f && a("html").css({overflow: "hidden"})
    }

    function c(b) {
        var c = "div.overlay-cornershape." + b, d = document.querySelector(c), e = a(c), f = Snap(d.querySelector("svg")), g = f.select("path"), h = {
        ...
        if (e.hasClass("ult-open")) {
            ...
            g.animate({path: h.from}, 400, mina.linear, i)
        } else e.hasClass("ult-close") || (e.addClass("ult-open"), g.animate({path: h.to}, 400, mina.linear))
    }

    function d(b) {
        var c = "div.overlay-genie." + b, d = document.querySelector(c), e = a(c), f = Snap(d.querySelector("svg")), g = f.select("path"), h = d.getAttribute("data-steps").split(";"), i = h.length;
        if (e.hasClass("ult-open")) {
            var j = i - 1;
            e.removeClass("ult-open"), e.addClass("ult-close");
            var k = function (a) {
                ...
                a--, 0 > a || g.animate({path: h[a]}, 60, mina.linear, function () {
                    0 === a && k(), l(a)
                })
            };
            l(j)
            ...
            e.addClass("ult-open");
            var l = function (a) {
                a++, a > i - 1 || g.animate({path: h[a]}, 60, mina.linear, function () {
                    l(a)
                })
            };
            l(j)
    ...
    function f(b) {
        var c = "div.overlay-boxes." + b, d = document.querySelector(c), f = a(c), g = [].slice.call(d.querySelectorAll("svg > path")), h = g.length, i = 0;
    ...
    function g(b) {
        var c = a("." + b).find(".ult_modal-content").height(), d = a(window).height();
    ...
    function h() {
        a(".ult_modal-body iframe").each(function (b, c) {
            var d = a(this).parent().width(), e = (!!a(this).parent().parent().parent().hasClass("ult-small"), !!a(this).parent().parent().parent().hasClass("ult-medium"), !!a(this).parent().parent().parent().hasClass("ult-container")), f = !!a(this).parent().parent().parent().hasClass("ult-block"), g = d / 10, h = d * (9 / 16) + g, i = !(!a(this).parent().hasClass("ult-youtube") && !a(this).parent().hasClass("ult-vimeo"));
            if (!i)return !1;
            if (e) {
    ...
    }, transEndEventName = transEndEventNames[bsfmodernizr.prefixed("transition")], support = {transitions: bsfmodernizr.csstransitions};
    ...
    a(window).load(function () {
        ...
        a(".ult-onload").each(function (c) {
            ...
            var d = (a(this).attr("id"), a(this)[0]), e = $f(d);
        ...
        a(document).on("click", ".overlay-show", function (c) {
            ...
            c(d), a("body, html").removeClass("ult_modal-body-open"), a("html").css({overflow: "auto"}), a(document).trigger("onUVCModalPopUpClosed", d)
            ...
            f(c), a("body, html").removeClass("ult_modal-body-open"), a("html").css({overflow: "auto"}), a(document).trigger("onUVCModalPopUpClosed", c)
        }), a(document).on("click", ".overlay-show-genie", function (b) {
            b.preventDefault();
            var c = a(this).data("class-id");
            a("." + c).find(".ult_modal-content").removeClass("ult-hide"), setTimeout(function () {
                a("." + c).addClass("overlay-genie"), d(c), a("body, html").addClass("ult_modal-body-open"), g(c), a("html").css({overflow: "auto"})
            }, 300)
        }), a(document).on("click", "div.overlay-genie div.ult-overlay-close", function (b) {
            b.stopPropagation();
            var c = a(this).parents("div.overlay-genie").data("class");
            d(c), a("body, html").removeClass("ult_modal-body-open"), a("html").css({overflow: "auto"}), a(document).trigger("onUVCModalPopUpClosed", c)
        }), a(document).on("click", ".ult-overlay .ult-overlay-close", function (c) {
            c.stopPropagation();
            var d = a(this).parents(".ult-overlay").data("class");
            b(d), a("body, html").removeClass("ult_modal-body-open"), a(this).parent().find(".ult-vimeo").length ? a(this).parent().find(".ult-vimeo iframe").each(function (b, c) {
                var d = a(c), e = a(c).attr("src");
                a(c).attr("src", ""), a(c).attr("src", e);
                var c = d[0], f = $f(c);
                f.api("pause")
            }) : a(this).parent().find(".ult-youtube iframe").each(function (b, c) {
                var d = a(c).attr("src");
                a(c).attr("src", ""), a(c).attr("src", d)
            }), a("html").css({overflow: "auto"}), a(document).trigger("onUVCModalPopUpClosed", d)
        }), a(document).on("click", ".ult-overlay .ult_modal", function (a) {
            a.stopPropagation()
        }), a(document).on("click", ".ult-overlay", function (b) {
            b.stopPropagation(), b.preventDefault(), a(this).find(".ult-overlay-close").trigger("click"), a("html").css({overflow: "auto"})
        })
