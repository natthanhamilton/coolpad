function BSFMouseSmoothScroll() {
    var a = parseInt(jQuery("html").attr("data-ult_smooth_speed")), b = parseInt(jQuery("html").attr("data-ult_smooth_step"));
    if ("undefined" == typeof a)var a = 480;
    if ("undefined" == typeof b)var b = 80;
    jQuery.srSmoothscroll({step: b, speed: a, ease: "easeOutSine", target: jQuery("body"), container: jQuery(window)})
}
!function (a) {
    function b(b) {
    ...
    a.srSmoothscroll = function (b) {
        var c, d = a.extend({
            ...
            target: a("body"),
            container: a(window)
        }, b || {}), e = d.container, f = 0, g = d.step, h = e.height(), i = !1;
        c = "body" == d.target.selector ? -1 !== navigator.userAgent.indexOf("AppleWebKit") ? d.target : a("html") : e, d.target.mousewheel(function (a, b) {
            return i = !0, f = 0 > b ? f + h >= d.target.outerHeight(!0) ? f : f += g : 0 >= f ? 0 : f -= g, c.stop().animate({scrollTop: f}, d.speed, d.ease, function () {
                i = !1
            }), !1
