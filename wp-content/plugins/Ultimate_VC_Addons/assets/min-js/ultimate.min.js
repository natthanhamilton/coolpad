...
function ult_creative_link_ht() {
    jQuery(".ult_cl_link_9").each(function (a) {
        var b = jQuery(this).find(".ult_colorlink").outerHeight(), b = parseInt(b / 2);
...
function recallme() {
    jQuery(".ult_dual_button").each(function (a) {
        var b = jQuery(this).attr("id"), c = jQuery(this).data("response");
        if ("undefined" != c && "" != c || (c = "on"), "on" == c) {
            ...
            var e = jQuery(window).width(), f = jQuery(this).find(".ult_dual1").outerWidth(), g = jQuery(this).find(".ult_dual2").outerWidth();
            if (e > 300 && 768 >= e)var h = "inset 0px -" + f + "px 0px 0px ", i = " inset 0px " + g + "px 0px 0px "; else if (e > 768 && 1015 > e)var h = "inset 0px -" + f + "px 0px 0px ", i = " inset 0px " + g + "px 0px 0px "; else var h = "inset -" + f + "px 0 0 0 ", i = "inset " + g + "px 0 0 0";
            jQuery("#" + b).find(".ult_dual1").mouseenter(function () {
                var a = jQuery(this).find(".ult-dual-btn-1").attr("class"), b = a.split(" "), a = b[1] + b[2];
                if ("Style2" == a) {
                ...
                var a = jQuery(this).find(".ult-dual-btn-2").attr("class"), b = a.split(" "), a = b[1] + b[2];
                if ("Style2" == a) {
            ...
            d = document.createElement("style"), d.type = "text/css", d.innerHTML = "#" + b + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:first-child .ult_ivan_button { border-top-right-radius: 0!important; border-bottom-right-radius: 0!important }#" + b + ".ult_dual_button .ulitmate_dual_buttons .ult_dualbutton-wrapper:last-child .ult_ivan_button { border-top-left-radius: 0!important; border-bottom-left-radius: 0!important }#" + b + ".ult_dual_button .ult_dual1 { border-right: none!important}", document.getElementsByTagName("head")[0].appendChild(d), document.getElementsByTagName("head")[0].appendChild(d), jQuery("#" + b).find(".ult_dual1").mouseenter(function () {
                var a = jQuery(this).find(".ult-dual-btn-1").attr("class"), b = a.split(" "), a = b[1] + b[2], c = jQuery(this).outerWidth();
                if ("Style2" == a) {
                    var d = "inset -" + c + "px 0 0 0 ", e = jQuery(this).find(".ult-dual-btn-1").data("bghovercolor");
                ...
                var a = jQuery(this).find(".ult-dual-btn-2").attr("class"), b = a.split(" "), a = b[1] + b[2], c = jQuery(this).outerWidth();
                if ("Style2" == a) {
                    var d = "inset " + c + "px 0 0 0", e = jQuery(this).find(".ult-dual-btn-2").data("bghovercolor");
                    jQuery(this).css({"box-shadow": d + e})
                }
            }), jQuery("#" + b).find(".ult_dual2").mouseleave(function () {
                var a = jQuery(this).find(".ult-dual-btn-2").attr("class"), b = a.split(" "), a = b[1] + b[2];
...
function calculate_clipped_circle() {
    jQuery(".clipped-info-circle").each(function () {
        var a = jQuery(this).data("circle-type"), b = jQuery(this).data("half-percentage"), c = jQuery(this).children().data("responsive-circle");
        if ("on" == c) {
            var d = jQuery(this).children().data("responsive-breakpoint"), e = jQuery(window).width(), a = jQuery(this).data("circle-type");
            if (e > d) {
        ...
        var g = jQuery(this).find(".info-circle-icons").outerHeight(), h = jQuery(this).find(".info-circle-icons").outerHeight();
        if ("full-circle" != a) {
            var i = jQuery(this).outerHeight(), j = (jQuery(this).outerWidth(), jQuery(this).css("margin-top")), k = jQuery(this).css("margin-bottom"), l = jQuery(this).children().outerWidth(), m = parseInt(jQuery(this).find(".info-c-full").css("margin-top").replace(/[^-\d\.]/g, "")), n = parseInt(jQuery(this).find(".info-c-full").css("padding-top").replace(/[^-\d\.]/g, ""));
            if ("top-circle" == a || "bottom-circle" == a) {
                ...
                if ("top-circle" == a) {
                    ...
                    var r = (100 - b) / 100 * i, p = i - r + 10;
                    jQuery(this).css({
                        "padding-bottom": k,
                        height: p,
                        "margin-top": 0
                    }), jQuery(this).children().css({"margin-top": -(r + g / 2)});
                    var q = p - m - parseInt(j.replace(/[^-\d\.]/g, "")) - n - n / 2;
                    jQuery(this).find(".info-c-full-wrap").height(q);
                    var s = o - q;
                    jQuery(this).find(".info-c-full-wrap").css({"margin-top": s + "px"})
                }
            } else if ("left-circle" == a || "right-circle" == a) {
                jQuery(this).css({overflow: "hidden", "padding-top": j, "padding-bottom": k});
                var o = (jQuery(this).find(".info-c-full").outerWidth(), jQuery(this).find(".info-c-full").width());
                if ("left-circle" == a) {
                    var t = b / 100 * l;
                    jQuery(this).css({width: t, "padding-left": j}), jQuery(this).children().css({
                        width: l,
                        "max-width": l
                    });
                    ...
                    var v = (100 - b) / 100 * l, t = parseInt(l - v);
                    jQuery(this).css({
                        width: t,
                        "padding-right": j
                    }), jQuery(this).children().css({"margin-left": -(v + h / 2), "max-width": l, width: l});
                    var w = v - m;
                    w = w + parseInt(j.replace(/[^-\d\.]/g, "")) - n;
                    var u = t - m - parseInt(j.replace(/[^-\d\.]/g, "")) - n, x = w;
                    jQuery(this).find(".info-c-full-wrap").width(u), jQuery(this).find(".info-c-full-wrap").css({"margin-left": x + "px"})
                }
            }
        }
        if ("on" == c) {
            var d = jQuery(this).children().data("responsive-breakpoint"), e = jQuery(window).width();
            d >= e && jQuery(this).css({width: "auto", overflow: "visible", height: "auto", padding: 0})
        }
    })
}
    ...
    b.bsf_appear(function () {
        setInterval(function () {
            if ("on" == b.attr("data-slide-true")) {
                var a = 1 * b.attr("data-slide-number"), c = b.find(".info-circle-icons").length;
...
function show_next_info_circle(a) {
    ...
    var c = a.next(), d = a.parents(".info-c-full-br").data("icon-show-size");
    ...
    e.find(".info-c-full-wrap").stop().animate({opacity: 0}, "slow", function () {
        a.parents(".info-c-full-br").find(".info-c-full .info-c-full-wrap").html(c), e.find(".info-c-full i").css({"font-size": parseInt(d) + "px"}), e.find(".info-c-full img").css({width: parseInt(d) + "px"}), a.parents(".info-c-full-br").find(".info-c-full-wrap").animate({opacity: 1}, "slow")
    })
}
function responsive_check(a) {
    jQuery(a).each(function () {
        if ("on" == jQuery(this).data("responsive-circle")) {
            ...
            var f = jQuery(this).parent().find(".smile_icon_list_wrap .smile_icon_list"), g = f.find(".icon_list_item").clone();
            f.find(".icon_list_item").remove();
            var h = jQuery(this).next().data("content_bg"), i = jQuery(this).next().data("content_color");
            jQuery(this).find(".icon-circle-list .info-details").each(function () {
                var a = jQuery(this).attr("data-icon-class"), b = jQuery(this).find(".info-circle-heading").html(), c = jQuery(this).find(".info-circle-text").html(), d = jQuery(this).prev().css("background-color"), e = jQuery(this).prev().css("color"), j = jQuery(this).prev().css("border"), k = jQuery(this).find(".info-circle-sub-def").children().eq(0).clone();
    ...
    jQuery(a).each(function () {
        jQuery(this).bsf_appear(function () {
            if ("none" != jQuery(this).css("display")) {
                var a = jQuery(this).find(".icon-circle-list .info-circle-icons").length, b = new Array, c = jQuery(this).outerWidth() / 2, d = 0, e = jQuery(this).data("start-degree");
                "undefined" == typeof e && "" == e || (d = e);
                var f = 180 / a, g = jQuery(this).data("info-circle-angle"), h = jQuery(this).data("divert"), i = "";
                ...
                var m = 0, n = 0, o = jQuery(this).data("launch"), p = jQuery(this).data("launch-duration"), q = jQuery(this).data("launch-delay");
                p || (p = 1), q || (q = .15), "" != o ? (n = -(1e3 * q), jQuery(this).find(".icon-circle-list .info-circle-icons").each(function () {
                    var a = jQuery(this);
                    n += 1e3 * q, setTimeout(function () {
                        a.animate({opacity: 1, left: b[m++], top: b[m++]}, {duration: 1e3 * p, easing: o})
                    }, n)
...
!function (a) {
    jQuery(document).ready(function () {
        ...
        function d(b, d) {
            var e = b.data("seperator"), f = b.data("seperator-type"), g = b.data("seperator-shape-size"), h = b.data("seperator-background-color"), i = b.data("seperator-border"), j = b.data("seperator-border-color"), k = b.data("seperator-border-width"), l = b.data("seperator-svg-height"), m = b.data("seperator-full-width"), n = b.data("seperator-position");
            ...
            if ("undefined" != typeof e && "true" == e.toString()) {
                ...
                if ("triangle_seperator" == f)seperator_class = "ult-trinalge-seperator"; else if ("circle_seperator" == f)seperator_class = "ult-circle-seperator"; else if ("diagonal_seperator" == f)seperator_class = "ult-double-diagonal"; else if ("triangle_svg_seperator" == f)seperator_class = "ult-svg-triangle", svg = '<svg class="uvc-svg-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 0.156661 0.1"><polygon points="0.156661,3.93701e-006 0.156661,0.000429134 0.117665,0.05 0.0783307,0.0999961 0.0389961,0.05 -0,0.000429134 -0,3.93701e-006 0.0783307,3.93701e-006 "/></svg>', r = !0; else if ("circle_svg_seperator" == f)seperator_class = "ult-svg-circle", svg = '<svg class="uvc-svg-circle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 0.2 0.1"><path d="M0.200004 0c-3.93701e-006,0.0552205 -0.0447795,0.1 -0.100004,0.1 -0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1l0.200004 0z"/></svg>', r = !0; else if ("xlarge_triangle_seperator" == f)seperator_class = "ult-xlarge-triangle", svg = '<svg class="uvc-x-large-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-0 0.333331l4.66666 0 0 -3.93701e-006 -2.33333 0 -2.33333 0 0 3.93701e-006zm0 -0.333331l4.66666 0 0 0.166661 -4.66666 0 0 -0.166661zm4.66666 0.332618l0 -0.165953 -4.66666 0 0 0.165953 1.16162 -0.0826181 1.17171 -0.0833228 1.17171 0.0833228 1.16162 0.0826181z"/></svg>', r = !0; else if ("xlarge_triangle_left_seperator" == f)seperator_class = "ult-xlarge-triangle-left", svg = '<svg class="uvc-x-large-triangle-left" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 2000 90" preserveAspectRatio="none"><polygon xmlns="http://www.w3.org/2000/svg" points="535.084,64.886 0,0 0,90 2000,90 2000,0 "></polygon></svg>', r = !0; else if ("xlarge_triangle_right_seperator" == f)seperator_class = "ult-xlarge-triangle-right", svg = '<svg class="uvc-x-large-triangle-right" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 2000 90" preserveAspectRatio="none"><polygon xmlns="http://www.w3.org/2000/svg" points="535.084,64.886 0,0 0,90 2000,90 2000,0 "></polygon></svg>', r = !0; else if ("xlarge_circle_seperator" == f)seperator_class = "ult-xlarge-circle", svg = '<svg class="uvc-x-large-circle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil1" d="M4.66666 0l0 7.87402e-006 -3.93701e-006 0c0,0.0920315 -1.04489,0.166665 -2.33333,0.166665 -1.28844,0 -2.33333,-0.0746339 -2.33333,-0.166665l-3.93701e-006 0 0 -7.87402e-006 4.66666 0z"/></svg>', r = !0; else if ("curve_up_seperator" == f)seperator_class = "ult-curve-up-seperator", svg = '<svg class="curve-up-inner-seperator uvc-curve-up-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-7.87402e-006 0.0148858l0.00234646 0c0.052689,0.0154094 0.554437,0.154539 1.51807,0.166524l0.267925 0c0.0227165,-0.00026378 0.0456102,-0.000582677 0.0687992,-0.001 1.1559,-0.0208465 2.34191,-0.147224 2.79148,-0.165524l0.0180591 0 0 0.166661 -7.87402e-006 0 0 0.151783 -4.66666 0 0 -0.151783 -7.87402e-006 0 0 -0.166661z"/></svg>', r = !0; else if ("curve_down_seperator" == f)seperator_class = "ult-curve-down-seperator", svg = '<svg class="curve-down-inner-seperator uvc-curve-down-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-7.87402e-006 0.0148858l0.00234646 0c0.052689,0.0154094 0.554437,0.154539 1.51807,0.166524l0.267925 0c0.0227165,-0.00026378 0.0456102,-0.000582677 0.0687992,-0.001 1.1559,-0.0208465 2.34191,-0.147224 2.79148,-0.165524l0.0180591 0 0 0.166661 -7.87402e-006 0 0 0.151783 -4.66666 0 0 -0.151783 -7.87402e-006 0 0 -0.166661z"/></svg>', r = !0; else if ("tilt_left_seperator" == f)seperator_class = "ult-tilt-left-seperator", svg = '<svg class="uvc-tilt-left-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4 0.266661" preserveAspectRatio="none"><polygon class="fil0" points="4,0 4,0.266661 -0,0.266661 "/></svg>', r = !0; else if ("tilt_right_seperator" == f)seperator_class = "ult-tilt-right-seperator", svg = '<svg class="uvc-tilt-right-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 4 0.266661" preserveAspectRatio="none"><polygon class="fil0" points="4,0 4,0.266661 -0,0.266661 "/></svg>', r = !0; else if ("waves_seperator" == f)seperator_class = "ult-wave-seperator", svg = '<svg class="wave-inner-seperator uvc-wave-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + h + '" width="100%" height="' + l + '" viewBox="0 0 6 0.1" preserveAspectRatio="none"><path d="M0.199945 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c-0.0541102,0 -0.0981929,-0.0430079 -0.0999409,-0.0967008l0 0.0967008 0.0999409 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm2.00004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm-0.1 0.1l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm1.90004 -0.1c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.199945 0.00329921l0 0.0967008 -0.0999409 0c0.0541102,0 0.0981929,-0.0430079 0.0999409,-0.0967008z"/></svg>',
                    ...
                    if (0 != g) {
                        ...
                        jQuery(b).css({"padding-bottom": g + "px"}), 0 == y && (temp_padding = g)
                    }
                    if ("top_seperator" == n)var z = "top-split-seperator", A = "0px", B = "auto", C = "border-radius: 0 0 " + g + "px 0 !important;", D = "border-radius: 0 0 0 " + g + "px !important;"; else if ("bottom_seperator" == n)var z = "bottom-split-seperator", A = "auto", B = "0px", C = "border-radius: 0 " + g + "px 0 0 !important;", D = "border-radius: " + g + "px 0 0 0 !important;"; else var z = "top-bottom-split-seperator", E = "0px", F = "auto", G = "auto", H = "0px", I = "border-radius: 0 0 " + g + "px 0 !important;", J = "border-radius: 0 0 0 " + g + "px !important;", K = "border-radius: 0 " + g + "px 0 0 !important;", L = "border-radius: " + g + "px 0 0 0 !important;";
        ...
        function f() {
            jQuery(".ult-vc-seperator").each(function (a, b) {
                var c = jQuery(this).data("full-width"), d = jQuery(this).parent().data("rtl");
                ...
                if (("ex-full" == e || "full" == e || "browser_size" == e) && 1 == c) {
                    ...
                    if (jQuery(this).hasClass("ult-rounded-split-seperator-wrapper")) {
                        var g = jQuery(this).data("border"), h = jQuery(this).data("border-width");
                        "undefined" != typeof g && "none" != g && "undefined" != g && (f -= h)
                    }
                    var i = jQuery(this).offset().left;
                    jQuery(this).find(".ult-main-seperator-inner").width(f), "true" == d.toString() ? jQuery(this).find(".ult-main-seperator-inner").css({"margin-right": -i + "px"}) : jQuery(this).find(".ult-main-seperator-inner").css({"margin-left": -i + "px"})
                }
            })
        }
        ...
        Mini / i.test(navigator.userAgent) && a("html").addClass("ult-remove-fixed-background"), jQuery(window).scroll(function () {
            b()
            ...
            return jQuery(this).each(function () {
                ...
                P(), "" != C && (c.addClass("ult-vc-hide-row"), c.attr("data-hide-row", C)), c.attr("data-rtl", D), c.addClass("upb_video_class"), c.attr("data-row-effect-mobile-disable", B), "fadeout_row_value" == x && (c.addClass("vc-row-fade"), c.attr("data-fadeout-percentage", y)), c.attr("data-upb_br_animation", n), e && (-1 != e.indexOf("youtube.com") ? a = "youtube" : -1 != e.indexOf("vimeo.com") && (a = "vimeo"));
                var Q = "";
                if ("display_control" == v) {
                    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))var R = "ult-vid-cntrlplay", S = "pause"; else var R = "ult-vid-cntrlpause", S = "play";
                ...
                if ("browser_size" == k && (c.wrapInner('<div class="upb_video-text-wrapper"><div class="upb_video-text"></div></div>'), c.find(".upb_video-text-wrapper").find(".upb_video-text").addClass(N)), "parallax_content_value" == z) {
                    ...
                    var T = c.css("padding-top"), U = c.css("padding-bottom");
                ...
                if ("true" == E.toString() && (V = "uvc-video-fixer"), "youtube" == a || "vimeo" == a ? c.prepend('<div class="upb_video-wrapper ' + V + '"><div class="upb_video-bg utube" data-rtl="' + D + '" data-bg-override="' + k + '" data-row="' + H + '" data-theme-support="' + J + '">' + L + "</div></div>") : c.prepend(' <div class="upb_video-wrapper"><div class="upb_video-bg" data-bg-override="' + k + '" data-rtl="' + D + '" data-row="' + H + '" data-theme-support="' + J + '"><video class="upb_video-src"></video>' + Q + L + "</div></div>"), d(O, c), O.remove(), "youtube" == a) {
                    ...
                    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && "display_control" != v)"display_control" != v && ("" != j && (W.parent().css({"background-image": "url(" + j + ")"}), W.parent().find(".video-controls").hide()), W.remove()); else {
                        if (jQuery("<source/>", {
                                type: "video/mp4",
                                src: e
                        ...
                        "muted" == g && W.attr({"data-mute": "muted"}), "loop" == h && W.attr({loop: h}), W.attr({preload: "auto"}), u === !0 ? (W.addClass("enable-on-viewport"), W.addClass("hosted-video"), b()) : "autoplay" == i && W.attr({autoplay: i})
                    }
                }
                jQuery(window).load(function () {
                    P()
            ...
            return jQuery(this).each(function () {
                ...
                if ("browser_size" == j && (K.wrapInner('<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'), a.parent().find(".upb-background-text-wrapper").addClass("full-browser-size"), a.parent().find(".upb-background-text-wrapper").find(".upb-background-text").addClass(L)), "parallax_content_value" == u) {
                    ...
                    var M = K.css("padding-top"), N = K.css("padding-bottom");
                ...
                var O = function () {
                    ...
                    if (wh = jQuery(window).height(), c = a.parent().outerHeight(), b = d.outerWidth(), a.css({"min-width": b + "px"}), f = a.offset().left, a.css({left: -Math.abs(e - f) + "px"}), "browser_size" == j) {
            ...
            return jQuery(this).each(function () {
                ...
                if ("undefined" != typeof e && "true" === e.toString() && ("" != g && ("" != i && (i = "background-size:" + i + "px;"), "undefined" != typeof j && "" != j && (overlay_pattern_attachment_css = "background-attachment:" + j + ";"), overlay_pattern_html = '<div class="upb_bg_overlay_pattern" style="background-image:url(' + g + "); opacity:" + h + "; " + i + "; " + overlay_pattern_attachment_css + '"></div>'), "" != f && (overlay_color_html = '<div class="upb_bg_overlay" style="background-color:' + f + ';"></div>'), "" != s && (overlay_multi_color_html = '<div class="upb_bg_overlay ' + s + '" style="opacity:' + t + ';"></div>'), A = overlay_color_html + overlay_pattern_html + overlay_multi_color_html), "browser_size" == c && (y.wrapInner('<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'), y.find(".upb-background-text-wrapper").find(".upb-background-text").addClass(z), y.addClass("full-browser-size")), "parallax_content_value" == n) {
                    ...
                    var B = y.css("padding-top"), C = y.css("padding-bottom");
                ...
                var E = function () {
                    ...
                    if (wh = jQuery(window).height(), d = a.parent().outerHeight(), b = e.outerWidth(), a.css({"min-width": b + "px"}), g = a.offset().left, a.css({left: -Math.abs(f - g) + "px"}), "browser_size" == c) {
            ...
            return jQuery(this).each(function () {
                ...
                if ("" != p && (x.addClass("ult-vc-hide-row"), x.attr("data-hide-row", p)), x.attr("data-rtl", q), "parallax_content_value" == g) {
                    ...
                    var A = x.css("padding-top"), B = x.css("padding-bottom");
                ...
                x.prepend('<div class="upb_row_bg">' + z + "</div>"), d(a, x), a.remove(), a = x, a.attr("data-row-effect-mobile-disable", i), "fadeout_row_value" == e && (a.addClass("vc-row-fade"), a.attr("data-fadeout-percentage", f)), a.css("background-image", ""), a = a.find(".upb_row_bg"), a.css({background: c}), a.attr("data-bg-override", b), "browser_size" == b && a.parent().find(".upb-background-text-wrapper").addClass("full-browser-size");
                var C = function () {
                    var c, d, e, f, g;
                    if (e = a.parent(), "full" == b && (e = jQuery("body"), f = 0), "ex-full" == b && (e = jQuery("html"), f = 0), !isNaN(b)) {
                        for (var h = 0; b > h && "HTML" != e.prop("tagName"); h++)e = e.parent();
                        f = e.offset().left
                    }
                    if (wh = jQuery(window).height(), d = a.parent().outerHeight(), c = e.outerWidth(), a.css({"min-width": c + "px"}), g = a.offset().left, a.css({left: -Math.abs(f - g) + "px"}), "browser_size" == b) {
                        var i = a.parent().find(".upb-background-text").height();
                        i > wh && (wh = i), a.parent().css("height", wh + "px"), a.parent().find(".upb-background-text-wrapper").css("height", wh + "px")
                    }
                };
            ...
            function b() {
                ...
                e.each(function () {
                    if ("upb_fade_animation" == jQuery(this).data("upb_br_animation")) {
                        ...
                        var e = jQuery(this), h = e.offset().top, i = d(e);
                        ...
                        if (g > h + i - c) {
                            ...
                            if ("parent" == a) {
                                ...
                                l += k / 2.3, jQuery(this).parents(".wpb_row").css({opacity: l})
                            }
                            if ("self" == a) {
                                var l = parseInt(jQuery(this).css("opacity"));
            ...
            var c = jQuery(window).height(), d = function (a) {
                return a.height()
            }, e = jQuery(this), f = jQuery(window).scrollTop();
        ...
        jQuery(".upb_content_video, .upb_content_iframe").prev().is("p") ? jQuery(".upb_content_video, .upb_content_iframe").prev().prev().css("background-image", "").css("background-repeat", "") : jQuery(".upb_content_video, .upb_content_iframe").prev().css("background-image", "").css("background-repeat", ""), jQuery(".upb_content_video").ultimate_video_bg(), jQuery(".upb_bg_img").ultimate_bg_shift(), jQuery(".upb_content_iframe").ultimate_video_bg(), jQuery(".upb_grad").ultimate_grad_shift(), jQuery(".upb_color").ultimate_bg_color_shift(), jQuery(".upb_no_bg").each(function (a, b) {
            var c = jQuery(b).attr("data-fadeout"), d = jQuery(b).data("fadeout-percentage"), e = jQuery(b).data("parallax-content"), f = jQuery(b).data("parallax-content-sense"), g = jQuery(b).data("row-effect-mobile-disable"), h = jQuery(b).data("custom-vc-row"), i = jQuery(b).data("vc"), j = jQuery(b).data("theme-support");
            if ("undefined" != typeof h && "" !== h || (h = "wpb_row"), "undefined" == typeof i && (i = 0), "undefined" == typeof j && (j = "disable"), i = parseFloat(i), 4.4 > i || "enable" == j)if (jQuery(b).prev().is("p") || jQuery(b).prev().is("style"))var k = jQuery(b).prev().prev(); else var k = jQuery(b).prev(); else var k = jQuery(b).prevAll("." + h + ":first");
            ...
            if (k.attr("row-effect-mobile-disable", g), "fadeout_row_value" == c && (k.addClass("vc-row-fade"), k.data("fadeout-percentage", d)), "parallax_content_value" == e) {
                ...
                var l = k.css("padding-top"), m = k.css("padding-bottom");
                k.find(".vc-row-translate-wrapper").css({
                    "padding-top": l,
                    "padding-bottom": m
                }), k[0].style.setProperty("padding-top", "0px", "important"), k[0].style.setProperty("padding-bottom", "0px", "important")
        ...
        var h = function () {
            jQuery(".upb_row_bg").each(function () {
                ...
                if (b = "undefined" != typeof d && "enable" !== d ? jQuery(this).parents("." + e + ":first") : jQuery(this).parent(), b.addClass("vc_row-has-fill"), "browser_size" == c && (a = jQuery("html")), "ex-full" == c)a = jQuery("html"); else if ("full" == c)a = jQuery("body"); else if (!isNaN(c)) {
                    a = b;
                    for (var f = 0; c > f && !a.is("html"); f++)a = a.parent()
                }
                var g = parseInt(a.css("paddingLeft")), h = parseInt(a.css("paddingRight")), i = g + h + a.width(), j = -(b.offset().left - a.offset().left);
                if (j > 0 && (left = 0), jQuery(this).css({width: i, left: j}), "browser_size" == c) {
                    var k = (a.width(), a.height(), b.width(), b.height()), l = b.find(".upb-background-text").height(), m = jQuery(window).height();
                    if (l > k)var n = l; else var n = m;
                    b.css("min-height", n + "px"), b.find(".upb-background-text-wrapper").css("min-height", n + "px")
                }
            }), jQuery(".upb_video-bg").each(function (a, b) {
                var c, d, e = jQuery(this).data("bg-override"), f = jQuery(this).attr("data-rtl"), h = jQuery(this).data("theme-support"), i = jQuery(this).data("row");
                if (d = "undefined" != typeof h && "enable" !== h ? jQuery(this).parents("." + i + ":first") : jQuery(this).parent(), "browser_size" == e)c = jQuery("html"), jQuery(this).parents(".upb_video_class").css("overflow", "visible"); else if ("ex-full" == e)c = jQuery("html"), jQuery(this).parents(".upb_video_class").css("overflow", "visible"); else if ("full" == e)c = jQuery("body"), jQuery(this).parents(".upb_video_class").css("overflow", "visible"); else if (isNaN(e) || 0 == e)c = d; else {
                    c = d;
                    for (var j = 1; e >= j && !c.is("html"); j++)c = c.parent()
                }
                var k = (parseInt(c.css("paddingLeft")), parseInt(c.css("paddingRight")), parseInt(c.css("marginLeft")), c.outerWidth()), l = k, m = jQuery(this).offset().left, n = jQuery(this).position().left, o = c.offset().left, p = o - m;
                0 > n && (p = n + p), 0 == a && (g = n), g > 0 && (p = g), "full" != e && "ex-full" != e && "browser_size" != e || p > 0 && (p = 0), "undefined" == typeof f || f !== !0 && "true" !== f ? jQuery(this).css({
                    width: k,
                    "min-width": k,
                    left: p
                }) : jQuery(this).css({width: k, "min-width": k, right: p});
                var q = 16 / 9, r = (jQuery(window).width(), jQuery(window).height());
                d.find("video").height();
                if ("browser_size" == e)var s = d.find(".upb_video-text").height(); else var s = d.height();
                if (960 > k) {
                    var t = 16 / 9 * s;
                    k = t + k
                }
                ...
                if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))"undefined" != typeof u && "none" != u || (children.css({
                    "max-height": "auto",
                    height: "auto"
                }), d.css("min-height", "auto")); else if ("browser_size" == e) {
                    if (s > r)var v = s; else var v = r;
        ...
        h(), jQuery(window).load(function () {
            ...
            var b = jQuery(this).attr("data-action"), c = jQuery(this).parent().find(".upb_video-src");
            ...
            if (d = "undefined" == typeof d ? "false" : d.toString(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))var e = "true"; else var e = "false";
            if ("true" == e && "true" == d)var f = "true"; else var f = "false";
            if ("false" == f) {
                var g = 10;
                "" != jQuery(this).attr("data-parallax_sense") && (g = jQuery(this).attr("data-parallax_sense")), g = 100 - g;
                var h = jQuery(this).attr("data-bg-animation-type"), i = jQuery(this).attr("data-bg-animation"), j = 0, k = h;
    ...
    function d() {
        a(".ult-content-box").each(function (c, d) {
            var f = a(d).css("background-color") || "", i = a(d).data("border_color") || "transparent", j = a(d).css("box-shadow") || "", k = a(d).data("hover_bg_color") || a(d).css("background-color"), l = a(d).data("hover_border_color") || "transparent", m = a(d).data("hover_box_shadow") || a(d).css("box-shadow");
            a(d).hover(function () {
            ...
            var n = {}, o = a(d).data("responsive_margins");
            "undefined" != typeof o && null != o && (n = g(o));
            var p = {}, q = a(d).data("normal_margins");
    ...
    var a = function () {
        ...
        jQuery(".ult-responsive").each(function (g, h) {
            var i = jQuery(h), j = i.attr("data-responsive-json-new"), k = i.data("ultimate-target"), l = "", m = "", n = "", o = "", p = "", q = "";
    ...
    a(), jQuery(".ult_countdown-dateAndTime").each(function () {
        var a = new Date(jQuery(this).html()), b = (60 * jQuery(this).data("time-zone"), jQuery(this).data("countformat")), c = jQuery(this).data("labels"), d = c.split(","), e = jQuery(this).data("labels2"), f = e.split(","), g = function () {
            return new Date(jQuery(this).data("time-now"))
        }, h = function (a) {
            var b = jQuery(".ult_countdown-dateAndTime").attr("data-responsive-json-new"), c = jQuery(".ult_countdown-dateAndTime").attr("data-ultimate-target"), d = jQuery(".ult_countdown").attr("data-responsive-json-new"), e = jQuery(".ult_countdown").attr("data-ultimate-target");
            ...
            }), jQuery(this).find(".ult_countdown-amount").css({color: jQuery(this).data("tick-col")}), jQuery(this).find(".ult_countdown-amount").addClass("ult-responsive"), jQuery(this).find(".ult_countdown-period").css({
    ...
    var b = "ult_countdown", c = 0, d = 1, e = 2, f = 3, g = 4, h = 5, i = 6;
    a.JQPlugin.createPlugin({
        ...
        _resetExtraLabels: function (a, b) {
            var c = !1;
            for (var d in b)if ("whichLabels" != d && d.match(/[Ll]abels/)) {
                c = !0;
                break
            }
            if (c)for (var d in a)d.match(/[Ll]abels[02-9]|compactLabels1/) && (a[d] = null)
        },
    ...
    jQuery(".ult_colorlink").hover(function () {
        ...
        if ("Style_10" == a) {
            var c = jQuery(this).find(".ult_btn10_span").data("bhover"), d = jQuery(this).find(".ult_btn10_span").data("bstyle");
            " " != d && (jQuery(this).find(".ult_btn10_span").css("border-top-style", "solid"), jQuery(this).find(".ult_btn10_span").css("border-top-color", c))
        }
        var e = jQuery(this).data("texthover"), f = jQuery(this).data("bghover");
        ...
        if ("Style_6" == a && jQuery(this).find(".ult_btn6_link_top").removeAttr("style"), "Style_10" == a) {
            var b = jQuery(this).find(".ult_btn10_span").data("color"), c = jQuery(this).find(".ult_btn10_span").data("bstyle");
            " " != c && (jQuery(this).find(".ult_btn10_span").css("border-top-style", c), jQuery(this).find(".ult_btn10_span").css("border-top-color", b))
        }
        var d = jQuery(this).data("textcolor"), e = jQuery(this).data("bgcolor");
    ...
    function b(a, b, c) {
        if ("img" === c) {
            var d = parseInt(b.outerHeight()), e = d / 2;
    ...
    function c(b) {
        b.find(".timeline-icon-block").length > 0 && a(".timeline-block").each(function (b, c) {
            var d = a(this).find(".timeline-header-block"), e = a(this).find(".timeline-icon-block");
            e.css({position: "absolute"});
            var f = e.outerHeight(), g = e.outerWidth(), h = -(g / 2), i = parseInt(d.find(".timeline-header").css("padding-left").replace(/[^\d.]/g, ""));
            a(this).hasClass("timeline-post-left") ? (e.css({
                left: h,
                right: "auto"
            }), d.css({"padding-left": g / 2 + i + "px"})) : a(this).hasClass("timeline-post-right") && (e.css({
                left: "auto",
                right: h
            }), d.css({"padding-right": g / 2 + i + "px"}));
            var j = d.height(), k = j / 2, l = f / 2, m = k - l;
            e.css({top: m});
            var n = e.offset().left, o = a(window).width();
            (0 > n || n + g > o) && (e.css({
                position: "relative",
                top: "auto",
                left: "auto",
                right: "auto",
                "text-align": "center"
            }), e.children().children().css({margin: "10px auto"}), d.css({padding: "0"}))
        })
    }
    ...
    function d() {
        jQuery(".ult-animation").each(function () {
            if (jQuery(this).attr("data-animate")) {
                var a = jQuery(this).children("*"), b = jQuery(this).attr("data-animate"), c = jQuery(this).attr("data-animation-duration") + "s", d = jQuery(this).attr("data-animation-iteration"), f = jQuery(this).attr("data-animation-delay"), g = (jQuery(this).attr("data-opacity_start_effect"), "opacity:1;-webkit-animation-delay:" + f + "s;-webkit-animation-duration:" + c + ";-webkit-animation-iteration-count:" + d + "; -moz-animation-delay:" + f + "s;-moz-animation-duration:" + c + ";-moz-animation-iteration-count:" + d + "; animation-delay:" + f + "s;animation-duration:" + c + ";animation-iteration-count:" + d + ";"), h = "opacity:1;-webkit-transition-delay: " + f + "s; -moz-transition-delay: " + f + "s; transition-delay: " + f + "s;";
                if (e(jQuery(this))) {
    ...
    function e(a) {
        var b = jQuery(window).scrollTop(), c = jQuery(window).height();
        if (jQuery(a).hasClass("ult-animate-viewport"))var d = jQuery(a).data("opacity_start_effect");
        if ("undefined" == typeof d || "" == d)var e = 2; else var e = 100 - d;
        var f = (jQuery(a).outerHeight(), jQuery(a).offset().top), g = f - b, h = c - c * (e / 100);
        return h >= g
    }
    ...
    function f() {
        ...
        a.each(function (a, b) {
            ...
            if (c.hasClass("ult-ib-resp")) {
                var d = jQuery(document).width(), e = c.data("min-width"), f = c.data("max-width");
    ...
    function g() {
        ...
        a(".ult-spacer").each(function (c, d) {
            var e = a(d).data("id"), f = (a("body").width(), a(d).data("height-mobile")), g = a(d).data("height-mobile-landscape"), h = a(d).data("height-tab"), i = a(d).data("height-tab-portrait"), j = a(d).data("height");
    ...
    a.fn.vc_translate_row = function () {
        var b = a(window).scrollTop(), c = a(window).height();
        a(this).each(function (d, e) {
            var f = a(e).attr("data-row-effect-mobile-disable");
            if (f = "undefined" == typeof f ? "false" : f.toString(), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))var g = "true"; else var g = "false";
            if ("true" == g && "true" == f)var h = "true"; else var h = "false";
            if ("false" == h) {
                var i = 0, j = a(e).outerHeight(), k = a(e).offset().top, l = k - b, m = l + j, n = a(e).attr("data-parallax-content-sense"), o = n / 100, p = 0, q = c - c * (i / 100);
                if (q >= m && 0 >= l) {
                    if (j > c)var p = (c - m) * o; else var p = -(l * o);
                    0 > p && (p = 0)
                } else p = 0;
        ...
        a(this).each(function (d, e) {
            ...
            if ("true" == g && "true" == f)var h = "true"; else var h = "false";
            if ("false" == h) {
                var i = 0, j = a(e).data("fadeout-percentage");
                j = 100 - j;
                var k = a(e).outerHeight(), l = a(e).offset().top, m = l - b, n = m + k, o = 1, p = c - c * (j / 100), q = (p - n) / p * (1 - i);
        ...
        jQuery(".ult-banner-block-custom-height").each(function (a, b) {
            var c = jQuery(this).find("img"), d = jQuery(this).width(), e = jQuery(this).height();
            c.width();
        ...
        var b = 0, d = 0, e = function () {
            jQuery(".ifb-jq-height").each(function () {
                ...
                var a = parseInt(jQuery(this).find(".ifb-front > div").outerHeight(!0)), b = parseInt(jQuery(this).find(".ifb-back > div").outerHeight(!0)), c = a > b ? a : b;
                ...
                if (jQuery(this).hasClass("horizontal_door_flip") || jQuery(this).hasClass("vertical_door_flip")) {
                    var a = parseInt(jQuery(this).find(".ifb-front > div").outerHeight()), b = parseInt(jQuery(this).find(".ifb-back > div").outerHeight()), c = a > b ? a : b;
        ...
        jQuery(window).resize(function () {
            f(), jQuery(".csstime.smile-icon-timeline-wrap").each(function () {
                ...
                c(jQuery(this))
            }), "none" == jQuery(".smile-icon-timeline-wrap.jstime .timeline-line").css("display") ? 0 === g && (a(".jstime .timeline-wrapper").masonry("destroy"), g = 1) : 1 == g && (jQuery(".jstime .timeline-wrapper").masonry({itemSelector: ".timeline-block"}), setTimeout(function () {
            ...
            var d = parseInt(jQuery(this).width()), e = parseInt(jQuery(this).find(".timeline-block").width()), f = d - 2 * e - 40;
            ...
            var g = jQuery(this).data("time_sep_color"), h = jQuery(this).data("time_sep_bg_color"), i = jQuery(".smile-icon-timeline-wrap .timeline-line").css("border-right-color");
        ...
        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && e >= 1 ? jQuery(".ult-animation").css("opacity", 1) : d(), f(), jQuery(".ubtn").hover(function () {
                ...
                var b = "" != a.data("hover-bg") ? a.data("hover-bg") : !1;
                setTimeout(function () {
                ...
                var b = a.data("border-color"), c = a.attr("style");
                "" != a.data("shadow-hover") && (c += "box-shadow:" + a.data("shadow")), a.attr("style", c), "" != a.data("border-hover") && a.css("border-color", b), "none" != a.data("shadow-click") && (a.removeClass("no-ubtn-shadow"), "" != a.is(".shd-left") ? a.css({right: "auto"}) : "" != a.is(".shd-right") ? a.css({left: "auto"}) : "" != a.is(".shd-top") ? a.css({bottom: "auto"}) : "" != a.is(".shd-bottom") && a.css({top: "auto"}))
            }), jQuery(".ubtn").on("focus blur mousedown mouseup", function (a) {
                var b = jQuery(this);
                "none" != b.data("shadow-click") && setTimeout(function () {
                    b.is(":focus") ? (b.addClass("no-ubtn-shadow"), "" != b.is(".shd-left") ? b.css({right: b.data("shd-shadow") + "px"}) : "" != b.is(".shd-right") ? b.css({left: b.data("shd-shadow") + "px"}) : "" != b.is(".shd-top") ? b.css({bottom: b.data("shd-shadow") + "px"}) : "" != b.is(".shd-bottom") && b.css({top: b.data("shd-shadow") + "px"})) : (b.removeClass("no-ubtn-shadow"), "" != b.is(".shd-left") ? b.css({right: "auto"}) : "" != b.is(".shd-right") ? b.css({left: "auto"}) : "" != b.is(".shd-top") ? b.css({bottom: "auto"}) : "" != b.is(".shd-bottom") && b.css({top: "auto"}))
                }, 0)
            }), jQuery(".ubtn").focusout(function () {
                var a = jQuery(this);
                a.removeClass("no-ubtn-shadow"), "" != a.is(".shd-left") ? a.css({right: "auto"}) : "" != a.is(".shd-right") ? a.css({left: "auto"}) : "" != a.is(".shd-top") ? a.css({bottom: "auto"}) : "" != a.is(".shd-bottom") && a.css({top: "auto"})
                ...
                if (jQuery(this).attr("data-animation")) {
                    var b = jQuery(this).attr("data-animation"), c = "delay-" + jQuery(this).attr("data-animation-delay");
                ...
                a(this).bsf_appear(function () {
                    var a = parseFloat(jQuery(this).find(".stats-number").data("counter-value")), b = jQuery(this).find(".stats-number").data("counter-value") + " ", c = parseInt(jQuery(this).find(".stats-number").data("speed")), d = jQuery(this).find(".stats-number").data("id"), e = jQuery(this).find(".stats-number").data("separator"), f = jQuery(this).find(".stats-number").data("decimal"), g = b.split(".");
            ...
            }), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))var g = !0; else var g = !1;
        jQuery("#page").click(function () {
            ...
            a.stopPropagation(), jQuery(document).trigger("ultFlipBoxClicked", jQuery(this)), jQuery(this).hasClass("ifb-hover") ? jQuery(this).removeClass("ifb-hover") : (jQuery(".ifb-hover").removeClass("ifb-hover"), jQuery(this).addClass("ifb-hover"))
    ...
    function a() {
        jQuery(".ult-new-ib").each(function (a, b) {
            ...
            if ("" != c) {
                ...
                var d = (jQuery(this).find(".ult-new-ib-img").width(), jQuery(this).find(".ult-new-ib-img").height()), e = jQuery(this).width();
    ...
    function a() {
        jQuery(".ultimate-map-wrapper").each(function (a, b) {
            ...
            var d = jQuery(b).find(".ultimate_google_map").attr("id"), e = jQuery("#" + d).attr("data-map_override"), f = "true";
            jQuery("#" + d).css({"margin-left": 0});
            var g = jQuery("#" + c).parent();
            if ("full" == e && (g = jQuery("body"), f = "false"), "ex-full" == e && (g = jQuery("html"), f = "false"), !isNaN(e))for (var a = 0; e > a && "HTML" != g.prop("tagName"); a++)g = g.parent();
            if (0 == e || "0" == e)var h = g.width(); else var h = g.outerWidth();
            var i = g.offset().left, j = jQuery("#" + d).offset().left, k = i - j;
            jQuery("#" + d).css({width: h}), 0 == e && "0" == e || jQuery("#" + d).css({"margin-left": k})
        })
    }
    ...
    a(document).ready(function () {
        ...
        if (b > 300 && 768 > b); else if (b > 768 && 1015 > b); else;
        a(document).on("mouseenter", ".ult_dual1", function () {
            var b = a(this).find(".ult-dual-btn-1").attr("class"), c = b.split(" "), b = c[1] + c[2];
            if ("Style1" == b) {
            ...
            if ("undefined" != b) {
                ...
                a(this).find(".ult-dual-btn-1").find(".aio-icon").css({background: f});
                var g = a(this).find(".ult-dual-btn-1").data("iconhoverborder");
                a(this).find(".ult-dual-btn-1").find(".aio-icon").css({"border-color": g}), a(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({background: f}), a(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({"border-color": g});
                var h = a(this).find(".ult-dual-btn-1").data("texthovercolor");
                a(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({color: h})
            }
            ...
            if ("undefined" != b) {
                ...
                a(this).find(".ult-dual-btn-1").find(".ult-dual-button-title").css({color: f});
                var g = a(this).find(".ult-dual-btn-1").data("iconbgcolor");
                a(this).find(".ult-dual-btn-1").find(".aio-icon").css({background: g});
                var h = a(this).find(".ult-dual-btn-1").data("iconborder");
                a(this).find(".ult-dual-btn-1").find(".aio-icon").css({"border-color": h}), a(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({background: g}), a(this).find(".ult-dual-btn-1").find(".aio-icon-img").css({"border-color": h})
            }
        }), a(document).on("mouseenter", ".ult_dual2", function () {
            var b = a(this).find(".ult-dual-btn-2").attr("class"), c = b.split(" "), b = c[1] + c[2];
            if ("Style1" == b) {
            ...
            if ("undefined" != b) {
                ...
                a(this).find(".ult-dual-btn-2").find(".ult-dual-button-title").css({color: f});
                var g = a(this).find(".ult-dual-btn-2").data("iconbghovercolor");
                a(this).find(".ult-dual-btn-2").find(".aio-icon").css({background: g});
                var h = a(this).find(".ult-dual-btn-2").data("iconhoverborder");
                a(this).find(".ult-dual-btn-2").find(".aio-icon").css({"border-color": h}), a(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({background: g}), a(this).find(".ult-dual-btn-2").find(".aio-icon-img").css({"border-color": h})
            }
    ...
    jQuery(".ult_main_dualbtn").each(function (a) {
        ...
        c = parseInt(c), b > c ? (jQuery(this).find(".ult_dual2").css({height: b}), jQuery(this).find(".ult_dual1").css({height: b})) : c > b ? (jQuery(this).find(".ult_dual1").css({height: c}), jQuery(this).find(".ult_dual2").css({height: c})) : b == c && (jQuery(this).find(".ult_dual1").css({height: c}), jQuery(this).find(".ult_dual2").css({height: c}))
    })
}), jQuery(document).ready(function (a) {
    ...
    function a() {
        jQuery(".ult_exp_section_layer").each(function (a, b) {
            ...
            if (0 != c) {
                var d = "true";
                if (jQuery(b).parents(".wpb_row").length > 0)var e = jQuery(b).parents(".wpb_column"); else if (jQuery(b).parents(".wpb_column").length > 0)var e = jQuery(b).parents(".wpb_row"); else var e = jQuery(b).parent();
                if ("full" == c && (e = jQuery("body"), d = "false"), "ex-full" == c && (e = jQuery("html"), d = "false"), !isNaN(c))for (var a = 1; c > a && "HTML" != e.prop("tagName"); a++)e = e.parent();
                if ("false" == d)var f = e.outerWidth(); else var f = e.width();
                var g = e.offset().left, h = jQuery(b).offset().left, i = g - h;
                "false" == d ? jQuery(b).css({width: f, "margin-left": i}) : jQuery(b).css({width: f})
            }
        })
    }

    jQuery(".ult_exp_section").hover(function () {
        var a = jQuery(this).data("texthover"), b = jQuery(this).data("ihover"), c = (jQuery(this).data("cnthvrbg"), jQuery(this).data("headerhover")), d = jQuery(this).data("icnhvrbg"), e = jQuery(this).data("icnhvrborder");
        jQuery(this).hasClass("ult_active_section") || (jQuery(this).css({
            color: a,
            background: c
        }), jQuery(this).find(".ult_expsection_icon").css({color: b}), jQuery(this).find(".ult_expsection_icon").css({background: d}), jQuery(this).find(".ult_expsection_icon").css({"border-color": e}))
    }, function () {
        var a = jQuery(this).data("textcolor"), b = jQuery(this).data("icncolor"), c = (jQuery(this).data("cntbg"), jQuery(this).data("headerbg")), d = jQuery(this).data("icnbg"), e = jQuery(this).data("icnborder");
        jQuery(this).hasClass("ult_active_section") || (jQuery(this).css({
            color: a,
            background: c
        }), jQuery(this).find(".ult_expsection_icon").css({color: b}), jQuery(this).find(".ult_expsection_icon").css({background: d}), jQuery(this).find(".ult_expsection_icon").css({"border-color": e}))
    ...
    jQuery(".ult_exp_section").select(function () {
        ...
        if (0 != a) {
            var b = jQuery(this).offset().top, c = parseInt(b) - a;
...
var fixto = function (a, b, c) {
    ...
    d.prototype = {
        _vendors: {
            ...
            var b;
            for (var c in this._vendors)if (b = this._prefixJsProperty(this._vendors[c], a), this.propertySupported(b))return this._vendor = this._vendors[c], b;
            return null
            ...
            for (var g in this._vendors)if (f = this._prefixValue(this._vendors[g], b), this._valueSupported(e, f, d))return this._vendor = this._vendors[g], f;
            return null
        }
    };
    ...
    q && (l = parseFloat(navigator.appVersion.split("MSIE")[1])), f.prototype = {
        _mindtop: function () {
            var a = 0;
            if (this._$mind)for (var b, c, d = 0, e = this._$mind.length; e > d; d++)if (b = this._$mind[d], c = b.getBoundingClientRect(), c.height)a += c.height; else {
                var f = i.getAll(b);
        ...
        _bind: function (a, b) {
        ...
        }, _toresize: 8 === l ? c.documentElement : b, _onscroll: function () {
            ...
            this._replacer.replace(), b.left = e - i.toFloat(d.marginLeft) + "px", b.width = f, b.position = "fixed", b.top = this._mindtop() + this.options.top - i.toFloat(d.marginTop) + "px", console.log("childStyle.top: " + b.top), this._$child.addClass(this.options.className), this.fixed = !0
        }, _unfix: function () {
    ...
    }, {FixToContainer: g, fixTo: r, computedStyle: i, mimicNode: j}
...
!function (a, b, c) {
        ...
        a(".flip-box").each(function (c, d) {
            ...
            if ("" != e)if (e >= 768) {
                ...
                if (a(this).hasClass("style_9")) {
                    ...
                    var m = a(this).find(".ifb-front-1 .ifb-front").outerHeight(), n = a(this).find(".ifb-back-1 .ifb-back").outerHeight();
    ...
    function b() {
        ...
        $jh(".uvc-heading").each(function () {
            ...
            if ("line_with_icon" == i) {
                ...
                var q = $jh(this).attr("data-hborder_style"), r = $jh(this).attr("data-hborder_color"), s = $jh(this).attr("data-hborder_height");
    ...
    function b() {
        a(".ultimate-call-to-action").each(function (b, c) {
            ...
            if (0 != d) {
                ...
                var e = "true";
                if (a(c).parents(".wpb_row").length > 0)var f = a(c).parents(".wpb_row"); else if (a(c).parents(".wpb_column").length > 0)var f = a(c).parents(".wpb_column"); else var f = a(c).parent();
                if ("full" == d && (f = a("body"), e = "false"), "ex-full" == d && (f = a("html"), e = "false"), !isNaN(d))for (var b = 1; d >= b && "HTML" != f.prop("tagName"); b++)f = f.parent();
                var g = f.outerWidth(), h = a(c).offset().left, i = (a(c).position().left, f.offset().left), j = f.position().left, k = i - h;
                "full" != d && "ex-full" != d && (k = i - j), a(c).css({width: g, "margin-left": k})
            }
        })
    }
    ...
    d.prototype = {
        _init: function () {
            ...
            d.options.functionBefore.call(d.$el, d.$el, function () {
                if (d.enabled && null !== d.Content) {
                    c && d.callbacks.show.push(c), d.callbacks.hide = [], clearTimeout(d.timerShow), d.timerShow = null, clearTimeout(d.timerHide), d.timerHide = null, d.options.onlyOne && a(".ult-tooltipstered").not(d.$el).each(function (b, c) {
                        var d = a(c), e = d.data("ult-tooltipster-ns");
                    ...
                    if ("hidden" !== d.Status) {
                        ...
                        d.Status = "appearing";
                        var f = d.options.speed, h = BaseStyle = "";
                        ...
                        var i = "ult-tooltipster-" + d.options.animation, k = "-webkit-transition-duration: " + d.options.speed + "ms; -webkit-animation-duration: " + d.options.speed + "ms; -moz-transition-duration: " + d.options.speed + "ms; -moz-animation-duration: " + d.options.speed + "ms; -o-transition-duration: " + d.options.speed + "ms; -o-animation-duration: " + d.options.speed + "ms; -ms-transition-duration: " + d.options.speed + "ms; -ms-animation-duration: " + d.options.speed + "ms; transition-duration: " + d.options.speed + "ms; animation-duration: " + d.options.speed + "ms;", l = d.options.minWidth ? "min-width:" + Math.round(d.options.minWidth) + "px;" : "", m = d.options.maxWidth ? "max-width:" + Math.round(d.options.maxWidth) + "px;" : "", n = d.options.interactive ? "pointer-events: auto;" : "";
            ...
            var a = this, b = this.$tooltip.find(".ult-tooltipster-content");
            ...
            if (0 !== a("body").find(e.$tooltip).length) {
                ...
                if (e.options.arrow) {
                    ...
                    if (f ? "left" == f ? (M = "ult-tooltipster-arrow-right", f = "") : "right" == f ? (M = "ult-tooltipster-arrow-left", f = "") : f = "left:" + Math.round(f) + "px;" : f = "", "top" == H || "top-left" == H || "top-right" == H)var O = parseFloat(e.$tooltip.css("border-bottom-width")), P = e.$tooltip.css("border-bottom-color"); else if ("bottom" == H || "bottom-left" == H || "bottom-right" == H)var O = parseFloat(e.$tooltip.css("border-top-width")), P = e.$tooltip.css("border-top-color"); else if ("left" == H)var O = parseFloat(e.$tooltip.css("border-right-width")), P = e.$tooltip.css("border-right-color"); else if ("right" == H)var O = parseFloat(e.$tooltip.css("border-left-width")), P = e.$tooltip.css("border-left-color"); else var O = parseFloat(e.$tooltip.css("border-bottom-width")), P = e.$tooltip.css("border-bottom-color");
                    O > 1 && O++;
                    var Q = "";
                    if (0 !== O) {
                        var R = "", S = "border-color: " + P + ";";
                        -1 !== M.indexOf("bottom") ? R = "margin-top: -" + Math.round(O) + "px;" : -1 !== M.indexOf("top") ? R = "margin-bottom: -" + Math.round(O) + "px;" : -1 !== M.indexOf("left") ? R = "margin-right: -" + Math.round(O) + "px;" : -1 !== M.indexOf("right") && (R = "margin-left: -" + Math.round(O) + "px;"), Q = '<span class="ult-tooltipster-arrow-border" style="' + R + " " + S + ';"></span>'
                    }
        ...
        if ("string" == typeof b[0]) {
            var e = "#*$~&";
            return this.each(function () {
                var c = a(this).data("ult-tooltipster-ns"), d = c ? a(this).data(c[0]) : null;
        ...
        return this.each(function () {
            var c = !1, e = a(this).data("ult-tooltipster-ns"), g = null;
        ...
        function d() {
            ...
            a('a[href="#"]').click(function (a) {
                ...
                c(".ult-hotspot-tooltip[data-link_style='tootip']", c(this)).each(function () {
                    if (a(this).find(".aio-icon-img").length > 0)var e = a(this).find(".aio-icon-img").outerHeight(!0), f = a(this).find(".aio-icon-img").outerWidth(!0); else var e = jQuery(this).find(".aio-icon").outerHeight(!0), f = jQuery(this).find(".aio-icon").outerWidth(!0);
                    var g = Math.round(e / 2), h = Math.round(f / 2), i = c(this).data("tooltipanimation"), j = c(this).data("trigger") || "hover", k = c(this).data("arrowposition") || "top", l = c(this).data("bubble-arrow"), m = c(this).data("tooltip-content-style"), n = c(this).data("tooltip-base-style"), o = c(this).find(".hotspot-tooltip-content").html();
    ...
    function d(b, c, d, e, f, g) {
        "" != c && (c >= 768 ? a(b).find(".ult-ih-item, .ult-ih-img, .ult-ih-image-block, .ult-ih-list-item").css({
            height: d,
            width: e
        }) : a(b).find(".ult-ih-item, .ult-ih-img, .ult-ih-image-block, .ult-ih-list-item").css({height: f, width: g}))
    }

    function e() {
        a(".ult-ih-list").each(function (c, e) {
            var f = a(e).attr("data-shape"), g = a(e).attr("data-height"), h = a(e).attr("data-width"), i = a(e).attr("data-res_height"), j = a(e).attr("data-res_width"), k = jQuery(b).width() || "";
    ...
    a(document).ready(function () {
        a(".ult-easy-separator-wrapper").each(function (b, c) {
            var d = a(this).attr("data-vc-row"), e = a(this).parents("." + d + ":first");
    ...
    function b() {
        a(".ultb3-box").each(function (b, c) {
            var d = a(c).outerHeight(), e = a(c).find(".ultb3-info").outerHeight(), f = (d - e) / 2;
    ...
    a(document).ready(function () {
        b(), a(window).resize(function () {
            ...
            if (jQuery(this).attr("data-animation")) {
                ...
                var a = jQuery(this).attr("data-animation"), b = "delay-" + jQuery(this).attr("data-animation-delay");
                jQuery(this).bsf_appear(function () {
                    var c = jQuery(this);
...
jQuery(document).ready(function () {
    make_info_circle(".info-c-full-br", 0), responsive_check(".info-c-full-br"), calculate_clipped_circle(), jQuery(".clipped-info-circle").each(function (a, b) {
        var c = jQuery(this).outerHeight(), d = jQuery(this).outerWidth();
    ...
    jQuery(".icon_list_item").each(function (a, b) {
        var c = jQuery(this), d = c.find(".info-circle-img-icon").length;
            ...
            if (!c.data("sticky_kit")) {
                ...
                if (u = !1, s = !1, C = null != k ? k && c.closest(k) : a("<div />"), C && C.css("position", c.css("position")), z = function () {
                    ...
                    if (!r)return t = !1, null != B && (B -= 1, 0 >= B && (B = n, z(), t = !0)), t || d.height() === w || (z(), t = !0), A = b.scrollTop(), null != v && (m = A - v), v = A, u ? (f && (D = A + p + x > h + g, s && !D && (s = !1, c.css({
                        ...
                        width: "",
                        top: ""
                    }, c.css(a).removeClass(o).trigger("sticky_kit:unstick")), i && (E = b.height(), p + l > E && (s || (x -= m, x = Math.max(E - p, x), x = Math.min(l, x), u && c.css({top: x + "px"}))))) : A > j && (u = !0, a = {
                        position: "fixed",
                        top: x
                    }, a.width = "border-box" === c.css("box-sizing") ? c.outerWidth() + "px" : c.width() + "px", c.css(a).addClass(o), null == k && (c.after(C), "left" !== q && "right" !== q || C.append(c)), c.trigger("sticky_kit:stick")), u && f && (null == D && (D = A + p + x > h + g), !s && D) ? (s = !0, "static" === y.css("position") && y.css({position: "relative"}), c.css({
                        position: "absolute",
                        bottom: e,
                        top: "auto"
    ...
    var b = function (a, b) {
        ...
        var e = Math.round(256 * c) * (d ? -1 : 1), f = a.match(new RegExp("^rgba?\\(\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])\\s*,\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])\\s*,\\s*(\\d|[1-9]\\d|1\\d{2}|2[0-4][0-9]|25[0-5])(?:\\s*,\\s*(0|1|0?\\.\\d+))?\\s*\\)$", "i")), g = f && null != f[4] ? f[4] : null, h = f ? [f[1], f[2], f[3]] : a.replace(/^#?([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])([a-f0-9][a-f0-9])/i, function () {
    ...
    count = 0, f.each(function () {
        function b(a) {
            var b = ".ult-slider-ticks" + a, c = w.find(b);
            c.prevAll(".ui-slider-label-ticks").css("background", n), c.nextAll(".ui-slider-label-ticks").css("background", k)
        }

        count += 1;
        var c = 0, f = 0, g = 0, h = a(this).find(".ult-rslider-container"), i = 0, j = h.data("slider_steps"), k = h.data("slider_color");
        k = k ? k : "#3BF7D1";
        var l = k, m = (d(l, .2), e(l, .2)), n = m, o = m, p = h.data("title-background"), q = h.data("title-box"), r = (h.data("slider_size"), h.data("adaptive_height")), s = h.data("arrow"), t = "border-top-color:" + p + ";";
        if (s) {
        ...
        var w = h, x = a(this), y = h.find(".ult-rslider"), z = function (c, d) {
            var e = h.find(".ui-slider-handle"), f = d.value || 1, g = ".ult-title" + f, j = ".ult-desc" + f;
        ...
        if (y.slider({range: "min", min: 1, max: j, step: 1, create: z, slide: z}), y.labeledslider({
                max: j - 1,
                tickInterval: 1
            }), "auto" == q) {
            h.find(".ult-tooltip").each(function () {
                var b = a(this).outerWidth(), d = a(this).outerHeight();
    ...
    a(document).ready(function () {
        a(".ult-carousel-wrapper").each(function () {
            ...
            if (b.hasClass("ult_full_width")) {
                ...
                var c = b.attr("data-rtl"), d = a("html").outerWidth(), e = 0, f = b.offset().left, g = Math.abs(e - f), h = g;
                "true" === c || c === !0 ? b.css({
                    position: "relative",
                    right: "-" + h + "px",
                    width: d + "px"
                }) : b.css({position: "relative", left: "-" + h + "px", width: d + "px"})
            }
        }), a(".ult-carousel-wrapper").each(function (b, c) {
            var d = a(c).data("gutter"), e = a(c).attr("id");
            if ("" != d) {
            ...
            a(".ult-carousel-wrapper").each(function () {
                ...
                if (b.hasClass("ult_full_width")) {
                    ...
                    b.removeAttr("style");
                    var d = a("html").outerWidth(), e = 0, f = b.offset().left, g = Math.abs(e - f), h = g;
                    "true" === c || c === !0 ? b.css({
                        position: "relative",
                        right: "-" + h + "px",
                        width: d + "px"
        ...
        a(".ult-carousel-wrapper").each(function () {
            ...
            if (b.hasClass("ult_full_width")) {
                b.css("left", 0), b.css("right", 0);
                var c = 0, d = b.offset().left, e = Math.abs(c - d), f = b.attr("data-rtl"), g = a("html").outerWidth(), h = e;
                "true" === f || f === !0 ? b.css({
                    position: "relative",
                    right: "-" + h + "px",
                    width: g + "px"
                }) : b.css({position: "relative", left: "-" + h + "px", width: g + "px"})
            }
        })
    })
}(jQuery), !function (a) {
    ...
    function b() {
        ...
        b.each(function () {
            var b = a(this), c = (b.closest(".ult_row_spacer"), b.find(".ult-sticky")), e = c.data("stick_behaviour"), g = c.data("support");
            if ("stick_with_scroll_row" == e || "no" != g) {
                var h = 0, i = c.data("gutter"), j = c.data("sticky_gutter_class"), k = c.data("sticky_gutter_id"), l = c.data("mobile");
                i = d(h, i, j, k);
                var m = b.closest(".wpb_column").closest(".vc_row");
                b.parent().offset().top;
                b.addClass("ult_stick_to_row"), m.addClass("ult_s_container"), "yes" == g && (m = "body"), 768 > f && "no" == l || b.fixTo(m, {
                    top: i,
                    useNativeSticky: !1
                })
            }
    ...
    function c() {
        elements = a("div.ult-sticky-anchor"), elements.each(function () {
            var b = a(this), c = b.find(".ult-sticky"), h = c.data("mobile"), i = b.find(".ult-space");
            if (768 > f && "no" == h)return c.removeClass("ult-stick"), void i.css("height", "");
            var j = e.scrollTop(), k = b.offset().top, l = e.height(), m = c.data("stick_behaviour"), n = c.data("support");
            if ("stick_with_scroll_row" != m && "yes" != n) {
                var o = b.parent().width(), p = c.height(), q = 0, r = c.data("gutter"), s = c.data("sticky_gutter_class"), t = c.data("sticky_gutter_id"), u = c.data("lr_position"), v = c.data("lr_value"), w = c.data("sticky_customwidth"), x = c.data("sticky_width"), y = c.data("sticky_position"), z = -1;
    ...
    jQuery.fn.reverse = [].reverse, a.SwatchBook = function (b, c) {
        ...
        _init: function (b) {
            ...
            this.support && this.$items.css({transition: "all " + this.options.speed + "ms " + this.options.easing})
        }, _openclose: function () {
            this.isClosed ? this._center(this.options.center, !0) : this.$items.css({transform: "rotate(0deg)"}), this.isClosed = !this.isClosed
            ...
            var b = a.index();
            b !== this.current && (-1 !== this.options.closeIdx && b === this.options.closeIdx ? (this._openclose(), this._setCurrent()) : (this._setCurrent(a), a.css({transform: "rotate(0deg)"}), this._rotateSiblings(a)))
            ...
            f ? c = f : (c = b.siblings(), this.cache[e] = c), c.each(function (b) {
                var c = e > b ? d.options.angleInc * (b - e) : b - e === 1 ? d.options.proximity : d.options.proximity + (b - e - 1) * d.options.neighbor, f = "rotate(" + c + "deg)";
    ...
    a(".cq-accordion").each(function () {
        ...
        a(this);
        var b = a(this).data("titlebg"), c = a(this).data("titlecolor"), d = a(this).data("titlehoverbg"), e = a(this).data("titlehovercolor"), f = a(this).data("activetitle"), g = a(this).data("activeicon"), h = a(this).data("activebg");
        if ("" == g)var g = a(this).find(".aio-icon").data("iconhover");
        a(this).find(".ult-tabto-actitle").each(function () {
            var f = a(this).find(".aio-icon").data("iconcolor"), g = a(this).find(".aio-icon").data("iconhover");
            a(this).css("background-color", b).on("mouseover", function () {
                ...
                a(this).hasClass("ult-tabto-actitleActive") || a(this).css({"background-color": b, color: c});
            ...
            if (c = a(b.target).is("i") ? a(b.target).parent() : a(b.target), c.hasClass("ult-tabto-actitle")) {
                var d = c.parent().next(), e = c.parents(".ult-tabto-accordion").data("animation");
                d.nextAll("dd").hasClass("cq-animateIn") && d.nextAll("dd").removeClass("cq-animateIn").addClass(" cq-animateOut ult-tabto-accolapsed"), d.prevAll("dd").hasClass("cq-animateIn") && d.prevAll("dd").removeClass("cq-animateIn").addClass("ult-tabto-accolapsed"), d.nextAll("dd").hasClass("ult-ac-slidedown") && d.nextAll("dd").removeClass("ult-ac-slidedown").addClass(" ult-ac-slideup ult-tabto-accolapsed"), d.prevAll("dd").hasClass("ult-ac-slidedown") && d.prevAll("dd").removeClass("ult-ac-slidedown").addClass("ult-tabto-accolapsed"), d.prevAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && d.prevAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), d.nextAll("dt").find(".ult-tabto-actitle").hasClass("ult-tabto-actitleActive") && d.nextAll("dt").find(".ult-tabto-actitle").removeClass("ult-tabto-actitleActive").addClass("ult-acc-normal"), c.removeClass("ult-acc-normal"), jQuery(this).find(".ult-acc-normal").each(function () {
                    var a = jQuery(this).find(".aio-icon").data("iconcolor"), b = (jQuery(this).find(".aio-icon").data("iconhover"), jQuery(this).parents(".ult-tabto-accordion").data("titlebg")), c = jQuery(this).parents(".ult-tabto-accordion").data("titlecolor");
                    jQuery(this).css({background: b, color: c}), jQuery(this).find(".aio-icon").css({color: a})
                }), c.css({color: f, "background-color": h}), c.find(".aio-icon").css({color: g});
                ...
                c.css({
                    color: f,
                    "background-color": h
                }), c.find(".aio-icon").css({color: g}), "Fade" == e ? (c.toggleClass("ult-tabto-actitleActive"), d.hasClass("ult-tabto-accolapsed") ? (d.hasClass("cq-animateOut") && d.removeClass("cq-animateOut"), d.addClass("cq-animateIn")) : (d.removeClass("cq-animateIn"), d.addClass("cq-animateOut")), d.toggleClass("ult-tabto-accolapsed"), b.preventDefault()) : (c.toggleClass("ult-tabto-actitleActive"), d.hasClass("ult-tabto-accolapsed") ? (d.hasClass("ult-ac-slideup") && d.removeClass("ult-ac-slideup"), d.addClass("ult-ac-slidedown")) : (d.removeClass("ult-ac-slidedown"), d.addClass("ult-ac-slideup")), d.toggleClass("ult-tabto-accolapsed"), b.preventDefault()), d.hasClass("ult-tabto-accolapsed") && c.removeClass("ult-tabto-actitleActive")
            ...
            jQuery("html, body").animate({scrollTop: a(this).offset().top - 100}, 1200)
        })
    })
}), jQuery(document).ready(function (a) {
    a(".ult_tabs").each(function () {
        ...
        var c = a(this), d = a(this).data("tabsstyle"), e = a(this).data("titlecolor"), f = a(this).data("titlebg"), g = a(this).data("titlehovercolor"), h = a(this).data("titlehoverbg"), i = parseInt(a(this).data("rotatetabs")), j = a(this).find("ul.ult_tabmenu li.ult_tab_li").length, k = a(this).data("activetitle"), l = a(this).data("activeicon"), m = a(this).data("activebg"), n = parseInt(a(this).find(".ult_tabcontent").outerWidth()), o = 0, p = [];
        p.push(0), a(this).find("ul.ult_tabmenu").addClass("active").find("> li.ult_tab_li:eq(0)").addClass("current"), a(this).find("ul.ult_tabmenu li.ult_tab_li").each(function (b) {
            var c = a(this).data("iconhover"), i = a(this).data("iconcolor");
            "" == l && (l = c), 0 == b && ("style2" == d || "style1" == d ? (a(this).find("a.ult_a").css({
                background: m,
                color: k
            }), a(this).find(".ult_tab_icon").css({color: l})) : (a(this).find("a.ult_a").css({color: k}), a(this).css({
                background: m,
                color: k
            }), a(this).find(".ult_tab_icon").css({color: k}))), a(this).on("mouseover", function () {
                a(this).hasClass("current") || (a(this).hasClass("current") || "style2" == d || "style1" == d ? (a(this).find("a.ult_a").css({
                    background: h,
                    color: g
                }), a(this).find(".ult_tab_icon").css({color: c})) : (a(this).find("a.ult_a").css({color: g}), a(this).css({
                    background: h,
                    color: g
                }), a(this).find("a.ult_a").find(".ult_tab_icon").css({color: c})))
            }).on("mouseleave", function () {
                a(this).hasClass("current") || ("style2" == d || "style1" == d ? (a(this).find("a.ult_a").css({
                    background: f,
                    color: e
                }), a(this).find(".ult_tab_icon").css({color: i})) : (a(this).find("a.ult_a").css({color: e}), a(this).css({
                    background: f,
                    color: e
                }), a(this).find("a.ult_a").find(".ult_tab_icon").css({color: i})))
            })
        }), a(this).find("ul.ult_tabmenu li a.ult_a").click(function (c) {
            var g = a(this).closest(".ult_tabs"), h = a(this).closest("li.ult_tab_li").index(), j = a(this).parent().data("iconcolor");
            a(this).parent().data("iconhover");
            p.push(h);
            var q = (p[p.length - 1], p[p.length - 2]), r = a(this).closest(".ult_tabs").data("animation");
            g.find("ul.ult_tabmenu > li.ult_tab_li").removeClass("current"), "style2" == d || "style1" == d ? (g.find("ul.ult_tabmenu > li.ult_tab_li").find("a").css({
                background: f,
                color: e
            }), g.find("ul.ult_tabmenu > li.ult_tab_li").find(".ult_tab_icon").css({color: j})) : (g.find("ul.ult_tabmenu > li.ult_tab_li").find("a.ult_a").css({color: e}), g.find("ul.ult_tabmenu > li.ult_tab_li").css({
                background: f,
                color: e
            }));
            ...
            "Slide" == r ? ("style2" == d || "style1" == d ? (s.find("a.ult_a").css({
                background: m,
                color: k
            }), s.find(".ult_tab_icon").css({color: l})) : (s.find("a.ult_a").css({color: k}), s.css({
                background: m,
                color: k
            ...
            }), o = h, c.preventDefault()) : "Fade" == r ? ("style2" == d || "style1" == d ? (s.find("a.ult_a").css({
                background: m,
                color: k
            }), s.find(".ult_tab_icon").css({color: l})) : (s.find("a.ult_a").css({color: k}), s.css({
                background: m,
                ...
                jQuery(this).addClass("ult_active_tabnme"), g.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + h + ")").removeClass("ult_active_tabnme"), g.find(".ult_tabcontent").find("div.ult_tabitemname").not("div.ult_tabitemname:eq(" + h + ")").hide(10), h > q ? jQuery(this).animate({left: "-" + n + "px"}, 10) : jQuery(this).animate({left: "" + n + "px"}, 10), i > 0 && b()
            }), g.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + h + ")").show(100, function () {
                jQuery(this).animate({left: "0px"}, 800)
            }), o = h, c.preventDefault()) : (g.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + h + ")").animate({opacity: 1}, 1, function () {
                i > 0 && b()
            }), g.find(".ult_tabcontent").find("div.ult_tabitemname:eq(" + h + ")").animate({opacity: 1}, 1, function () {
            }), o = h, c.preventDefault())) : ("style2" == d || "style1" == d ? (s.find("a.ult_a").css({
                background: m,
                color: k
            }), s.find(".ult_tab_icon").css({color: l})) : (s.find("a.ult_a").css({color: k}), s.css({
                background: m,
    ...
    setmytime(), jQuery(this).find("ul.ult_tabmenu li a.ult_a").click(function (a) {
        ...
        if (j = jQuery(this).closest("li.ult_tab_li").index(), "Fade" == b) {
            ...
            jQuery(this).closest(".ult_tabs").find(".ult_tabitemname").css({
                ...
                left: "0",
                right: "0"
            }), jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").animate({height: c}, "slow")
        }
        if ("Slide-Horizontal" == b) {
            var c = jQuery(this).closest(".ult_tabs").find("div.ult_tabitemname:eq(" + j + ")").outerHeight();
            jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").css({overflow: "hidden"}), jQuery(this).closest(".ult_tabs").find(".ult_tabcontent").animate({height: c}, "slow")
        }
    })
}), jQuery(document).ready(function () {
    ...
    function b() {
        jQuery(".ult-team-member-wrap").each(function (a) {
            var b = jQuery(this).height(), c = jQuery(this).find(".ult-team_description_slide"), d = c;
            ...
            var b = jQuery(this).height(), c = jQuery(this).find(".ult-team-member-description"), d = c;
            parseFloat(b) < parseFloat(d.height()) ? d.addClass("ult-desc-set-top") : d.hasClass("ult-desc-set-top") && d.removeClass("ult-desc-set-top")
        })
    }
    ...
    jQuery(".ult-team.ult-social-icon").hover(function () {
        ...
        var a = jQuery(this).find(" .ult-team-member-image").first(), b = a.data("hover_opacity");
        a.children("img").css("opacity", b)
    }, function () {
        var a = jQuery(this).find(" .ult-team-member-image").first(), b = a.data("opacity");
        a.children("img").css("opacity", b)
        ...
        jQuery(this).css({"background-color": a})
    })
}), +function (a) {
    "use strict";
    var b = function (a, b) {
    ...
    a.fn.bsf_tooltip = function (c) {
        return this.each(function () {
            var d = a(this), e = d.data("bs.bsf_tooltip"), f = "object" == typeof c && c;
    ...
    jQuery(".ult-responsive").each(function (h, i) {
        var j = jQuery(this), k = j.attr("data-responsive-json-new"), l = j.data("ultimate-target"), m = "", n = "", o = "", p = "", q = "", r = "";
    ...
    a(document).ready(function () {
        ...
        a(".ult-video-banner").each(function (c, d) {
            var e = a(d).attr("id"), f = a(d).data("current-time"), g = (a(d).data("placeholder"), 0);
            ...
            var h = a(d).find(".ult-video-banner-overlay").data("overlay"), i = a(d).find(".ult-video-banner-overlay").data("overlay-hover");
    ...
    a.fn.vTicker = function (b) {
        ...
        return moveUp = function (b, c, d) {
            if (!d.isPaused) {
                var e = b.children("ul"), f = e.children("li:first").clone(!0);
                d.height > 0 && (c = e.children("li:first").height()), e.animate({top: "-=" + c + "px"}, d.speed, function () {
            ...
            if (!d.isPaused) {
                var e = b.children("ul"), f = e.children("li:last").clone(!0);
                d.height > 0 && (c = e.children("li:first").height()), e.css("top", "-" + c + "px").prepend(f), e.animate({top: 0}, d.speed, function () {
                    a(this).children("li:last").remove()
                }), "fade" == d.animation && (0 == d.height && e.children("li:eq(" + d.showItems + ")").fadeOut(d.speed), e.children("li:first").hide().fadeIn(d.speed))
            }
        }, this.each(function () {
            var c = a(this), d = 0;
            c.css({overflow: "hidden", position: "relative"}).children("ul").css({
                position: "absolute",
                margin: 0,
                padding: 0
            }).children("li").css({
