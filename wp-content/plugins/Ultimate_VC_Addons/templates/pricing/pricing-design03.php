...
if (!function_exists('ult_price_generate_design03')) {
    function ult_price_generate_design03($atts, $content = NULL) {
        $package_heading
            = $package_sub_heading = $package_price = $package_unit = $package_btn_text = $package_link
            = $package_featured
            =
        $color_bg_main = $color_txt_main = $color_bg_highlight = $color_txt_highlight = $color_scheme = $el_class = '';
        ...
        $css_price_box = apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG,
                                       vc_shortcode_custom_css_class($css_price_box, ' '), "ultimate_pricing", $atts);
        ...
        /* Typography */
        $package_name_inline
            = $sub_heading_inline = $price_inline = $price_unit_inline = $features_inline = $button_inline = '';
        // package name/title
