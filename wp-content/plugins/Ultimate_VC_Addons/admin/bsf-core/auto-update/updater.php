                ...
                foreach ($update_ready as $key => $product) :
                    ...
                    <tr class='active' id="bsf-row-<?php echo $key ?>">
                        <td class='plugin-title'>
                            <strong><?php echo ($product['bundled']) ? $product['name'] : $product['product_name'] ?></strong>
                            <span><?php _e('You have version ' . $product['version'] . ' installed. Update to ' . $product['remote'], 'bsf'); ?></span>
                        </td>
