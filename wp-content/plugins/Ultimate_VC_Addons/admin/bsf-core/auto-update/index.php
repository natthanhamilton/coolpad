                ...
                <div class="bsf-ur-wrap">
                    <form action="" method="post" id="bsf-user-form" class="bsf-pr-form">
                        ...
                        <div class="bsf-pr-form-row">
                            <input type="text" id="bsf_useremail_reenter" name="bsf_useremail_reenter" value=""
                                   spellcheck="false" placeholder="<?php echo __('Verify Email Address', 'bsf'); ?>"
                                   class="bsf-pr-input stored" data-required="true"/>
                        </div>
                        <div class="bsf-pr-form-row">
                    ...
                    <div class="bsf-pr-submit-row">
                        <input type="button" class="bsf-pr-form-submit button-primary bsf-button-primary"
                               data-form-id="bsf-user-form" value="<?php echo __('Register and Proceed', 'bsf'); ?>"/>
                    ...
                    if (!empty($bsf_plugins)) :
                        foreach ($bsf_plugins as $plugin => $plugin_data) :
                            ...
                            <tr id="<?php echo $row_id ?>" class="<?php echo $alternate . ' ' . $status ?>">
                                ...
                                <td><input type="text" class="bsf-form-input" name="purchase_key" spellcheck="false"
                                           data-required="true"
                                           value="<?php echo $purchase_key ?>" <?php echo $readonly ?>/></td>
                                <td>
                                    <?php if ($status !== 'registered') : ?>
                                        <input type="button" class="button button-primary bsf-submit-button"
                                               value="Register"
                                               data-row-id="<?php echo $row_id ?>" <?php echo $common_data; ?>/> <span
                                            class="spinner bsf-spinner"></span>
                                    <?php else : ?>
                                        <input type="button" class="button bsf-submit-button-deregister"
                                               value="De-register"
                                               data-row-id="<?php echo $row_id ?>" <?php echo $common_data; ?>/> <span
                                            class="spinner bsf-spinner"></span>
                                    <?php endif; ?>
                    ...
                    if (!empty($bsf_themes)) :
                        foreach ($bsf_themes as $theme => $theme_data) :
                            ...
                            <tr id="<?php echo $row_id ?>" class="<?php echo $alternate . ' ' . $status ?>">
                                ...
                                <td><input type="text" class="bsf-form-input" name="purchase_key" data-required="true"
                                           value="<?php echo $purchase_key ?>" <?php echo $readonly ?>/></td>
                                <td>
                                    <?php if ($status !== 'registered') : ?>
                                        <input type="button" class="button button-primary bsf-submit-button"
                ...
                <div class="inner">
                    <div class="bsf-cp-res-user">
                        ...
                        <a class="button-primary"
                           href="<?php echo $reset_url ?>"><?php echo __('Reset Site', 'bsf') ?></a>
                    </div>
