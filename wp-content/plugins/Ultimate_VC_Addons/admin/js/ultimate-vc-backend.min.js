(function () {
    ...
    var b = function () {
        var b = 65, c = '<div class="colorpicker"><div class="colorpicker_color"><div><div></div></div></div><div class="colorpicker_hue"><div></div></div><div class="colorpicker_new_color"></div><div class="colorpicker_current_color"></div><div class="colorpicker_hex"><input type="text" maxlength="6" size="6" /></div><div class="colorpicker_rgb_r colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_g colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_rgb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_h colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_s colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_hsb_b colorpicker_field"><input type="text" maxlength="3" size="3" /><span></span></div><div class="colorpicker_submit"></div></div>', d = {
            eventName: "click",
            onShow: function () {
            },
            ...
            this.parentNode.className.indexOf("_hex") > 0 ? d.data("colorpicker").color = c = J(H(this.value)) : this.parentNode.className.indexOf("_hsb") > 0 ? d.data("colorpicker").color = c = F({
            ...
            }) : d.data("colorpicker").color = c = K(G({
            ...
            c.preview = c.cal.data("colorpicker").livePreview, a(document).bind("mouseup", c, u), a(document).bind("mousemove", c, t)
        }, t = function (a) {
            ...
            return e(b.data.cal.data("colorpicker").color, b.data.cal.get(0)),
                g(b.data.cal.data("colorpicker").color, b.data.cal.get(0)), a(document).unbind("mouseup", u), a(document).unbind("mousemove", t), !1
        }, v = function (b) {
            var c = {cal: a(this).parent(), pos: a(this).offset()};
            ...
            var c = a(this).parent(), d = c.data("colorpicker").color;
            c.data("colorpicker").origColor = d, j(d, c.get(0)), c.data("colorpicker").onSubmit(d, N(d), L(d), c.data("colorpicker").el)
        }, B = function (b) {
            var c = a("#" + a(this).data("colorpickerId"));
            c.data("colorpicker").onBeforeShow.apply(this, [c.get(0)]);
            var d = a(this).offset(), e = E(), f = d.top + this.offsetHeight, g = d.left;
            return f + 176 > e.t + e.h && (f -= this.offsetHeight + 176), g + 356 > e.l + e.w && (g -= 356), c.css({
                left: g + "px",
                top: f + "px"
            }), 0 != c.data("colorpicker").onShow.apply(this, [c.get(0)]) && c.show(), a(document).bind("mousedown", {cal: c}, C), !1
        }, C = function (b) {
            ...
            var b = a(this).parent(), c = b.data("colorpicker").origColor;
            b.data("colorpicker").color = c, e(c, b.get(0)), g(c, b.get(0)), f(c, b.get(0)), h(c, b.get(0)), i(c, b.get(0)), k(c, b.get(0))
        };
        return {
            init: function (b) {
                if (b = a.extend({}, d, b || {}), "string" == typeof b.color)b.color = J(b.color); else if (void 0 != b.color.r && void 0 != b.color.g && void 0 != b.color.b)b.color = K(b.color); else {
                ...
                if ("string" == typeof b)b = J(b); else if (void 0 != b.r && void 0 != b.g && void 0 != b.b)b = K(b); else {
    ...
    a.ClassyGradient = function (b, c) {
        ...
        return this.settings = {}, this.__constructor = function () {
            return this.settings = a.extend({}, n, c), this.update(), this.settings.onInit(), this
        }, this.update = function () {
            this._setupPoints(), this._setup(), this._render()
        }, this.getCSS = function () {
            var b = "", c = "0%", d = "100%", e = "left bottom", f = "top";
            "horizontal" === this.settings.orientation && (c = "100%", d = "0%", e = "right top", f = "left"), f = this.settings.orientation;
            var g = '<svg xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gradient" x1="0%" y1="0%" x2="' + c + '" y2="' + d + '">', h = "-webkit-gradient(linear, left top, " + e, i = "";
            return a.each(p, function (a, b) {
                h += ", color-stop(" + b[0] + ", " + b[1] + ")", i += "," + b[1] + " " + b[0], g += '<stop offset="' + b[0] + '" style="stop-color:' + b[1] + ';" />'
            }), h += ")", i = i.substr(1), g += '</linearGradient></defs><rect fill="url(#gradient)" height="100%" width="100%" /></svg>', g = this._base64(g), b += "background: url(data:image/svg+xml;base64," + g + ");\n", b += "background: " + h + ";\n", b += "background: -moz-linear-gradient(" + f + "," + i + ");\n", b += "background: -webkit-linear-gradient(" + f + "," + i + ");\n", b += "background: -o-linear-gradient(" + f + "," + i + ");\n", b += "background: -ms-linear-gradient(" + f + "," + i + ");\n", b += "background: linear-gradient(" + f + "," + i + ");"
        }, this.getArray = function () {
            return p
        }, this.getString = function () {
            var b = "";
            return a.each(p, function (a, c) {
                b += c[0] + " " + c[1] + ","
            }), b = b.substr(0, b.length - 1)
        }, this.setOrientation = function (a) {
            this.settings.orientation = a, this._renderToTarget()
        }, this._setupPoints = function () {
            p = new Array, p = a.isArray(this.settings.gradient) ? this.settings.gradient : this._getGradientFromString(this.settings.gradient)
            ...
            o.empty(), d = a('<div class="ClassyGradient"></div>'), e = a('<canvas class="canvas" width="' + this.settings.width + '" height="' + this.settings.height + '"></canvas>'), d.append(e), l = e.get(0).getContext("2d"), f = a('<div class="points"></div>'), f.css("width", this.settings.width + Math.round(this.settings.point / 2 + 1) + "px"), d.append(f), g = a('<div class="info"></div>'), g.append('<div class="arrow"></div>'), d.append(g), h = a('<div class="content"></div>'), g.append(h), o.hover(function () {
                ...
                o.removeClass("hover")
            }), i = a('<div class="point-color"><div style="background-color: #00ff00"></div></div>'), j = a('<span class="point-position">%</span>'), k = a('<a href="#" class="delete"></a>'), h.append(i, j, k), o.append(d), i.ColorPicker({
                color: "#00ff00",
                onSubmit: function (a, c, d) {
                    o.find(".point-color div").css("backgroundColor", "#" + c), m.css("backgroundColor", "#" + c), b._renderCanvas(), b._renderToTarget()
                },
                onChange: function (a, c, d) {
                    o.find(".point-color div").css("backgroundColor", "#" + c), m.css("backgroundColor", "#" + c), b._renderCanvas(), b._renderToTarget()
                }
            }), a(document).bind("click", function () {
                o.is(".hover") || g.hide("fast")
            }), e.unbind("click"), e.bind("click", function (c) {
                var d = e.offset(), g = c.pageX - d.left;
                g = Math.round(100 * g / b.settings.width);
                var h = "#000000", i = 999999999999;
                a.each(p, function (a, b) {
                    parseInt(b[0]) < g && g - parseInt(b[0]) < i ? (i = g - parseInt(b[0]), h = b[1]) : parseInt(b[0]) > g && parseInt(b[0]) - g < i && (i = parseInt(b[0]) - g, h = b[1])
                }), p.push([g + "%", h]), p.sort(b._sortByPosition), b._render(), a.each(p, function (a, c) {
                    c[0] == g + "%" && b._selectPoint(f.find(".point:eq(" + a + ")"))
                })
            })
        }, this._render = function () {
            this._initGradientPoints(), this._renderCanvas(), this._renderToTarget()
        }, this._initGradientPoints = function () {
            var b = this;
            f.empty(), a.each(p, function (a, c) {
                f.append('<div class="point" style="background-color: ' + c[1] + "; left:" + parseInt(c[0]) * b.settings.width / 100 + 'px;"></div>')
            }), f.find(".point").css("width", this.settings.point + "px").css("height", this.settings.point + "px").mouseup(function () {
                b._selectPoint(this)
            }).draggable({
                axis: "x", containment: "parent", drag: function () {
                    b._selectPoint(this), b._renderCanvas(), b._renderToTarget()
                }
            })
        }, this._selectPoint = function (b) {
            var c = this;
            m = a(b);
            var d = a(b).css("backgroundColor"), e = parseInt(a(b).css("left"));
            e = Math.round(e / this.settings.width * 100), d = d.substr(4, d.length), d = d.substr(0, d.length - 1), i.ColorPickerSetColor(this._rgbToHex(d.split(","))), i.find("div").css("backgroundColor", this._rgbToHex(d.split(","))), j.html("Position: " + e + "%"), k.unbind("click").bind("click", function () {
                return p.length > 1 && (p.splice(m.index(), 1), c._render(), o.find(".info").hide("fast")), !1
            }), o.find(".info").css("marginLeft", parseInt(a(b).css("left")) - 30 + "px").show("fast")
        }, this._renderCanvas = function () {
            var b = this;
            p = new Array, o.find(".point").each(function (c, d) {
                var e = Math.round(parseInt(a(d).css("left")) / b.settings.width * 100), f = a(d).css("backgroundColor").substr(4, a(d).css("backgroundColor").length - 5);
                f = b._rgbToHex(f.split(",")), p.push([e + "%", f])
            }), p.sort(b._sortByPosition), this._renderToCanvas(), this.settings.onChange(this.getString(), this.getCSS(), this.getArray())
        }, this._renderToElement = function (b, c) {
            var d = "0%", f = "100%", g = "left bottom", i = "top";
            b !== e && "horizontal" !== this.settings.orientation || (d = "100%", f = "0%", g = "right top", i = "left"), i = this.settings.orientation;
            var j = '<svg xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="gradient" x1="0%" y1="0%" x2="' + d + '" y2="' + f + '">', k = "-webkit-gradient(linear, left top, " + g, l = "";
            if (a.each(c, function (a, b) {
                    k += ", color-stop(" + b[0] + ", " + b[1] + ")", l += "," + b[1] + " " + b[0], j += '<stop offset="' + b[0] + '" style="stop-color:' + b[1] + ';" />'
                }), k += ")", l = l.substr(1), j += "</linearGradient></defs>", b === h) {
                var m = parseInt(h.css("borderRadius"));
                j += '<rect fill="url(#gradient)" height="100%" width="100%" rx="' + m + '" ry="' + m + '" />'
            } else j += '<rect fill="url(#gradient)" height="100%" width="100%" />';
            j += "</svg>", j = this._base64(j), b.css("background", "url(data:image/svg+xml;base64," + j + ")"), b.css("background", k), b.css("background", "-moz-linear-gradient(" + i + "," + l + ")"), b.css("background", "-webkit-linear-gradient(" + i + "," + l + ")"), b.css("background", "-o-linear-gradient(" + i + "," + l + ")"), b.css("background", "-ms-linear-gradient(" + i + "," + l + ")"), b.css("background", "linear-gradient(" + i + "," + l + ")")
        }, this._renderToTarget = function () {
            null !== this.settings.target && this._renderToElement(a(this.settings.target), p)
        }, this._renderToCanvas = function () {
            var b = l.createLinearGradient(0, 0, this.settings.width, 0);
            a.each(p, function (a, c) {
                b.addColorStop(parseInt(c[0]) / 100, c[1])
            }), l.clearRect(0, 0, this.settings.width, this.settings.height), l.fillStyle = b, l.fillRect(0, 0, this.settings.width, this.settings.height), this.settings.onChange(this.getString(), this.getCSS(), this.getArray())
        }, this._getGradientFromString = function (b) {
            var c = new Array, d = b.split(",");
            return a.each(d, function (a, b) {
                var d;
                "100" == b.substr(b.indexOf("%") - 3, b.indexOf("%")) || "100%" == b.substr(b.indexOf("%") - 3, b.indexOf("%")) ? d = "100%" : b.indexOf("%") > 1 ? (d = parseInt(b.substr(b.indexOf("%") - 2, b.indexOf("%"))), d += "%") : (d = parseInt(b.substr(b.indexOf("%") - 1, b.indexOf("%"))), d += "%");
                var e = b.substr(b.indexOf("#"), 7);
                c.push([d, e])
            }), c
        }, this._rgbToHex = function (a) {
            function b(a) {
                return a = parseInt(a, 10), isNaN(a) ? "00" : (a = Math.max(0, Math.min(a, 255)), "0123456789ABCDEF".charAt((a - a % 16) / 16) + "0123456789ABCDEF".charAt(a % 16))
            }

            var c = a[0], d = a[1], e = a[2];
            return "#" + b(c) + b(d) + b(e)
        }, this._sortByPosition = function (a, b) {
            return parseInt(a[0]) < parseInt(b[0]) ? -1 : parseInt(a[0]) > parseInt(b[0]) ? 1 : 0
        }, this._base64 = function (a) {
            for (var b, c, d, e, f, g, h, i = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", j = "", k = 0; k < a.length;)b = a.charCodeAt(k++), c = a.charCodeAt(k++), d = a.charCodeAt(k++), e = b >> 2, f = (3 & b) << 4 | c >> 4, g = (15 & c) << 2 | d >> 6, h = 63 & d, isNaN(c) ? g = h = 64 : isNaN(d) && (h = 64), j += i.charAt(e) + i.charAt(f) + i.charAt(g) + i.charAt(h);
            return j
        }, this.__constructor()
    }, a.fn.ClassyGradient = function (b) {
        return this.each(function () {
            if (void 0 === a(this).data("ClassyGradient")) {
                var c = new a.ClassyGradient(this, b);
                a(this).data("ClassyGradient", c)
            }
        })
    }
}(jQuery), !function (a) {
    a(document).ready(function () {
        if ("undefined" == typeof vc || "undefined" == typeof window.VcColumnView)return !1;
        window.ULTHotspotSingleView = vc.shortcode_view.extend({
            editElement: function (b) {
                _.isObject(b) && b.preventDefault(), window.ULTHotspotSingleView.__super__.editElement.call(this, b), this.model.get("params");
                var c = this.$el, d = c.parent().attr("data-hotspot-image");
                if (void 0 == c.attr("data-latest-img") || 0 === c.attr("data-latest-img").length)var e = d; else var e = c.attr("data-latest-img");
                if (c.attr("data-hotspot-image", d), void 0 == c.parent().attr("data-hotspot-link") || 0 == c.parent().attr("data-hotspot-link").length || e != d)a.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {action: "wpb_single_image_src", content: d, size: "full", _vcnonce: window.vcAdminNonce},
                    dataType: "html",
                    success: function (a) {
                        ULT_H_img_ID = d, ULT_H_img_link = a, c.attr("data-hotspot-link", a), c.attr("data-latest-img", d)
                    }
                }); else {
                    var f = c.parent().attr("data-hotspot-link");
                    ULT_H_img_link = f, ULT_H_img_ID = c.parent().attr("data-hotspot-image")
                }
                ULT_H_Size = c.parent().attr("data-hotspot-size"), ULT_H_custom_size = c.parent().attr("data-hotspot-custom")
            }
        });
        var b = vc.shortcodes;
        window.ULTHotspotContainerView = window.VcColumnView.extend({
            buildDesignHelpers: function () {
                var c = this.model.get("params"), d = this.$el, e = (d.attr("data-model-id"), c.main_img), f = c.main_img_size, g = c.main_img_width, h = e.split("|"), i = "", j = "";
                "undefined" != h && null != h && jQuery.each(h, function (a, b) {
                    b.startsWith("id:") && (i = b.split("id:").pop()), b.startsWith("id^") && (i = b.split("id^").pop()), b.startsWith("url:") && (j = b.split("url:").pop()), b.startsWith("url^") && (j = b.split("url^").pop())
                }), null != i && "undefined" != i && null != j && "undefined" != j && (e = i + "|" + j), "undefined" != typeof c.main_img_width && (g = c.main_img_width), b.where({parent_id: this.model.id}), _.isEmpty(e) || (d.find("> .wpb_element_wrapper .wpb_column_container").attr("data-hotspot-image", e), d.find("> .wpb_element_wrapper .wpb_column_container").attr("data-hotspot-size", f), d.find("> .wpb_element_wrapper .wpb_column_container").attr("data-hotspot-custom", g), d.attr("data-hotspot-image", e), d.attr("data-hotspot-size", f), d.attr("data-hotspot-custom", g), a.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {action: "wpb_single_image_src", content: e, size: "full", _vcnonce: window.vcAdminNonce},
                    dataType: "html",
                    success: function (a) {
                        d.find("> .wpb_element_wrapper .wpb_column_container").attr("data-hotspot-link", a), d.attr("data-hotspot-link", a)
                    }
                }))
            }, addElement: function (a) {
                _.isObject(a) && a.preventDefault();
                var b = this.$el.attr("data-hotspot-image"), c = this.$el.attr("data-hotspot-link"), d = this.$el.attr("data-hotspot-size"), e = this.$el.attr("data-hotspot-custom");
                ULT_H_img_ID = b, ULT_H_img_link = c, ULT_H_Size = d, ULT_H_custom_size = e, window.ULTHotspotContainerView.__super__.addElement.call(this, a)
            }
        })
    })
}(jQuery);