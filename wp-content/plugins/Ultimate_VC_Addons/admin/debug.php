		...
		<div class="bend-heading-section ultimate-header">
			...
			<div class="bend-head-logo">
				<div class="bend-product-ver">
					<?php _e("Version", "ultimate_vc");
					echo ' ' . ULTIMATE_VERSION; ?>
				</div>
			</div>
		...
		<div class="bend-content-wrap">
			<div class="smile-settings-wrapper">
				<h2 class="nav-tab-wrapper">
					<a href="<?php echo admin_url('admin.php?page=about-ultimate' . $author_extend); ?>"
					   data-tab="about-ultimate" class="nav-tab"> <?php echo __('About', 'ultimate_vc'); ?> </a>
					<a href="<?php echo admin_url('admin.php?page=ultimate-dashboard' . $author_extend); ?>"
					   data-tab="ultimate-modules" class="nav-tab"> <?php echo __('Modules', 'ultimate_vc'); ?> </a>
					<a href="<?php echo admin_url('admin.php?page=ultimate-smoothscroll' . $author_extend); ?>"
					   data-tab="css-settings" class="nav-tab"> <?php echo __('Smooth Scroll', 'ultimate_vc'); ?> </a>
					<a href="<?php echo admin_url('admin.php?page=ultimate-scripts-and-styles' . $author_extend); ?>"
					   data-tab="css-settings"
					   class="nav-tab"> <?php echo __('Scripts and Styles', 'ultimate_vc'); ?> </a>
					<?php if ($author) : ?>
						<a href="<?php echo admin_url('admin.php?page=ultimate-debug-settings'); ?>"
						   data-tab="ultimate-debug" class="nav-tab nav-tab-active"> Debug </a>
					<?php endif; ?>
				</h2>
				...
				<div class="col-md-12">
					<?php if ($author) : ?>
						<div id="ultimate-debug" class="ult-tabs active-tab">
							<form method="post" id="ultimate_debug_settings">
								...
								<table class="form-table">
									...
									<tr valign="top">
										...
										<td>
											<div class="onoffswitch">
												<input type="checkbox" <?php echo $ultimate_video_fixer; ?>
												       id="ultimate_video_fixer" value="enable"
												       class="onoffswitch-checkbox" name="ultimate_video_fixer"/>
												<label class="onoffswitch-label" for="ultimate_video_fixer">
													<div class="onoffswitch-inner">
														<div class="onoffswitch-active">
															<div
																class="onoffswitch-switch"><?php echo __('ON',
															                                             'ultimate_vc'); ?></div>
														</div>
														<div class="onoffswitch-inactive">
															<div
																class="onoffswitch-switch"><?php echo __('OFF',
															                                             'ultimate_vc'); ?></div>
														</div>
													</div>
												</label>
									...
									<tr valign="top">
										...
										<td>
											<div class="onoffswitch">
												<input type="checkbox" <?php echo $ultimate_ajax_theme; ?>
												       id="ultimate_ajax_theme" value="enable"
												       class="onoffswitch-checkbox" name="ultimate_ajax_theme"/>
									...
									<tr valign="top">
										...
										<td>
											<a href="<?php echo admin_url('admin.php?page=bsf-font-icon-manager&delete-bsf-fonts'); ?>"
											   target="_blank" class="button">Delete Fonts</a>
										</td>
									</tr>
									<?php
									...
									<tr valign="top">
										...
										<td>
											<div class="onoffswitch" id="ult-theme-support-row">
												<input type="checkbox" <?php echo $ultimate_theme_support; ?>
												       id="ultimate_theme_support" value="enable"
												       class="onoffswitch-checkbox" name="ultimate_theme_support"/>
									...
									<tr valign="top">
										...
										<td>
											<div class="onoffswitch" id="ult-rtl-support-row">
												<input type="checkbox" <?php echo $ultimate_rtl_support; ?>
												       id="ultimate_rtl_support" value="enable"
												       class="onoffswitch-checkbox" name="ultimate_rtl_support"/>
									...
									?>
									<tr valign="top" class="ult-theme-support-row-dependant"
									    style="<?php echo $theme_dependant; ?>">
										<th scope="row"><?php echo __("Custom VC Row Class", "ultimate_vc"); ?></th>
										<td>
											<div>
												<input type="text" id="ultimate_custom_vc_row"
												       value="<?php echo $ultimate_custom_vc_row; ?>"
												       name="ultimate_custom_vc_row"/>
											</div>
										</td>
									</tr>
									<!--<tr valign="top">
									...
									<!--<tr valign="top">
										...
										<input type="checkbox" <?php echo $ultimate_modal_fixer; ?> id="ultimate_modal_fixer" value="enable" class="onoffswitch-checkbox" name="ultimate_modal_fixer" />
											 <label class="onoffswitch-label" for="ultimate_modal_fixer">
												<div class="onoffswitch-inner">
													<div class="onoffswitch-active">
														<div class="onoffswitch-switch"><?php echo __('ON',
									                                                                  'ultimate_vc'); ?></div>
													</div>
													<div class="onoffswitch-inactive">
														<div class="onoffswitch-switch"><?php echo __('OFF',
									                                                                  'ultimate_vc'); ?></div>
													</div>
												</div>
											</label>
									...
									<tr>
										...
										<td>
											<div class="onoffswitch">
												<input type="checkbox" <?php echo $bsf_dev_mode; ?> id="bsf_dev_mode"
												       value="enable" class="onoffswitch-checkbox"
												       name="bsf_options[dev_mode]"/>
									...
									<tr>
										...
										<td>
											<div class="onoffswitch">
												<input type="checkbox" <?php echo $ultimate_global_scripts; ?>
												       id="ultimate_global_scripts" value="enable"
												       class="onoffswitch-checkbox"
												       name="bsf_options[ultimate_global_scripts]"/>
									...
									<tr valign="top">
										<?php
										$ultimate_smooth_scroll_compatible
											= get_option('ultimate_smooth_scroll_compatible');
										...
										?>
										<th scope="row"><?php echo __("Smooth Scroll - Old library",
										                              "ultimate_vc"); ?></th>
										<td>
											<div class="onoffswitch">
												<input
													type="checkbox" <?php echo $ultimate_smooth_scroll_compatible_attr; ?>
													id="ultimate_smooth_scroll_compatible" value="enable"
													class="onoffswitch-checkbox"
													name="ultimate_smooth_scroll_compatible"/>
												<label class="onoffswitch-label"
												       for="ultimate_smooth_scroll_compatible">
													<div class="onoffswitch-inner">
														<div class="onoffswitch-active">
															<div
																class="onoffswitch-switch"><?php echo __('ON',
									...
									<tr valign="top">
										...
										?>
										<th scope="row"><?php echo __("Animation Block on Mobile",
										                              "ultimate_vc"); ?></th>
										<td>
											<div class="onoffswitch">
												<input type="checkbox" <?php echo $ultimate_animation; ?>
												       id="ultimate_animations" value="enable"
												       class="onoffswitch-checkbox" name="ultimate_animation"/>
							...
							<p class="submit"><input type="submit" name="submit" id="submit-debug-settings"
							                         class="button button-primary"
							                         value="<?php echo __("Save Changes", "ultimate"); ?>"></p>
						</div>
					<?php endif; ?>
				</div> <!--col-md-12 -->
	...
	submit_btn.bind('click', function (e) {
		...
		jQuery.ajax({
			...
			success: function (result) {
				...
				console.log(result);
				if (result == "success") {
					jQuery("#msg").html('<div class="updated"><p><?php echo __('Settings updated successfully!',
					                                                           'ultimate_vc'); ?></p></div>');
				} else {
					jQuery("#msg").html('<div class="error"><p><?php echo __('No settings were updated.',
					                                                         'ultimate_vc'); ?></p></div>');
				}
			}
		});
...
<style type="text/css">
	...
	#ultimate-settings, #ultimate-modules, .ult-tabs {
		display: none;
	}

	#ultimate-settings.active-tab, #ultimate-modules.active-tab, .ult-tabs.active-tab {
		display: block;
	}
