    ...
    if (window.Select2 === b) {
        ...
        K = a(document), I = function () {
            ...
            bind: function (a) {
                ...
                function d() {
                    j.removeClass("select2-active"), m.positionDropdown(), k.find(".select2-no-results,.select2-selection-limit,.select2-searching").length ? m.liveRegion.text(k.text()) : m.liveRegion.text(m.opts.formatMatches(k.find(".select2-result-selectable").length))
                }
            ...
            createContainer: function () {
                ...
                var d = this;
                this.selection.on("click", ".select2-search-choice:not(.select2-locked)", function (b) {
