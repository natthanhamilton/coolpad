...
if (!class_exists('WooComposer_Cat_Carousel')) {
    class WooComposer_Cat_Carousel {
        function __construct() {
            add_action('admin_init', [$this, 'woocomposer_init_grid']);
            add_shortcode('woocomposer_carousel_cat', [$this, 'woocomposer_carousel_shortcode']);
        } /* end constructor */
                    ...
                    [
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "value"      => "",
                                ////"description" => __("","smile"),,
                                "dependency" => ["element" => "options", "value" => ["sel_cat"]],
                                "group"      => "Initial Settings",
                            ],
                            [
                                "type"       => "textfield",
        ...
        function woocomposer_carousel_shortcode($atts) {
            ...
            $number           = $orderby
                =
            $order = $columns = $options = $parent = $design_style = $text_align = $border_style = $border_color = '';
            $border_size
                              = $border_radius
                =
            $product_animation = $color_categories = $size_cat = $img_animate = $color_categories_bg = $cat_count = '';
            $slides_to_scroll = $scroll_speed
                = $advanced_opts
                = $output = $autoplay_speed = $scroll_opts = $color_cat_count_color = $color_cat_count_bg = '';
            ...
            if ($product_categories) {
                ...
                foreach ($product_categories as $category) {
                    ...
                    ?>">
                        <div
                            class="wcmp-product wcmp-img-<?php echo $img_animate; ?> woocommerce wcmp-cat-<?php echo $design_style; ?>">
                                ...
                                <h3 style="<?php echo $size; ?>">
                                    ...
                                    if ($category->count > 0) {
                                        echo apply_filters('woocommerce_subcategory_count_html',
                                                           ' <mark class="count" style="' . $count_style . '">' . $category->count . ' ' . $cat_count . '</mark>',
                                                           $category);
                                    }
                                    ?>
                                </h3>
