...
if (!class_exists('WooComposer_Cat_Grid')) {
    class WooComposer_Cat_Grid {
        function __construct() {
            ...
            add_shortcode('woocomposer_grid_cat', [$this, 'woocomposer_grid_shortcode']);
        } /* end constructor */
                        ...
                        "params"                  => [
                            ...
                            [
                                ...
                                "options"     => [
                                    ...
                                    "parent"     => [
                                        "label" => __("Display Child Categories if availabe in the loop",
                                                      "ultimate_vc"),
                                        "on"    => __("Yes", "ultimate_vc"),
                                        "off"   => __("No", "ultimate_vc"),
                                    ],
        ...
        function woocomposer_grid_shortcode($atts) {
            ...
            $border_size
                                   = $border_radius
                = $product_animation = $color_categories = $size_cat = $img_animate = $color_categories_bg = '';
            ...
            if ($product_categories) {
                ...
                foreach ($product_categories as $category) {
                    ...
                    ?>">
                        ...
                        <div
                            class="wcmp-product wcmp-img-<?php echo $img_animate; ?> wcmp-cat-<?php echo $design_style . ' animated ' . $product_animation; ?>"
