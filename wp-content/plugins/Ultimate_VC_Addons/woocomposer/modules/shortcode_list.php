...
if (!class_exists("WooComposer_ViewList")) {
	class WooComposer_ViewList {
		function __construct() {
			add_shortcode('woocomposer_list', [$this, 'woocomposer_list_shortcode']);
					...
					[
						...
						"params"                  => [
							...
							[
								...
								"suffix"     => "px",
								//"description" => __("", "woocommerce"),
								"dependency" => ["element" => "img_border", "not_empty" => TRUE],
							],
							[
								"type"       => "number",
								"class"      => "",
		...
		function woocomposer_list_shortcode($atts) {
			...
			$img_position = $img_size
				...
				= $border_radius
				=
			$border_color = $title_font = $price_font = $price_color = $rating_color = $rating_font = $shortcode = '';
