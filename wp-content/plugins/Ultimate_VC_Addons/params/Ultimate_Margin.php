		...
		function __construct() {
			if (defined('WPB_VC_VERSION') && version_compare(WPB_VC_VERSION, 4.8) >= 0) {
				if (function_exists('vc_add_shortcode_param')) {
					vc_add_shortcode_param('ultimate_margins', [$this, 'ultimate_margins_param'],
					                       plugins_url('../admin/vc_extend/js/vc-headings-param.js', __FILE__));
				}
			} else {
				if (function_exists('add_shortcode_param')) {
					add_shortcode_param('ultimate_margins', [$this, 'ultimate_margins_param'],
					                    plugins_url('../admin/vc_extend/js/vc-headings-param.js', __FILE__));
				}
			}
		}
