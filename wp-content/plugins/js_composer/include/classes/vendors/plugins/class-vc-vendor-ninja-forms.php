...
class Vc_Vendor_NinjaForms implements Vc_Vendor_Interface {
    ...
    public function load() {
        vc_lean_map('ninja_forms_display_form', [
            $this,
     ...
     * @deprecated 4.9
     */
    public function mapNinjaForms($ninja_forms = []) {
        ...
        vc_map([
                   ...
                   'params'      => [
                       [
                           ...
                           'value'       => $ninja_forms,
                           'save_always' => TRUE,
                           'description' => __('Choose previously created ninja form from the drop down list.',
                                               'js_composer'),
                       ],
                   ],
               ]);
