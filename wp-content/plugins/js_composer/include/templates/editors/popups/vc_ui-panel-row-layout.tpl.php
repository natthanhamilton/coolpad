...
?>
<div class="vc_ui-font-open-sans vc_ui-panel-window vc_media-xs vc_ui-panel" data-vc-panel=".vc_ui-panel-header-header"
     data-vc-ui-element="panel-row-layout" id="vc_ui-panel-row-layout">
            ...
            <div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements"
                ...
                <div class="vc_row vc_ui-flex-row">
                    ...
                    <div class="vc_col-sm-12 vc_column">
                        <div
                            class="wpb_element_label"><?php _e('Enter custom layout for your row', 'js_composer') ?></div>
                        <div class="edit_form_line">
                            <input name="padding" class="wpb-textinput vc_row_layout" type="text" value=""
                                   id="vc_row-layout">
                            <span
                                class="vc_general vc_ui-button vc_ui-button-size-sm vc_ui-button-action vc_ui-button-shape-rounded vc_ui-button-update-layout"
                                data-vc-ui-element="button-update-layout"><?php _e('Update', 'js_composer') ?></span>
					<span
