...
<script type="text/html" id="vc_controls-template-default">
	<div
		...
		<div class="vc_controls-cc"><a
				class="vc_control-btn vc_element-name{# if( can_all ) { #} vc_element-move{# } #}"><span
					class="vc_btn-content"
					title="{# if( can_all ) { #}<?php printf(__('Drag to move %s', 'js_composer'),
					                                         '{{ name }}') ?>{# } #}">
					{{ name }}
	...
	<div class="vc_controls-container">
		<div class="vc_controls-out-tl">
			<div class="vc_element element-{{ tag }}"><a
					class="vc_control-btn vc_element-name{# if( can_all ) { #} vc_element-move{# } #}"
					title="{# if( can_all ) { #}<?php printf(__('Drag to move %s', 'js_composer'),
					                                         '{{ name }}') ?>{# } #}"><span
						class="vc_btn-content">{{ name }}</span></a>{# if( can_edit ) { #}<a
					class="vc_control-btn vc_control-btn-edit"
					href="#"
					title="<?php printf(__('Edit %s', 'js_composer'), '{{ name }}') ?>"><span
						class="vc_btn-content"><span class="icon"></span></span></a>{# } #}{# if( 'edit' !== state ) {
				#}<a
	...
	<div class="vc_controls-column">
		<div class="vc_controls-out-tl">
			<div class="vc_parent parent-{{ parent_tag }}"><a
					...
					title="{# if( parent_can_all ) { #}<?php printf(__('Drag to move %s', 'js_composer'),
					                                                '{{ parent_name }}') ?>{# } #}"><span
						class="vc_btn-content">{{ parent_name }}</span></a><span
					class="vc_advanced{{ switcherPrefix }}">{# if( parent_can_edit ) { #}<a
						class="vc_control-btn vc_control-btn-edit vc_edit" href="#"
						title="<?php printf(__('Edit %s', 'js_composer'), '{{ parent_name }}') ?>"><span
							class="vc_btn-content"><span class="icon"></span></span></a>{# } #}{# if( parent_can_all ) { #}<a
