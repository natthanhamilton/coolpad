...
<form class="vc_ui-prompt">
    ...
    <div class="vc_ui-prompt-content">
        ...
        <div class="vc_ui-prompt-column">
            <button type="buttom"
                    class="vc_general vc_ui-button vc_ui-button-size-sm vc_ui-button-action vc_ui-button-shape-rounded"
                    id="vc_ui-save-preset-btn" disabled><?php _e('Save changes', 'js_composer') ?></button>
        </div>
    </div>
</form>
