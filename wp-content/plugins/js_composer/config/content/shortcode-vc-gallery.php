...
return [
    ...
    'params'      => [
        ...
        [
            ...
            'description' => __('Enter external link for each gallery image (Note: divide links with linebreaks (Enter)).',
                                'js_composer'),
            'dependency'  => [
                'element' => 'source',
                'value'   => 'external_link',
        ...
        [
            ...
            'description' => __('Enter links for each slide (Note: divide links with linebreaks (Enter)).',
                                'js_composer'),
            'dependency'  => [
                'element' => 'onclick',
                'value'   => ['custom_link'],
