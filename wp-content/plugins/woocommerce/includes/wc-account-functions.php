...
function wc_edit_address_i18n($id, $flip = FALSE) {
	$slugs = apply_filters('woocommerce_edit_address_slugs', [
...
function wc_get_account_orders_columns() {
	$columns = apply_filters('woocommerce_account_orders_columns', [
...
function wc_get_account_downloads_columns() {
	return apply_filters('woocommerce_account_downloads_columns', [
...
function wc_get_account_payment_methods_columns() {
	return apply_filters('woocommerce_account_payment_methods_columns', [
...
function wc_get_account_payment_methods_types() {
	return apply_filters('woocommerce_payment_methods_types', [
...
function wc_get_account_saved_payment_methods_list($list, $customer_id) {
	...
	foreach ($payment_tokens as $payment_token) {
		...
		$list[ $type ][ $key ] = apply_filters('woocommerce_payment_methods_list_item', $list[ $type ][ $key ],
		                                       $payment_token);
	}
