...
class WC_REST_Report_Sales_Controller extends WC_REST_Controller {
	...
	public function get_collection_params() {
		return [
			...
			'date_min' => [
				'description'       => sprintf(__('Return sales for a specific start date, the date need to be in the %s format.',
				                                  'woocommerce'), 'YYYY-MM-AA'),
				'type'              => 'string',
				'format'            => 'date',
			...
			'date_max' => [
				'description'       => sprintf(__('Return sales for a specific end date, the date need to be in the %s format.',
				                                  'woocommerce'), 'YYYY-MM-AA'),
				'type'              => 'string',
				'format'            => 'date',
				'validate_callback' => 'wc_rest_validate_reports_request_arg',
