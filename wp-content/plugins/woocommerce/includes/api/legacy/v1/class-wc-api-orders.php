...
class WC_API_Orders extends WC_API_Resource {
	...
	public function get_orders_count($status = NULL, $filter = []) {
		...
		if (!current_user_can('read_private_shop_orders')) {
			return new WP_Error('woocommerce_api_user_cannot_read_orders_count',
	...
	public function get_order_notes($id, $fields = NULL) {
		...
		return ['order_notes' => apply_filters('woocommerce_api_order_notes_response', $order_notes, $id, $fields,
		                                       $notes, $this->server)];
	}
}
