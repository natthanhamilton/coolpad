...
abstract class WC_Payment_Gateway extends WC_Settings_API {
	...
	public function supports($feature) {
		return apply_filters('woocommerce_payment_gateway_supports', in_array($feature, $this->supports) ? TRUE : FALSE,
		                     $feature, $this);
	}
	...
	public function tokenization_script() {
		wp_enqueue_script(
			...
			plugins_url('/assets/js/frontend/tokenization-form' . (defined('SCRIPT_DEBUG') && SCRIPT_DEBUG ? ''
				            : '.min') . '.js', WC_PLUGIN_FILE),
			['jquery'],
			WC()->version
		);
	}
	...
	public function saved_payment_methods() {
		$html
			= '<ul class="woocommerce-SavedPaymentMethods wc-saved-payment-methods" data-count="' . esc_attr(count($this->get_tokens())) . '">';
	...
	public function get_new_payment_method_option_html() {
		$label = apply_filters('woocommerce_payment_gateway_get_new_payment_method_option_html_label',
		                       $this->new_method_label
			                       ? $this->new_method_label : __('Use a new payment method', 'woocommerce'), $this);
		$html  = sprintf(
