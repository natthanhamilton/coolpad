...
if (!class_exists('WC_Email_Failed_Order')) :
	...
	class WC_Email_Failed_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->description
			                      = __('Failed order emails are sent to chosen recipient(s) when orders have been marked failed (if they were previously processing or on-hold).',
			                           'woocommerce');
			...
			add_action('woocommerce_order_status_pending_to_failed_notification', [$this, 'trigger']);
			add_action('woocommerce_order_status_on-hold_to_failed_notification', [$this, 'trigger']);
