...
if (!class_exists('WC_Email_Customer_Invoice')) :
	...
	class WC_Email_Customer_Invoice extends WC_Email {
		...
		public function get_subject() {
			if ($this->object->has_status(['processing', 'completed'])) {
				return apply_filters('woocommerce_email_subject_customer_invoice_paid',
				                     $this->format_string($this->subject_paid), $this->object);
			} else {
				return apply_filters('woocommerce_email_subject_customer_invoice', $this->format_string($this->subject),
				                     $this->object);
			}
		}
		...
		public function get_heading() {
			if ($this->object->has_status(['completed', 'processing'])) {
				return apply_filters('woocommerce_email_heading_customer_invoice_paid',
				                     $this->format_string($this->heading_paid), $this->object);
			} else {
				return apply_filters('woocommerce_email_heading_customer_invoice', $this->format_string($this->heading),
				                     $this->object);
			}
		}
