...
if (!class_exists('WC_Email_Cancelled_Order')) :
	...
	class WC_Email_Cancelled_Order extends WC_Email {
		...
		public function __construct() {
			...
			$this->description
			                      = __('Cancelled order emails are sent to chosen recipient(s) when orders have been marked cancelled (if they were previously processing or on-hold).',
			                           'woocommerce');
			...
			add_action('woocommerce_order_status_pending_to_cancelled_notification', [$this, 'trigger']);
			add_action('woocommerce_order_status_on-hold_to_cancelled_notification', [$this, 'trigger']);
