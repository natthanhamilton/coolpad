...
class WC_Admin_Addons {
	...
	public static function get_sections() {
		if (FALSE === ($sections = get_transient('wc_addons_sections'))) {
			$raw_sections = wp_safe_remote_get('https://d3t0oesq8995hv.cloudfront.net/addon-sections.json',
			                                   ['user-agent' => 'WooCommerce Addons Page']);
	...
	/**
	 * Handles the outputting of a contextually aware Storefront link (points to child themes if Storefront is already
	 * active).
	 */
