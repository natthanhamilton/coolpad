	...
	class WC_Settings_Accounts extends WC_Settings_Page {
		...
		public function get_settings() {
			$settings = apply_filters('woocommerce_' . $this->id . '_settings', [
				['title' => __('Account Pages',
				               'woocommerce'), 'type' => 'title', 'desc' => __('These pages need to be set so that WooCommerce knows where to send users to access account related functionality.',
				                                                               'woocommerce'), 'id' => 'account_page_options'],
				[
					'title'    => __('My Account Page', 'woocommerce'),
					'desc'     => __('Page contents:',
					                 'woocommerce') . ' [' . apply_filters('woocommerce_my_account_shortcode_tag',
				...
				['title' => '', 'type' => 'title', 'id' => 'account_registration_options'],
				[
				...
				[
					...
					'desc'          => __('Display returning customer login reminder on the "Checkout" page',
					                      'woocommerce'),
				...
				['title' => __('My Account Endpoints',
				               'woocommerce'), 'type' => 'title', 'desc' => __('Endpoints are appended to your page URLs to handle specific actions on the accounts pages. They should be unique and can be left blank to disable the endpoint.',
				...
				[
					...
					'desc'     => __('Endpoint for the triggering logout. You can add this to your menus via a custom link: yoursite.com/?customer-logout=true',
					                 'woocommerce'),
