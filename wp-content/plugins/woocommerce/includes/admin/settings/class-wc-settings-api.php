...
if (!class_exists('WC_Settings_Rest_API')) :
	...
	class WC_Settings_Rest_API extends WC_Settings_Page {
		...
		public function __construct() {
			...
			add_action('woocommerce_settings_form_method_tab_' . $this->id, [$this, 'form_method']);
		...
		public function get_settings() {
			$settings = apply_filters('woocommerce_settings_rest_api', [
				[
		...
		public function save() {
			global $current_section;
			if (apply_filters('woocommerce_rest_api_valid_to_save',
			                  !in_array($current_section, ['keys', 'webhooks']))) {
