...
class WC_Report_Customers extends WC_Admin_Report {
	...
	public function get_main_chart() {
		...
		$guest_orders    = $this->prepare_chart_data($guest_orders, 'post_date', 'total_orders', $this->chart_interval,
		                                             $this->start_date, $this->chart_groupby);
	...
	public function customers_vs_guests() {
		...
		<div class="chart-container">
			...
			<ul class="pie-chart-legend">
				<li style="border-color: <?php echo $this->chart_colours['customers']; ?>"><?php _e('Customer Sales',
				                                                                                    'woocommerce'); ?></li>
				<li style="border-color: <?php echo $this->chart_colours['guests']; ?>"><?php _e('Guest Sales',
				                                                                                 'woocommerce'); ?></li>
			</ul>
		</div>
		<script type="text/javascript">
