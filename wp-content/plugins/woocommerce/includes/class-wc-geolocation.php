...
class WC_Geolocation {
	...
	public static function init() {
		...
		if ('geolocation' === get_option('woocommerce_default_customer_address') || apply_filters('woocommerce_geolocation_update_database_periodically',
			...
			add_action('woocommerce_geoip_updater', [__CLASS__, 'update_database']);
		}
		add_filter('pre_update_option_woocommerce_default_customer_address', [__CLASS__, 'maybe_update_database'], 10,
		           2);
	}
	...
	public static function get_local_database_path($version = 'v4') {
		...
		return apply_filters('woocommerce_geolocation_local_database_path',
		                     $upload_dir['basedir'] . '/GeoIP' . $version . '.dat', $version);
	}
