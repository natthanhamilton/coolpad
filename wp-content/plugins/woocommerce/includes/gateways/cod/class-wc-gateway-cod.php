...
class WC_Gateway_COD extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description = __('Have your customers pay with cash (or by other means) upon delivery.',
		                               'woocommerce');
	...
	public function init_form_fields() {
		...
		$this->form_fields = [
			...
			'enable_for_methods' => [
				...
				'css'               => 'width: 450px;',
				'default'           => '',
				'description'       => __('If COD is only available for certain methods, set it up here. Leave blank to enable for all methods.',
				                          'woocommerce'),
	...
	public function process_payment($order_id) {
		...
		$order->update_status(apply_filters('woocommerce_cod_process_payment_order_status',
