...
class WC_Gateway_Cheque extends WC_Payment_Gateway {
	...
	public function __construct() {
		...
		$this->method_description
		                    = __('Allows check payments. Why would you take checks in this day and age? Well you probably wouldn\'t but it does allow you to make test purchases for testing order emails and the \'success\' pages etc.',
		                         'woocommerce');
		// Load the settings.
