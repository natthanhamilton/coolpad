							...
							if (has_action('woocommerce_account_payment_methods_column_' . $column_id)) {
								...
								if ('method' === $column_id) {
									if (!empty ($method['method']['last4'])) {
										echo sprintf(__('%s ending in %s', 'woocommerce'),
...
<?php else : ?>
	...
	<p class="woocommerce-Message woocommerce-Message--info woocommerce-info"><?php esc_html_e('No saved methods found.',
	                                                                                           'woocommerce'); ?></p>
...
<a class="button"
   href="<?php echo esc_url(wc_get_endpoint_url('add-payment-method')); ?>"><?php esc_html_e('Add Payment Method',
                                                                                             'woocommerce'); ?></a>
