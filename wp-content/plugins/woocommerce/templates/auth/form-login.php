...
<p><?php printf(__('To connect to %1$s you need to be logged in. Log in to your store below, or %2$scancel and return to %1$s%3$s',
                   'woocommerce'), wc_clean($app_name), '<a href="' . esc_url($return_url) . '">', '</a>'); ?></p>
...
<form method="post" class="wc-auth-login">
	...
	<p class="wc-auth-actions">
		...
		<input type="submit" class="button button-large button-primary wc-auth-login-button" name="login"
