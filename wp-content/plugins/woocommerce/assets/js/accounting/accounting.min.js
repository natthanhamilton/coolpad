...
!function (a, b) {
    ...
    var k = Array.prototype.map, l = Array.isArray, m = Object.prototype.toString, n = j.unformat = j.parse = function (a, b) {
        ...
        var k = f(e(b) ? b : {
            ...
            thousand: c,
            decimal: i
        }, j.settings.number), l = h(k.precision), m = a < 0 ? "-" : "", q = parseInt(o(Math.abs(a || 0), l), 10) + "", r = q.length > 3 ? q.length % 3 : 0;
        ...
        var o = f(e(b) ? b : {
            ...
            decimal: l,
            format: m
        }, j.settings.currency), r = i(o.format), s = a > 0 ? r.pos : a < 0 ? r.neg : r.zero;
    ...
    j.formatColumn = function (a, b, k, l, m, o) {
        ...
        var q = f(e(b) ? b : {
            ...
            decimal: m,
            format: o
        }, j.settings.currency), r = i(q.format), s = r.pos.indexOf("%s") < r.pos.indexOf("%v"), t = 0, u = g(a, function (a, b) {
            if (d(a))return j.formatColumn(a, q);
            a = n(a);
            var c = a > 0 ? r.pos : a < 0 ? r.neg : r.zero, e = c.replace("%s", q.symbol).replace("%v", p(Math.abs(a), h(q.precision), q.thousand, q.decimal));
