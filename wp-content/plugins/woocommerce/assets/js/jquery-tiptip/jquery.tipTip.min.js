!function (a) {
    a.fn.tipTip = function (b) {
        ...
        if (a("#tiptip_holder").length <= 0) {
            var e = a('<div id="tiptip_holder" style="max-width:' + d.maxWidth + ';"></div>'), f = a('<div id="tiptip_content"></div>'), g = a('<div id="tiptip_arrow"></div>');
            a("body").append(e.html(f).prepend(g.html('<div id="tiptip_arrow_inner"></div>')))
        } else var e = a("#tiptip_holder"), f = a("#tiptip_content"), g = a("#tiptip_arrow");
        return this.each(function () {
            function b() {
                d.enter.call(this), f.html(i), e.hide().removeAttr("class").css("margin", "0"), g.removeAttr("style");
                var b = parseInt(h.offset().top), c = parseInt(h.offset().left), k = parseInt(h.outerWidth()), l = parseInt(h.outerHeight()), m = e.outerWidth(), n = e.outerHeight(), o = Math.round((k - m) / 2), p = Math.round((l - n) / 2), q = Math.round(c + o), r = Math.round(b + l + d.edgeOffset), s = "", t = "", u = Math.round(m - 12) / 2;
                ...
                var v = o + c < parseInt(a(window).scrollLeft()), w = m + c > parseInt(a(window).width());
                ...
                var x = b + l + d.edgeOffset + n + 8 > parseInt(a(window).height() + a(window).scrollTop()), y = b + l - (d.edgeOffset + n + 8) < 0;
            ...
            var h = a(this);
            if (d.content)var i = d.content; else var i = h.attr(d.attribute);
            if ("" != i) {
