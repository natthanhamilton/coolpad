    ...
    function c(c, e, f, g) {
        ...
        function j(b) {
            ...
            var d, e, f, g = {
                ...
                size: Math.round(.8 * (+c.css("font-size").replace("px", "") || 13)),
                variant: c.css("font-variant"),
                weight: c.css("font-weight"),
                family: c.css("font-family")
            };
            for (g.lineHeight = 1.15 * g.size, f = ea.xaxes.length || 1, d = 0; d < f; ++d)e = ea.xaxes[d], e && !e.tickColor && (e.tickColor = e.color), e = a.extend(!0, {}, ea.xaxis, e), ea.xaxes[d] = e, e.font && (e.font = a.extend({}, g, e.font), e.font.color || (e.font.color = e.color));
            for (f = ea.yaxes.length || 1, d = 0; d < f; ++d)e = ea.yaxes[d], e && !e.tickColor && (e.tickColor = e.color), e = a.extend(!0, {}, ea.yaxis, e), ea.yaxes[d] = e, e.font && (e.font = a.extend({}, g, e.font), e.font.color || (e.font.color = e.color));
            ...
            for (var i in pa)ea.hooks[i] && ea.hooks[i].length && (pa[i] = pa[i].concat(ea.hooks[i]));
        ...
        function s() {
            ...
            for (c = 0; c < da.length; ++c) {
                ...
                if (null == g.datapoints.pointsize) {
                    ...
                    for (g.xaxis.used = g.yaxis.used = !0, d = e = 0; d < o.length; ++d, e += j) {
                        m = o[d];
                        var v = null == m;
                        if (!v)for (f = 0; f < j; ++f)k = m[f], l = p[f], l && (l.number && null != k && (k = +k, isNaN(k) ? k = null : k == 1 / 0 ? k = s : k == -(1 / 0) && (k = -s)), null == k && (l.required && (v = !0), null != l.defaultValue && (k = l.defaultValue))), i[e + f] = k;
                        if (v)for (f = 0; f < j; ++f)k = i[e + f], null != k && (l = p[f], l.autoscale && (l.x && b(g.xaxis, k, k), l.y && b(g.yaxis, k, k))), i[e + f] = null; else if (u && e > 0 && null != i[e - j] && i[e - j] != i[e] && i[e - j + 1] != i[e + 1]) {
            ...
            for (c = 0; c < da.length; ++c) {
                ...
                var w = q, x = q, y = r, z = r;
                for (d = 0; d < i.length; d += j)if (null != i[d])for (f = 0; f < j; ++f)k = i[d + f], l = p[f], l && l.autoscale !== !1 && k != s && k != -s && (l.x && (k < w && (w = k), k > y && (y = k)), l.y && (k < x && (x = k), k > z && (z = k)));
                if (g.bars.show) {
                    var A;
                    switch (g.bars.align) {
                        case"left":
        ...
        function t() {
            c.css("padding", 0).children(":not(.flot-base,.flot-overlay)").remove(), "static" == c.css("position") && c.css("position", "relative"), fa = new b("flot-base", c), ga = new b("flot-overlay", c), ia = fa.context, ja = ga.context, ha = a(ga.element).unbind();
            var d = c.data("plot");
        ...
        function x(a) {
            var b = a.options, c = a.ticks || [], d = b.labelWidth || 0, e = b.labelHeight || 0, f = d || "x" == a.direction ? Math.floor(fa.width / (c.length || 1)) : null;
            ...
            for (var g = 0; g < c.length; ++g) {
                var h = c[g];
                if (h.label) {
                    var i = fa.getTextInfo(layer, h.label, font, null, f);
        ...
        function y(b) {
            var c, d = b.labelWidth, e = b.labelHeight, f = b.options.position, g = b.options.tickLength, h = ea.grid.axisMargin, i = ea.grid.labelMargin, j = "x" == b.direction ? ka : la, k = a.grep(j, function (a) {
            ...
            isNaN(+g) || (i += +g), "x" == b.direction ? (e += i, "bottom" == f ? (ma.bottom += e + h, b.box = {
                top: fa.height - ma.bottom,
                height: e
            }) : (b.box = {
                top: ma.top + h,
                height: e
            }, ma.top += e + h)) : (d += i, "left" == f ? (b.box = {
                left: ma.left + h,
                width: d
            }, ma.left += d + h) : (ma.right += d + h, b.box = {
                left: fa.width - ma.right,
                width: d
            })), b.position = f, b.tickLength = g, b.box.padding = i, b.innermost = c
        }
        ...
        function A() {
            var b, c = ea.grid.minBorderMargin, d = {x: 0, y: 0};
            ...
            }), ma.left = Math.max(d.x, ma.left), ma.right = Math.max(d.x, ma.right), ma.top = Math.max(d.y, ma.top), ma.bottom = Math.max(d.y, ma.bottom)
        }
        ...
        function J() {
            ...
            for (var j = 0; j < c.length; ++j) {
                ...
                if (p.show && 0 != p.ticks.length) {
                    for (ia.lineWidth = 1, "x" == p.direction ? (k = 0, l = "full" == r ? "top" == p.position ? 0 : oa : q.top - ma.top + ("top" == p.position ? q.height : 0)) : (l = 0, k = "full" == r ? "left" == p.position ? 0 : na : q.left - ma.left + ("left" == p.position ? q.width : 0)), p.innermost || (ia.strokeStyle = p.options.color, ia.beginPath(), m = o = 0, "x" == p.direction ? m = na + 1 : o = oa + 1, 1 == ia.lineWidth && ("x" == p.direction ? l = Math.floor(l) + .5 : k = Math.floor(k) + .5), ia.moveTo(k, l), ia.lineTo(k + m, l + o), ia.stroke()), ia.strokeStyle = p.options.tickColor, ia.beginPath(), b = 0; b < p.ticks.length; ++b) {
                        var s = p.ticks[b].v;
                        m = o = 0, isNaN(s) || s < p.min || s > p.max || "full" == r && ("object" == typeof d && d[p.position] > 0 || d > 0) && (s == p.min || s == p.max) || ("x" == p.direction ? (k = p.p2c(s), o = "full" == r ? -oa : r, "top" == p.position && (o = -o)) : (l = p.p2c(s), m = "full" == r ? -na : r, "left" == p.position && (m = -m)), 1 == ia.lineWidth && ("x" == p.direction ? k = Math.floor(k) + .5 : l = Math.floor(l) + .5), ia.moveTo(k, l), ia.lineTo(k + m, l + o))
                    }
                    ia.stroke()
                }
            }
                ...
                for (var d = a.points, e = a.pointsize, f = Math.min(Math.max(0, c.min), c.max), g = 0, h = !1, i = 1, j = 0, k = 0; ;) {
                    ...
                    if (null != l && null != n) {
                        ...
                        if (h || (ia.beginPath(), ia.moveTo(b.p2c(l), c.p2c(f)), h = !0), m >= c.max && o >= c.max)ia.lineTo(b.p2c(l), c.p2c(c.max)), ia.lineTo(b.p2c(n), c.p2c(c.max)); else if (m <= c.min && o <= c.min)ia.lineTo(b.p2c(l), c.p2c(c.min)), ia.lineTo(b.p2c(n), c.p2c(c.min)); else {
                            var p = l, q = n;
                            m <= o && m < c.min && o >= c.min ? (l = (c.min - m) / (o - m) * (n - l) + l, m = c.min) : o <= m && o < c.min && m >= c.min && (n = (c.min - m) / (o - m) * (n - l) + l, o = c.min), m >= o && m > c.max && o <= c.max ? (l = (c.max - m) / (o - m) * (n - l) + l, m = c.max) : o >= m && o > c.max && m <= c.max && (n = (c.max - m) / (o - m) * (n - l) + l, o = c.max), l != p && ia.lineTo(b.p2c(p), c.p2c(m)), ia.lineTo(b.p2c(l), c.p2c(m)), ia.lineTo(b.p2c(n), c.p2c(o)), n != q && (ia.lineTo(b.p2c(n), c.p2c(o)), ia.lineTo(b.p2c(q), c.p2c(o)))
                        }
                    }
                }
            }
        ...
        function P(a) {
            function b(b, c, d, e, f, g, h) {
                for (var i = b.points, j = b.pointsize, k = 0; k < i.length; k += j)null != i[k] && O(i[k], i[k + 1], i[k + 2], c, d, e, f, g, h, ia, a.bars.horizontal, a.bars.lineWidth)
            }
            ...
            b(a.datapoints, c, c + a.bars.barWidth, 0, d, a.xaxis, a.yaxis), ia.restore()
        }
        ...
        function R() {
            if (c.find(".legend").remove(), ea.legend.show) {
        ...
        function Z(a, b, c) {
            ...
            var e = _(a, b);
            e == -1 ? (ra.push({series: a, point: b, auto: c}), X()) : c || (ra[e].auto = !1)
        }
        ...
        function ba(b, c) {
            ...
            ja.lineWidth = b.bars.lineWidth, ja.strokeStyle = d, O(c[0], c[1], c[2] || 0, f, f + b.bars.barWidth, 0, function () {
                return e
        ...
        }, qa.shutdown = v, qa.resize = function () {
