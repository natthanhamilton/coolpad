		...
		'email_support' => array(
			...
			'options' => array(
				...
				array(
					...
					'type'    => 'checkbox',
					'default' => false,
					'desc'    => __( 'Shall the connection go through a secure channel?', 'as-email-support' )
				),
				array(
				...
				array(
					...
					'type'    => 'textarea',
					'default' => '<b><i><br><u><ul><ol><li><h1><h2><h3><h4><h5><h6><p>',
					'desc'    => __( 'Which HTML tags should be allowed in incoming emails? Enter just the opening tag, not the closing tag.', 'as-email-support' ),
				),
				array(
					'name' => __( 'Character Set Conversion', 'as-email-support' ),
					'type' => 'heading',
					'desc' => __( 'Do not change anything in this section unless absolutely necessary. Setting this incorrectly will cause all your emails to be rejected by the database.', 'as-email-support' ),
				),
				array(
