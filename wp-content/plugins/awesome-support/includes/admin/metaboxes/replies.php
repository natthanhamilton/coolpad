                ...
                foreach ($history->posts as $row):
                    ...
                    <tr class="wpas-editor wpas-editwrap-<?php echo $row->ID; ?>" style="display:none;">
                        <td colspan="2">
                            ...
                            <input type="submit" id="wpas-edit-submit-<?php echo $row->ID; ?>"
                                   class="button-primary wpas-btn-save-edit"
                                   value="<?php _e('Save changes', 'awesome-support'); ?>">
                            <input type="button" class="wpas-editcancel button-secondary"
                                   data-origin="#wpas-reply-<?php echo $row->ID; ?>"
                                   data-replyid="<?php echo $row->ID; ?>"
                                   data-reply="wpas-editwrap-<?php echo $row->ID; ?>"
                                   data-wysiwygid="wpas-editreply-<?php echo $row->ID; ?>"
                                   value="<?php _e('Cancel', 'awesome-support'); ?>">
                        </td>
                    </tr>
