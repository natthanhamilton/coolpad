 ...
 */
function wpas_tool_link($tool, $args = []) {
	$args['tool']   = $tool;
...
?>
<p><?php _e('These tool are intended for advanced users or for use on the support staff request. Be aware that some of these tools can definitively erase data.',
            'awesome-support'); ?></p>
<table class="widefat wpas-system-tools-table" id="wpas-system-tools">
	...
	<tr>
		...
		<td>
			<a href="<?php echo wpas_tool_link('tickets_metas'); ?>" class="button-secondary"><?php _e('Clear',
			                                                                                           'awesome-support'); ?></a>
			<span class="wpas-system-tools-desc"><?php _e('Clear all transients for all tickets.',
	...
	<tr>
		...
		<td>
			<a href="<?php echo wpas_tool_link('agents_metas'); ?>" class="button-secondary"><?php _e('Clear',
			                                                                                          'awesome-support'); ?></a>
	...
	<tr>
		...
		<td>
			<a href="<?php echo wpas_tool_link('clear_taxonomies'); ?>" class="button-secondary"><?php _e('Clear',
			                                                                                              'awesome-support'); ?></a>
			<span class="wpas-system-tools-desc"><?php _e('Clear all terms from all custom taxonomies.',
			                                              'awesome-support'); ?></span>
		</td>
	</tr>
