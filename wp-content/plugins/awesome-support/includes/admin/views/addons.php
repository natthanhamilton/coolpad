...
<div class="wrap about-wrap">
    <h1>Addons</h1>
    <div class="about-text">Even though Awesome Support has a lot of built-in features, it is impossible to make
        everyone happy. This is why we have lots of addons to help you tailor your support system.
    </div>

    <div class="changelog wpas-addon-all">
        <?php
        if (FALSE === $items):
            ?><p>To check out all our addons please visit <a href="http://getawesomesupport.com/addons" target="_blank">http://getawesomesupport.com/addons</a>
        </p><?php
        else:
            ...
            foreach ($items as $key => $item):
                ...
                <div class="row wpas-addon-item" id="wpas-addon-item-<?php echo intval($item->info->id); ?>">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-7 col-lg-7">
                        <div class="inside">
                            <h3><?php echo esc_attr($item->info->title); ?>
                            ...
                            <div class="wpas-btn-group">
                                <span
                                    ...
                                    href="<?php echo esc_url($item->info->link); ?>&amp;utm_source=plugin&amp;utm_medium=addon_page&amp;utm_campaign=promote_addons"
                                    target="_blank">Details and Buy</a>
                            </div>
                        </div>
                    </div>
                </div>
