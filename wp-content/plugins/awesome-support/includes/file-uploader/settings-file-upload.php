        ...
        'file_upload' => [
            ...
            'options' => [
                [
                    ...
                    'type'    => 'checkbox',
                    'default' => TRUE,
                    'desc'    => __('Do you want to allow your users (and agents) to upload attachments to tickets and replies?',
                                    'awesome-support')
                ],
                [
                ...
                [
                    ...
                    'type'    => 'text',
                    'default' => 2,
                    'desc'    => sprintf(__('What is the maximum size allowed for one file (in <code>MB</code>)? Your server allows up to %s',
                                            'awesome-support'), ini_get('upload_max_filesize'))
                ],
                [
                    ...
                    'desc'    => sprintf(__('Which file types do you allow your users to attach? Please separate each extension by a comma (%s)',
                                            'awesome-support'), '<code>,</code>')
                ],
            ]
        ],
    ];
