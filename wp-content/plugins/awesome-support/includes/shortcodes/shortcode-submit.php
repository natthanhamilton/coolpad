         ...
         */
            ...
            if (FALSE === is_user_logged_in()) {
                echo wpas_get_notification_markup('failure',
                                                  sprintf(__('You need to <a href="%s">log-in</a> to submit a ticket.',
                                                             'awesome-support'), esc_url('')));
            } else {
                /**
                ...
                if (FALSE === wpas_can_submit_ticket()) {
                    echo wpas_get_notification_markup('failure',
                                                      __('You are not allowed to submit a ticket.', 'awesome-support'));
                } /**
                 ...
                 */
                     ...
                     */
                    if (is_user_logged_in() && current_user_can('edit_ticket') && (FALSE === apply_filters('wpas_agent_submit_front_end',
                                                                                                           FALSE))
                    ):
                        /**
                         ...
                         * will not be tracked.
                         */
                        echo wpas_get_notification_markup('info',
                                                          sprintf(__('Sorry, support team members cannot submit tickets from here. If you need to open a ticket, please go to your admin panel or <a href="%s">click here to open a new ticket</a>.',
                                                                     'awesome-support'),
                                                                  add_query_arg(['post_type' => 'ticket'],
