...
class Titan_Framework_Checker_Test extends PHPUnit_Framework_TestCase {
    ...
    function test_display_install_or_active_notice() {
        ...
        if (!function_exists('tgmpa')) {
            ...
            add_filter('tf_framework_checker_regex', [$this, 'titan_regex_fail']);
            ob_start();
            $o->display_install_or_active_notice();
            $result = ob_get_contents();
            ob_end_clean();
            $this->assertNotEmpty($result);
            remove_filter('tf_framework_checker_regex', [$this, 'titan_regex_fail']);
            // Titan is installed, but not activated, show message.
            add_filter('tf_framework_checker_regex', [$this, 'titan_regex_pass']);
            add_filter('tf_framework_checker_titan_class', [$this, 'titan_class_fail']);
            ob_start();
            $o->display_install_or_active_notice();
            $result = ob_get_contents();
            ob_end_clean();
            $this->assertNotEmpty($result);
            remove_filter('tf_framework_checker_titan_class', [$this, 'titan_class_fail']);
            remove_filter('tf_framework_checker_regex', [$this, 'titan_regex_pass']);
            // Titan is installed and activated, don't show message.
            add_filter('tf_framework_checker_regex', [$this, 'titan_regex_pass']);
            add_filter('tf_framework_checker_titan_class', [$this, 'titan_class_pass']);
            ob_start();
            $o->display_install_or_active_notice();
            $result = ob_get_contents();
            ob_end_clean();
            ...
            remove_filter('tf_framework_checker_regex', [$this, 'titan_regex_pass']);
            remove_filter('tf_framework_checker_titan_class', [$this, 'titan_class_pass']);
            function tgmpa() {
            }
        }
        if (function_exists('tgmpa')) {
