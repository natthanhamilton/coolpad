...
class TitanFrameworkOptionUpload extends TitanFrameworkOption {
	...
	function __construct($settings, $owner) {
		...
		add_filter('tf_generate_css_upload_' . $this->getOptionNamespace(), [$this, 'generateCSS'], 10, 2);
		add_action('tf_livepreview_pre_' . $this->getOptionNamespace(), [$this, 'preLivePreview'], 10, 3);
		add_action('tf_livepreview_post_' . $this->getOptionNamespace(), [$this, 'postLivePreview'], 10, 3);
	}
	...
	public function registerCustomizerControl($wp_customize, $section, $priority = 1) {
		$wp_customize->add_control(new TitanFrameworkOptionUploadControl($wp_customize, $this->getID(), [
