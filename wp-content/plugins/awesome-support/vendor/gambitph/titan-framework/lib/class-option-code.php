...
class TitanFrameworkOptionCode extends TitanFrameworkOption {
    ...
    function __construct($settings, $owner) {
        ...
        add_action('customize_controls_enqueue_scripts', [$this, 'loadAdminScripts']);
        // CSS generation for CSS code langs
        add_filter('tf_generate_css_code_' . $this->getOptionNamespace(), [$this, 'generateCSSCode'], 10, 2);
    ...
    public function registerCustomizerControl($wp_customize, $section, $priority = 1) {
        $wp_customize->add_control(new TitanFrameworkOptionCodeControl($wp_customize, $this->getID(), [
