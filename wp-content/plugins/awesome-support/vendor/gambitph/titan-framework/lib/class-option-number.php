    ...
    class TitanFrameworkOptionNumberControl extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            <label class='tf-number'>
                ...
                <input class="<?php echo esc_attr($this->size) ?>-text" min="<?php echo esc_attr($this->min) ?>"
                       max="<?php echo esc_attr($this->max) ?>" step="<?php echo esc_attr($this->step) ?>" type="number"
