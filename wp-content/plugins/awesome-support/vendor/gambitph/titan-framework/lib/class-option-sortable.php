...
class TitanFrameworkOptionSortable extends TitanFrameworkOption {
	...
	function __construct($settings, $owner) {
		...
		add_action('admin_head', [__CLASS__, 'createSortableScript']);
		tf_add_action_once('admin_enqueue_scripts', [$this, 'enqueueSortable']);
		tf_add_action_once('customize_controls_enqueue_scripts', [$this, 'enqueueSortable']);
	}
	...
	public function registerCustomizerControl($wp_customize, $section, $priority = 1) {
		$wp_customize->add_control(new TitanFrameworkOptionSortableControl($wp_customize, $this->getID(), [
