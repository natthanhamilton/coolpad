...
class TitanFrameworkOptionDate extends TitanFrameworkOption {
	...
	function __construct($settings, $owner) {
		...
		tf_add_action_once('admin_enqueue_scripts', [$this, 'enqueueDatepicker']);
		tf_add_action_once('customize_controls_enqueue_scripts', [$this, 'enqueueDatepicker']);
		add_action('admin_head', [__CLASS__, 'createCalendarScript']);
	...
	public function registerCustomizerControl($wp_customize, $section, $priority = 1) {
		$wp_customize->add_control(new TitanFrameworkOptionDateControl($wp_customize, $this->getID(), [
	...
	public function enqueueDatepicker() {
		...
		wp_enqueue_script('tf-jquery-ui-timepicker-addon',
		                  TitanFramework::getURL('../js/min/jquery-ui-timepicker-addon-min.js', __FILE__),
	...
	class TitanFrameworkOptionDateControl extends WP_Customize_Control {
		...
		public function render_content() {
			...
			<label class='tf-date'>
				...
				<input class="input-date<?php echo $class ?>" <?php $this->link(); ?>
