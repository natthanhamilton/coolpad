...
class TitanFrameworkOptionColor extends TitanFrameworkOption {
    ...
    function __construct($settings, $owner) {
        ...
        tf_add_action_once('admin_enqueue_scripts', [$this, 'enqueueColorPickerScript']);
        tf_add_action_once('admin_footer', [$this, 'startColorPicker']);
    }
    ...
    public function registerCustomizerControl($wp_customize, $section, $priority = 1) {
        $wp_customize->add_control(new TitanFrameworkOptionColorControl($wp_customize, $this->getID(), [
    ...
    public function enqueueColorPickerScript() {
        ...
        wp_enqueue_script('wp-color-picker-alpha',
                          TitanFramework::getURL('../js/min/wp-color-picker-alpha-min.js', __FILE__),
                          ['wp-color-picker'], TF_VERSION);
    }
...
function registerTitanFrameworkOptionColorControl() {
    class TitanFrameworkOptionColorControl extends WP_Customize_Color_Control {
        ...
        function __construct($manager, $id, $args = []) {
            ...
            tf_add_action_once('customize_controls_print_footer_scripts', [$this, 'printOpacityOverrideTemplate']);
        }
