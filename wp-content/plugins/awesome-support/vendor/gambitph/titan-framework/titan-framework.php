 ...
 * Description: Titan Framework allows theme and plugin developers to create a admin pages, options, meta boxes, and
 * theme customizer options with just a few simple lines of code. Author: Benjamin Intal, Gambit Version: 1.9.2 Author
 * URI: http://gambit.ph
 */
if (!defined('ABSPATH')) {
...
class TitanFrameworkPlugin {
    ...
    function __construct() {
        ...
        add_action('plugins_loaded', [$this, 'force_load_first'], 10, 1);
