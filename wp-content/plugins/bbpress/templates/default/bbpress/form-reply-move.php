				...
				<fieldset class="bbp-form">
					...
					<div>
						...
						<div class="bbp-template-notice info">
							<p><?php _e('You can either make this reply a new topic with a new title, or merge it into an existing topic.',
							            'bbpress'); ?></p>
						</div>

						<div class="bbp-template-notice">
							<p><?php _e('If you choose an existing topic, replies will be ordered by the time and date they were created.',
							            'bbpress'); ?></p>
						</div>
						...
						<fieldset class="bbp-form">
							...
							<div>
								...
								<label
									for="bbp_reply_move_option_reply"><?php printf(__('New topic in <strong>%s</strong> titled:',
								                                                      'bbpress'),
								                                                   bbp_get_forum_title(bbp_get_reply_forum_id(bbp_get_reply_id()))); ?></label>
							...
							<?php if (bbp_has_topics(['show_stickies' => FALSE, 'post_parent' => bbp_get_reply_forum_id(bbp_get_reply_id()), 'post__not_in' => [bbp_get_reply_topic_id(bbp_get_reply_id())]])) : ?>
								...
								<div>
									...
									<label
										for="bbp_reply_move_option_existing"><?php _e('Use an existing topic in this forum:',
									                                                  'bbpress'); ?></label>
						...
						<div class="bbp-submit-wrapper">
							<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_move_reply_submit"
							        name="bbp_move_reply_submit" class="button submit"><?php _e('Submit',
							                                                                    'bbpress'); ?></button>
						</div>
					</div>
	...
	<?php else : ?>
		...
		<div id="no-reply-<?php bbp_reply_id(); ?>" class="bbp-no-reply">
			<div class="entry-content"><?php is_user_logged_in()
					? _e('You do not have the permissions to edit this reply!', 'bbpress')
					: _e('You cannot edit this reply.', 'bbpress'); ?></div>
		</div>
