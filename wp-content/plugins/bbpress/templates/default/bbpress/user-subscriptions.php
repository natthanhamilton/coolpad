		...
		<div id="bbp-user-subscriptions" class="bbp-user-subscriptions">
			...
			<div class="bbp-user-section">
				...
				<?php else : ?>
					...
					<p><?php bbp_is_user_home() ? _e('You are not currently subscribed to any forums.', 'bbpress')
							: _e('This user is not currently subscribed to any forums.', 'bbpress'); ?></p>
			...
			<div class="bbp-user-section">
				...
				<?php else : ?>
					...
					<p><?php bbp_is_user_home() ? _e('You are not currently subscribed to any topics.', 'bbpress')
							: _e('This user is not currently subscribed to any topics.', 'bbpress'); ?></p>
