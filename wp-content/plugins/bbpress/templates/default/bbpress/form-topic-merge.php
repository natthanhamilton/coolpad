						...
						<fieldset class="bbp-form">
							...
							<div>
								<?php if (bbp_has_topics(['show_stickies' => FALSE, 'post_parent' => bbp_get_topic_forum_id(bbp_get_topic_id()), 'post__not_in' => [bbp_get_topic_id()]])) : ?>
									...
									<label for="bbp_destination_topic"><?php _e('Merge with this topic:',
									                                            'bbpress'); ?></label>
						...
						<fieldset class="bbp-form">
							...
							<div>
								...
								<?php if (bbp_is_subscriptions_active()) : ?>
									...
									<label for="bbp_topic_subscribers"><?php _e('Merge topic subscribers',
									                                            'bbpress'); ?></label><br/>
								...
								<label for="bbp_topic_favoriters"><?php _e('Merge topic favoriters',
								                                           'bbpress'); ?></label><br/>
