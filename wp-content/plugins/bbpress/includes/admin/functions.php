...
function bbp_admin_separator() {
	...
	global $menu;
	$menu[] = ['', 'read', 'separator-bbpress', '', 'wp-menu-separator bbpress'];
}
...
function bbp_do_activation_redirect() {
	...
	wp_safe_redirect(add_query_arg(['page' => 'bbp-about'], admin_url('index.php')));
}
...
function bbp_tools_modify_menu_highlight() {
	...
	if (!in_array($plugin_page, ['bbp-settings'])) {
...
function bbp_get_tools_admin_tabs($active_tab = '') {
	...
	$tabs = apply_filters('bbp_tools_admin_tabs', [
		'0' => [
			'href' => get_admin_url('', add_query_arg(['page' => 'bbp-repair'], 'tools.php')),
			'name' => __('Repair Forums', 'bbpress')
		],
		'1' => [
			'href' => get_admin_url('', add_query_arg(['page' => 'bbp-converter'], 'tools.php')),
			'name' => __('Import Forums', 'bbpress')
		],
		'2' => [
			'href' => get_admin_url('', add_query_arg(['page' => 'bbp-reset'], 'tools.php')),
