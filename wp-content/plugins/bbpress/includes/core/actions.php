...
// Widgets
add_action('bbp_widgets_init', ['BBP_Login_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Views_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Search_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Forums_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Topics_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Replies_Widget', 'register_widget'], 10);
add_action('bbp_widgets_init', ['BBP_Stats_Widget', 'register_widget'], 10);
