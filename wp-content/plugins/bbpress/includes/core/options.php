...
function bbp_get_default_options() {
	// Default options
	return apply_filters('bbp_get_default_options', [
		/** DB Version ********************************************************/
...
function bbp_allow_threaded_replies($default = 0) {
	return (bool)apply_filters('_bbp_allow_threaded_replies',
	                           (bool)get_option('_bbp_allow_threaded_replies', $default));
}
...
function bbp_get_topic_tag_tax_slug($default = 'topic-tag') {
	return apply_filters('bbp_get_topic_tag_tax_slug',
	                     bbp_maybe_get_root_slug() . get_option('_bbp_topic_tag_slug', $default));
}
