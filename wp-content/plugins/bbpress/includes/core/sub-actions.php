 ...
 */
function bbp_profile_update($user_id = 0, $old_user_data = []) {
 ...
 * @return array
 */
function bbp_request($query_vars = []) {
...
function bbp_generate_rewrite_rules($wp_rewrite) {
	do_action_ref_array('bbp_generate_rewrite_rules', [&$wp_rewrite]);
}
 ...
 */
function bbp_map_meta_caps($caps = [], $cap = '', $user_id = 0, $args = []) {
