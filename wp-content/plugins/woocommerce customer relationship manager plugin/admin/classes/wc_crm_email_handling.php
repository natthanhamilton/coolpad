...
class WC_Crm_Email_Handling {
	...
	public static function display_form() {
		...
		if( empty($orders) && !empty($_REQUEST['user_id'])){
...
&nbsp;
	...
	public static function process_form() {
		...
		//save log
			...
			$insert = $wpdb->prepare( "(%s, %s, %s, %s, %s, %s, %s)", current_time('mysql'), $subject, $text, $emails_, $phones_ , $type, get_current_user_id() );

			if ( !empty($insert) )
				$wpdb->query("INSERT INTO $table_name (created, subject, message, user_email, phone, activity_type, user_id) VALUES " . $insert);
