...
class WC_Crm_Phone_Call {
	...
	<div class="panel-wrap woocommerce" id="place_new_call">
        <div id="log_data" class="panel">
			...
			<p>Place a new call with <?php echo $user_name ?> using the fields below. </p>
			<table class="wp-list-table form-table fixed phone_call">
				...
				<tr>
					...
					<td>
						<?php
								if( !empty($user_id) ){
									echo "<input type='text' value='".$user_name."' disabled='disabled'><a class='button tips' href='user-edit.php?user_id=$user_id' target='_blank' id='view_customer_info' data-tip='View Customer Profile'>";
				...
				<tr class="completed_call_wrap disabled">
					...
					<td>
							<div class="wrap_disabled">
								<input type="text" name="call_date" id="call_date">
