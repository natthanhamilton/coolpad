        ...
        <p class="form-field">
            ...
            if (! empty($field['multiple']))
            {
                foreach ((array)$field['value'] as $value)
                {
                    ?><span class="file_url"><input type="text" name="<?php echo esc_attr($name); ?>[]"
                        ...
                        data-uploader_button_text="<?php _e('Use file', 'wp-job-manager'); ?>"><?php _e('Upload', 'wp-job-manager'); ?></button>
                    </span><?php
                }
            }
            else
            ...
            if (! empty($field['multiple']))
            {
                ...
                <button class="button button-small wp_job_manager_add_another_file_button"
                        ...
                        data-uploader_button="<?php _e('Upload', 'wp-job-manager'); ?>"><?php _e('Add file', 'wp-job-manager'); ?></button><?php
            }
            ?>
        </p>
        <?php
        ...
        <p class="form-field">
            ...
            <select name="<?php echo esc_attr($name); ?>" id="<?php echo esc_attr($key); ?>">
                <?php foreach ($field['options'] as $key => $value) : ?>
                    <option
                        value="<?php echo esc_attr($key); ?>" <?php if (isset($field['value'])) selected($field['value'], $key); ?>><?php echo esc_html($value); ?></option>
                <?php endforeach; ?>
            </select>
        </p>
        <?php
    ...
    public static function input_multiselect($key, $field)
    {
        ...
        <p class="form-field">
            ...
            <select multiple="multiple" name="<?php echo esc_attr($name); ?>[]" id="<?php echo esc_attr($key); ?>">
                <?php foreach ($field['options'] as $key => $value) : ?>
                    <option
                        value="<?php echo esc_attr($key); ?>" <?php if (! empty($field['value']) && is_array($field['value'])) selected(in_array($key, $field['value']), TRUE); ?>><?php echo esc_html($value); ?></option>
                <?php endforeach; ?>
            </select>
        </p>
        <?php
    ...
    public static function input_author($key, $field)
    {
        ...
        <p class="form-field form-field-author">
			...
			<span class="hidden change-author">
				...
				<span
                    class="description"><?php _e('Enter the ID of the user, or leave blank if submitted by a guest.', 'wp-job-manager') ?></span>
			</span>
        </p>
        <?php
    }
        ...
        <p class="form-field form-field-checkbox">
            ...
            <?php foreach ($field['options'] as $option_key => $value) : ?>
                <label><input type="radio" class="radio"
                              ...
                              value="<?php echo esc_attr($option_key); ?>" <?php checked($field['value'], $option_key); ?> /> <?php echo esc_html($value); ?>
                </label>
            <?php endforeach; ?>
            <?php if (! empty($field['description'])) : ?><span
                class="description"><?php echo $field['description']; ?></span><?php endif; ?>
