			                                ...
			                                'job_listings'   => [
				                                ...
				                                [
					                                [
						                                ...
						                                'desc'        => __('How many listings should be shown per page by default?',
						                                                    'wp-job-manager'),
						                                'attributes'  => []
					                                ],
					                                [
						                                ...
						                                'desc'       => __('If enabled, filled positions will be hidden from archives.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'cb_label'   => __('Hide content within expired listings',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If enabled, the content within expired listings will be hidden. Otherwise, expired listings will be displayed as normal (without the application area).',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'cb_label'   => __('Enable categories for listings',
						                                                   'wp-job-manager'),
						                                'desc'       => __('Choose whether to enable categories. Categories must be setup by an admin to allow users to choose them during submission.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'cb_label'   => __('Enable category multiselect by default',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If enabled, the category select box will default to a multiselect on the [jobs] shortcode.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'type'    => 'select',
						                                'options' => [
							                                'any' => __('Jobs will be shown if within ANY selected category',
							                                            'wp-job-manager'),
							                                'all' => __('Jobs will be shown if within ALL selected categories',
							                                            'wp-job-manager'),
						                                ]
					                                ],
				                                ],
			                                ...
			                                'job_submission' => [
				                                ...
				                                [
					                                [
						                                ...
						                                'cb_label'   => __('Submitting listings requires an account',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If disabled, non-logged in users will be able to submit listings without creating an account.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'desc'       => __('If enabled, non-logged in users will be able to create an account by entering their email address on the submission form.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'cb_label'   => __('Automatically Generate Username from Email Address',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If enabled, a username will be generated from the first part of the user email address. Otherwise, a username field will be shown.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'desc'    => __('If you enable registration on your submission form, choose a role for the new user.',
						                                                'wp-job-manager'),
						                                'type'    => 'select',
					                                ...
					                                [
						                                ...
						                                'cb_label'   => __('New listing submissions require admin approval',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If enabled, new submissions will be inactive, pending admin approval.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'cb_label'   => __('Submissions awaiting approval can be edited',
						                                                   'wp-job-manager'),
						                                'desc'       => __('If enabled, submissions awaiting admin approval can be edited by the user.',
						                                                   'wp-job-manager'),
						                                'type'       => 'checkbox',
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'desc'       => __('How many <strong>days</strong> listings are live before expiring. Can be left blank to never expire.',
						                                                   'wp-job-manager'),
						                                'attributes' => []
					                                ],
					                                [
						                                ...
						                                'desc'    => __('Choose the contact method for listings.',
						                                                'wp-job-manager'),
						                                'type'    => 'select',
						                                'options' => [
							                                ''      => __('Email address or website URL',
							                                              'wp-job-manager'),
			                                ...
			                                'job_pages'      => [
				                                ...
				                                [
					                                [
						                                ...
						                                'desc'  => __('Select the page where you have placed the [submit_job_form] shortcode. This lets the plugin know where the form is located.',
						                                              'wp-job-manager'),
						                                'type'  => 'page'
					                                ],
					                                [
						                                ...
						                                'desc'  => __('Select the page where you have placed the [job_dashboard] shortcode. This lets the plugin know where the dashboard is located.',
						                                              'wp-job-manager'),
						                                'type'  => 'page'
					                                ],
					                                [
						                                ...
						                                'desc'  => __('Select the page where you have placed the [jobs] shortcode. This lets the plugin know where the job listings page is located.',
						                                              'wp-job-manager'),
						                                'type'  => 'page'
					                                ],
				                                ]
		...
		<div class="wrap job-manager-settings-wrap">
			<form method="post" action="options.php">
				...
				if (!empty($_GET['settings-updated'])) {
					flush_rewrite_rules();
					echo '<div class="updated fade job-manager-updated"><p>' . __('Settings successfully saved',
					                                                              'wp-job-manager') . '</p></div>';
				}
				foreach ($this->settings as $key => $section) {
						...
						switch ($option['type']) {
							case "checkbox" :
								?><label><input id="setting-<?php echo $option['name']; ?>"
								                ...
								                value="1" <?php echo implode(' ', $attributes); ?> <?php checked('1',
								                                                                                 $value); ?> /> <?php echo $option['cb_label']; ?>
								</label><?php
								if ($option['desc']) {
							...
							case "textarea" :
								?><textarea id="setting-<?php echo $option['name']; ?>" class="large-text" cols="50"
								            rows="3" name="<?php echo $option['name']; ?>" <?php echo implode(' ',
								                                                                              $attributes); ?><?php echo $placeholder; ?>><?php echo esc_textarea($value); ?></textarea><?php
								if ($option['desc']) {
									echo ' <p class="description">' . $option['desc'] . '</p>';
								}
								break;
							case "select" :
								?><select id="setting-<?php echo $option['name']; ?>" class="regular-text"
								          name="<?php echo $option['name']; ?>" <?php echo implode(' ',
								                                                                   $attributes); ?>><?php
							...
							case "page" :
								...
								echo str_replace(' id=', " data-placeholder='" . __('Select a page&hellip;',
								                                                    'wp-job-manager') . "' id=",
							...
							case "password" :
								?><input id="setting-<?php echo $option['name']; ?>" class="regular-text"
								         ...
								         value="<?php esc_attr_e($value); ?>" <?php echo implode(' ',
								                                                                 $attributes); ?><?php echo $placeholder; ?> /><?php
								if ($option['desc']) {
									echo ' <p class="description">' . $option['desc'] . '</p>';
								}
								break;
							...
							case "text" :
								...
								break;
							default :
								do_action('wp_job_manager_admin_field_' . $option['type'], $option, $attributes, $value,
								          $placeholder);
								break;
						}
						echo '</td></tr>';
