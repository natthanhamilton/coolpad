...
class WC_Google_Analytics extends WC_Integration {
    ...
    public function __construct() {
        ...
        $this->method_description
                                     = __('Google Analytics is a free service offered by Google that generates detailed statistics about the visitors to a website.',
        ...
        add_action('woocommerce_update_options_integration_google_analytics', [$this, 'process_admin_options']);
        add_action('woocommerce_update_options_integration_google_analytics', [$this, 'show_options_info']);
        add_action('admin_enqueue_scripts', [$this, 'load_admin_assets']);
        // Tracking code
        add_action('wp_head', [$this, 'tracking_code_display'], 999999);
        // Event tracking code
        add_action('woocommerce_after_add_to_cart_button', [$this, 'add_to_cart']);
        add_action('wp_footer', [$this, 'loop_add_to_cart']);
        add_action('woocommerce_after_cart', [$this, 'remove_from_cart']);
        add_action('woocommerce_after_mini_cart', [$this, 'remove_from_cart']);
        add_filter('woocommerce_cart_item_remove_link', [$this, 'remove_from_cart_attributes'], 10, 2);
        add_action('woocommerce_after_shop_loop_item', [$this, 'listing_impression']);
        add_action('woocommerce_after_shop_loop_item', [$this, 'listing_click']);
        add_action('woocommerce_after_single_product', [$this, 'product_detail']);
        add_action('woocommerce_after_checkout_form', [$this, 'checkout_process']);
        // utm_nooverride parameter for Google AdWords
        add_filter('woocommerce_get_return_url', [$this, 'utm_nooverride']);
    }
    ...
    public function init_form_fields() {
        $this->form_fields = [
            'ga_id'                          => [
                ...
                'description' => __('Log into your Google Analytics account to find your ID. e.g. <code>UA-XXXXX-X</code>',
                                    'woocommerce-google-analytics-integration'),
                'type'        => 'text',
            ...
            'ga_set_domain_name'             => [
                ...
                'description' => sprintf(__('(Optional) Sets the <code>_setDomainName</code> variable. <a href="%s">See here for more information</a>.',
                                            'woocommerce-google-analytics-integration'),
            ...
            'ga_standard_tracking_enabled'   => [
                ...
                'description'   => __('This tracks session data such as demographics, system, etc. You don\'t need to enable this if you are using a 3rd party Google analytics plugin.',
                                      'woocommerce-google-analytics-integration'),
                'type'          => 'checkbox',
                'checkboxgroup' => 'start',
                'default'       => get_option('woocommerce_ga_standard_tracking_enabled')
                    ? get_option('woocommerce_ga_standard_tracking_enabled') : 'no'  // Backwards compat
            ],
            'ga_support_display_advertising' => [
                'label'         => __('"Display Advertising" Support', 'woocommerce-google-analytics-integration'),
                'description'   => sprintf(__('Set the Google Analytics code to support Display Advertising. %sRead more about Display Advertising%s.',
                                              'woocommerce-google-analytics-integration'),
                                           '<a href="https://support.google.com/analytics/answer/2700409" target="_blank">',
                                           '</a>'),
                'type'          => 'checkbox',
                'checkboxgroup' => '',
                'default'       => get_option('woocommerce_ga_support_display_advertising')
                    ? get_option('woocommerce_ga_support_display_advertising') : 'no'  // Backwards compat
            ],
            'ga_use_universal_analytics'     => [
                'label'         => __('Enable Universal Analytics', 'woocommerce-google-analytics-integration'),
                'description'   => sprintf(__('Uses Universal Analytics instead of Classic Google Analytics. If you have <strong>not</strong> previously used Google Analytics on this site, check this box. Otherwise, %sfollow step 1 of the Universal Analytics upgrade guide.%s Enabling this setting will take care of step 2. %sRead more about Universal Analytics%s. Universal Analytics must be enabled to enable enhanced eCommerce.',
                                              'woocommerce-google-analytics-integration'),
                                           '<a href="https://developers.google.com/analytics/devguides/collection/upgrade/guide" target="_blank">',
                                           '</a>',
                                           '<a href="https://support.google.com/analytics/answer/2790010?hl=en" target="_blank">',
                                           '</a>'),
                'type'          => 'checkbox',
                'checkboxgroup' => '',
                'default'       => get_option('woocommerce_ga_use_universal_analytics')
                    ? get_option('woocommerce_ga_use_universal_analytics') : 'no'  // Backwards compat
            ],
            'ga_anonymize_enabled'           => [
                'label'         => __('Anonymize IP addresses.', 'woocommerce-google-analytics-integration'),
                'description'   => sprintf(__('Enabling this option is mandatory in certain countries due to national privacy laws. %sRead more about IP Anonymization%s.',
                                              'woocommerce-google-analytics-integration'),
                                           '<a href="https://support.google.com/analytics/answer/2763052" target="_blank">',
                                           '</a>'),
                'type'          => 'checkbox',
                'checkboxgroup' => '',
                'default'       => 'yes'
            ...
            'ga_ecommerce_tracking_enabled'  => [
                ...
                'description'   => __('This requires a payment gateway that redirects to the thank you/order received page after payment. Orders paid with gateways which do not do this will not be tracked.',
                                      'woocommerce-google-analytics-integration'),
                'type'          => 'checkbox',
                'checkboxgroup' => 'start',
                'default'       => get_option('woocommerce_ga_ecommerce_tracking_enabled')
                    ? get_option('woocommerce_ga_ecommerce_tracking_enabled') : 'yes'  // Backwards compat
            ],
            ...
            'ga_enhanced_ecommerce_tracking_enabled' => [
                ...
                'description'   => sprintf(__('Enhanced eCommerce allows you to measure more user interactions with your store, including: product impressions, product detail views, starting the checkout process, adding cart items, and removing cart items. Universal Analytics must be enabled for Enhanced eCommerce to work. Before enabling this setting, turn on Enhanced eCommerce in your Google Analytics dashboard. <a href="%s">See here for more information</a>.',
                                              'woocommerce-google-analytics-integration'),
            ...
            'ga_enhanced_product_impression_enabled' => [
                'label'         => __('Product Impressions from Listing Pages',
                                      'woocommerce-google-analytics-integration'),
                'type'          => 'checkbox',
                'checkboxgroup' => '',
                'default'       => 'yes',
    ...
    function show_options_info() {
        $this->method_description .= "<div class='notice notice-info'><p>" . __('Please allow Google Analytics 24 hours to start displaying results.',
                                                                                'woocommerce-google-analytics-integration') . "</p></div>";
        if (isset($_REQUEST['woocommerce_google_analytics_ga_ecommerce_tracking_enabled']) && TRUE === (bool)$_REQUEST['woocommerce_google_analytics_ga_ecommerce_tracking_enabled']) {
            $this->method_description .= "<div class='notice notice-info'><p>" . __('Please note, for transaction tracking to work properly, you will need to use a payment gateway that redirects the customer back to a WooCommerce order received/thank you page.',
                                                                                    'woocommerce-google-analytics-integration') . "</div>";
        }
    }
    ...
    function load_admin_assets() {
        ...
        wp_enqueue_script('wc-google-analytics-admin-enhanced-settings',
                          plugins_url('/assets/js/admin-enhanced-settings.js', dirname(__FILE__)));
    }
    ...
    protected function get_ecommerce_tracking_code($order_id) {
        ...
        $code = WC_Google_Analytics_JS::get_instance()
                                      ->load_analytics($order);
        $code .= WC_Google_Analytics_JS::get_instance()
                                       ->add_transaction($order);
    ...
    protected function get_standard_tracking_code() {
		...
		" . WC_Google_Analytics_JS::get_instance()
                                  ->header() . "
		<script type='text/javascript'>" . WC_Google_Analytics_JS::get_instance()
                                                                 ->load_analytics() . "</script>
		<!-- /WooCommerce Google Analytics Integration -->";
    }
    ...
    public function add_to_cart() {
        ...
        $parameters['label']    = "'" . esc_js($product->get_sku() ? __('SKU:',
                                                                        'woocommerce-google-analytics-integration') . ' ' . $product->get_sku()
                                                   : "#" . $product->id) . "'";
        if (!$this->disable_tracking($this->ga_enhanced_ecommerce_tracking_enabled)) {
            $code = "" . WC_Google_Analytics_JS::get_instance()
                                               ->tracker_var() . "( 'ec:addProduct', {";
        ...
        WC_Google_Analytics_JS::get_instance()
                              ->event_tracking_code($parameters, '.single_add_to_cart_button');
    }
    ...
    public function remove_from_cart_attributes($url, $key) {
        ...
        $url     = str_replace('href=',
                               'data-product_id="' . esc_attr($product->id) . '" data-product_sku="' . esc_attr($product->get_sku()) . '" href=',
                               $url);
    ...
    public function loop_add_to_cart() {
        ...
        $parameters['action']   = "'" . __('Add to Cart', 'woocommerce-google-analytics-integration') . "'";
        $parameters['label']
                                = "($(this).data('product_sku')) ? ('SKU: ' + $(this).data('product_sku')) : ('#' + $(this).data('product_id'))"; // Product SKU or ID
        if (!$this->disable_tracking($this->ga_enhanced_ecommerce_tracking_enabled)) {
            $code = "" . WC_Google_Analytics_JS::get_instance()
                                               ->tracker_var() . "( 'ec:addProduct', {";
        ...
        WC_Google_Analytics_JS::get_instance()
                              ->event_tracking_code($parameters,
    ...
    public function listing_impression() {
        ...
        WC_Google_Analytics_JS::get_instance()
                              ->listing_impression($product, $woocommerce_loop['loop']);
    }
    ...
    public function listing_click() {
        ...
        global $product, $woocommerce_loop;
        WC_Google_Analytics_JS::get_instance()
                              ->listing_click($product, $woocommerce_loop['loop']);
    }
    ...
    public function checkout_process($checkout) {
        ...
        WC_Google_Analytics_JS::get_instance()
                              ->checkout_process(WC()->cart->get_cart());
    }

    /**
     * Add the utm_nooverride parameter to any return urls. This makes sure Google Adwords doesn't mistake the offsite
     * gateway as the referrer.
     *
