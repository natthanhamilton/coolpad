...
class MC4WP_Request {
	...
	public static function create_from_globals() {
		...
		$server_data = is_array($_SERVER) ? $_SERVER : [];
	...
	public function get_client_ip() {
		...
		if (array_key_exists('HTTP_X_FORWARDED_FOR', $headers) && filter_var($headers['HTTP_X_FORWARDED_FOR'],
