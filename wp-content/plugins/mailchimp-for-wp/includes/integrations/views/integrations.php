	...
	<?php foreach ($integrations as $integration) {
		...
		<tr style="<?php if (!$installed) {
			...
			<td>
				...
				<?php
				if ($installed) {
					printf('<strong><a href="%s" title="%s">%s</a></strong>',
					       add_query_arg(['integration' => $integration->slug]),
					       __('Configure this integration', 'mailchimp-for-wp'), $integration->name);
				} else {
	...
	<div class="main-content row">
		...
		<div class="col col-4">
			...
			<p>
				...
				<?php _e('Click on the name of an integration to edit all settings specific to that integration.',
				         'mailchimp-for-wp'); ?>
			</p>
