...
class MC4WP_Update_Optin {
    ...
    public function add_hooks() {
        add_filter('pre_set_site_transient_update_plugins', [$this, 'maybe_hide_update']);
        ...
        if ($pagenow === 'plugins.php' || $pagenow === 'update-core.php' || $on_settings_page) {
            add_action('admin_notices', [$this, 'show_update_optin']);
        }
    }
    ...
    public function show_update_optin() {
        ...
        // prepare link URL
        $update_link = add_query_arg([$this->option_enable => 1]);
        // show!
