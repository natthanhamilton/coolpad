		...
		<div class="main-content col col-4">
			...
			<form action="<?php echo admin_url('options.php'); ?>" method="post">
				...
				<table class="form-table">
					...
					<tr valign="top">
						<th scope="row"><label for="mailchimp_api_key"><?php _e('API Key',
						...
						<td>
							...
							<p class="help">
								<?php _e('The API key for connecting with your MailChimp account.',
								         'mailchimp-for-wp'); ?>
								<a target="_blank"
								   href="https://admin.mailchimp.com/account/api"><?php _e('Get your API key here.',
								                                                           'mailchimp-for-wp'); ?></a>
							</p>
						</td>
