...
class MC4WP_Form_Asset_Manager {
	...
	public function load_stylesheets() {
		...
		foreach ($stylesheets as $stylesheet) {
			...
			wp_enqueue_style($handle, $this->get_stylesheet_url($stylesheet), [], MC4WP_VERSION);
	...
	public function load_scripts() {
		...
		wp_enqueue_script('mc4wp-forms-api', MC4WP_PLUGIN_URL . 'assets/js/forms-api' . $this->filename_suffix . '.js',
		                  [], MC4WP_VERSION, TRUE);
		...
		wp_enqueue_script('mc4wp-forms-placeholders', MC4WP_PLUGIN_URL . 'assets/js/third-party/placeholders.min.js',
		                  [], MC4WP_VERSION, TRUE);
