...
class MC4WP_Form_Widget extends WP_Widget {
	...
	public function form($settings) {
		...
		<p class="help">
			<?php printf(__('You can edit your sign-up form in the <a href="%s">MailChimp for WordPress form settings</a>.',
			                'mailchimp-for-wp'), admin_url('admin.php?page=mailchimp-for-wp-forms')); ?>
		</p>
		<?php
	}
