...
<div id="mc4wp-admin" class="wrap mc4wp-settings">
	...
	<p class="breadcrumbs">
		...
		<a href="<?php echo admin_url('admin.php?page=mailchimp-for-wp-forms'); ?>"><?php _e('Forms',
		...
		<div class="main-content col col-4">
			...
			<form method="post">
				...
				<div id="titlediv" class="small-margin">
					<div id="titlewrap">
						<label class="screen-reader-text" for="title"><?php _e('Enter form title here',
						...
						<input type="text" name="mc4wp_form[name]" size="30"
						       ...
						       autocomplete="off" placeholder="<?php echo __("Enter the title of your sign-up form",
						                                                     'mailchimp-for-wp'); ?>"
					...
					<div class="inside" style="margin-top: 3px;">
						...
						<a href="#" class="button-secondary" onclick="prompt('<?php echo esc_attr__('Shortcode',
						                                                                            'mailchimp-for-wp'); ?>', document.getElementById('shortcode').value); return false;">
				...
				<h2 class="nav-tab-wrapper" id="mc4wp-tabs-nav">
					<?php foreach ($tabs as $tab => $name) {
						...
						echo sprintf('<a class="nav-tab nav-tab-%s %s" href="%s">%s</a>', $tab, $class,
						             $this->tab_url($tab), $name);
					} ?>
				</h2>
