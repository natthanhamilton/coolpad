...
<div class="mc4wp-admin">
	...
	<div class="help-text">
		...
		<p>
			<?php echo __('To add more fields to your form, you will need to create those fields in MailChimp first.',
			              'mailchimp-for-wp'); ?>
		</p>
		...
		<ol>
			...
			<li>
				<p>
					...
					<?php echo __('Clicking the following links will take you to the right screen.',
					              'mailchimp-for-wp'); ?>
				</p>
					...
					<?php foreach ($lists as $list) { ?>
						<li data-list-id="<?php echo $list->id; ?>"
							...
							<a href="https://admin.mailchimp.com/lists/settings/merge-tags?id=<?php echo $list->web_id; ?>">
								<span class="screen-reader-text"><?php _e('Edit list fields for',
								                                          'mailchimp-for-wp'); ?> </span>
								<?php echo $list->name; ?>
							</a>
						</li>
					<?php } ?>
			...
			<li>
				<p>
					<?php echo __('Click the following button to have MailChimp for WordPress pick up on your changes.',
					              'mailchimp-for-wp'); ?>
				</p>

				<p>
					<a class="button button-primary"
					   href="<?php echo add_query_arg(['_mc4wp_action' => 'empty_lists_cache']); ?>">
