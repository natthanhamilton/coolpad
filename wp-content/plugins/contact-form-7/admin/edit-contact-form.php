...
?>
    <div class="wrap">
        ...
        if ($post) :
            ...
            <form method="post"
                  action="<?php echo esc_url(add_query_arg(['post' => $post_id], menu_page_url('wpcf7', FALSE))); ?>"
                ...
                <input type="hidden" id="wpcf7-locale" name="wpcf7-locale"
                    ...
                    <div id="post-body" class="metabox-holder columns-2">
                            ...
                            <div id="titlediv">
                                <div id="titlewrap">
                                    <label class="screen-reader-text" id="title-prompt-text"
                                           for="title"><?php echo esc_html(__('Enter title here',
                                ...
                                <div class="inside">
                                    ...
                                    if (!$post->initial()) :
                                        ...
                                        <p class="description">
                                            <label
                                                for="wpcf7-shortcode"><?php echo esc_html(__("Copy this shortcode and paste it into your post, page, or text widget content:",
                                                                                             'contact-form-7')); ?></label>
                                    <span class="shortcode wp-ui-highlight"><input type="text" id="wpcf7-shortcode"
                                        ...
                                        <?php
                                        if ($old_shortcode = $post->shortcode(['use_old_format' => TRUE])) :
                                            ?>
                                            <p class="description">
                                                <label
                                                    for="wpcf7-shortcode-old"><?php echo esc_html(__("You can also use this old-style shortcode:",
                                                                                                     'contact-form-7')); ?></label>
                        ...
                        <div id="postbox-container-1" class="postbox-container">
                                    ...
                                    <div class="inside">
                                        <div class="submitbox" id="submitpost">
                                            ...
                                            <div id="minor-publishing-actions">
                                                ...
                                                <div class="hidden">
                                                    <input type="submit" class="button-primary" name="wpcf7-save"
                                                           value="<?php echo esc_attr(__('Save',
                                                                                         'contact-form-7')); ?>"/>
                                                </div>
                                                ...
                                                if (!$post->initial()) :
                                                    $copy_nonce
                                                        = wp_create_nonce('wpcf7-copy-contact-form_' . $post_id);
                                                    ?>
                                                    <input type="submit" name="wpcf7-copy" class="copy button"
                                                           value="<?php echo esc_attr(__('Duplicate',
                                                                                         'contact-form-7')); ?>" <?php echo "onclick=\"this.form._wpnonce.value = '$copy_nonce'; this.form.action.value = 'copy'; return true;\""; ?> />
                                                <?php endif; ?>
                                            ...
                                            <div id="major-publishing-actions">
                                                ...
                                                if (!$post->initial()) :
                                                    $delete_nonce
                                                        = wp_create_nonce('wpcf7-delete-contact-form_' . $post_id);
                                                    ?>
                                                    <div id="delete-action">
                                                        <input type="submit" name="wpcf7-delete"
                                                               class="delete submitdelete"
                                                               value="<?php echo esc_attr(__('Delete',
                                                                                             'contact-form-7')); ?>" <?php echo "onclick=\"if (confirm('" . esc_js(__("You are about to delete this contact form.\n  'Cancel' to stop, 'OK' to delete.",
                                                                                                                                                                      'contact-form-7')) . "')) {this.form._wpnonce.value = '$delete_nonce'; this.form.action.value = 'delete'; return true;} return false;\""; ?> />
                                                    </div><!-- #delete-action -->
                                                <?php endif; ?>
                            ...
                            <div id="informationdiv" class="postbox">
                                ...
                                <div class="inside">
                                    <ul>
                                        <li><?php echo wpcf7_link(__('http://contactform7.com/docs/', 'contact-form-7'),
                                                                  __('Docs', 'contact-form-7')); ?></li>
                                        <li><?php echo wpcf7_link(__('http://contactform7.com/faq/', 'contact-form-7'),
                                                                  __('FAQ', 'contact-form-7')); ?></li>
                                        <li><?php echo wpcf7_link(__('http://contactform7.com/support/',
                                                                     'contact-form-7'),
                                                                  __('Support', 'contact-form-7')); ?></li>
                                    </ul>
                                </div>
                            </div><!-- #informationdiv -->
                        ...
                        <div id="postbox-container-2" class="postbox-container">
                            <div id="contact-form-editor">
                                <div
                                    class="keyboard-interaction"><?php echo sprintf(esc_html(__('%s keys switch panels',
                                                                                                'contact-form-7')),
                                                                                    '<span class="dashicons dashicons-leftright"></span>'); ?></div>
                                ...
                                if (current_user_can('wpcf7_edit_contact_form', $post_id)) {
                                    ...
                                    $panels['additional-settings-panel'] = [
