...
function wpcf7_admin_enqueue_scripts($hook_suffix) {
    ...
    wp_enqueue_script('wpcf7-admin-taggenerator',
                      ...
                      ['jquery', 'thickbox', 'wpcf7-admin'], WPCF7_VERSION, TRUE);
}
...
function wpcf7_admin_management_page() {
    ...
    <div class="wrap">
        ...
        <h1><?php
            ...
            if (current_user_can('wpcf7_edit_contact_forms')) {
                echo ' <a href="' . esc_url(menu_page_url('wpcf7-new',
                                                          FALSE)) . '" class="add-new-h2">' . esc_html(__('Add New',
                                                                                                          'contact-form-7')) . '</a>';
            }
            if (!empty($_REQUEST['s'])) {
...
function wpcf7_admin_bulk_validate_page() {
    ...
    <div class="wrap">
        ...
        <?php echo wpcf7_link(__('http://contactform7.com/configuration-validator-faq/', 'contact-form-7'),
...
function wpcf7_admin_integration_page() {
    ...
    <div class="wrap">
        ...
        if (isset($_REQUEST['service'])
            ...
            $integration->list_services(['include' => $_REQUEST['service']]);
        } else {
...
function wpcf7_admin_updated_message() {
    ...
    if (!empty($updated_message)) {
        echo sprintf('<div id="message" class="updated notice notice-success is-dismissible"><p>%s</p></div>',
                     esc_html($updated_message));

        return;
    }
    if ('validated' == $_REQUEST['message']) {
        $bulk_validate = WPCF7::get_option('bulk_validate', []);
        ...
        if ($count_invalid) {
            ...
            echo sprintf('<div id="message" class="notice notice-warning is-dismissible"><p>%s</p></div>',
                         esc_html($updated_message));
        } else {
            $updated_message = __("Configuration validation completed. No invalid contact form was found.",
                                  'contact-form-7');
            echo sprintf('<div id="message" class="notice notice-success is-dismissible"><p>%s</p></div>',
                         esc_html($updated_message));
        }
...
function wpcf7_old_wp_version_error() {
    ...
    <div class="notice notice-error is-dismissible">
        <p><?php echo sprintf(__('<strong>Contact Form 7 %1$s requires WordPress %2$s or higher.</strong> Please <a href="%3$s">update WordPress</a> first.',
                                 'contact-form-7'), WPCF7_VERSION, WPCF7_REQUIRED_WP_VERSION,
...
function wpcf7_welcome_panel() {
    ...
    <div id="welcome-panel" class="<?php echo esc_attr($classes); ?>">
        ...
        <a class="welcome-panel-close"
           href="<?php echo esc_url(menu_page_url('wpcf7', FALSE)); ?>"><?php echo esc_html(__('Dismiss',
                                                                                               'contact-form-7')); ?></a>
        ...
        <div class="welcome-panel-content">
            <div class="welcome-panel-column-container">
                <div class="welcome-panel-column">
                    ...
                    <p class="message"><?php echo esc_html(__("It is hard to continue development and support for this plugin without contributions from users like you. If you enjoy using Contact Form 7 and find it useful, please consider making a donation.",
                                                              'contact-form-7')); ?></p>
                    <p><?php echo wpcf7_link(__('http://contactform7.com/donate/', 'contact-form-7'),
                                             __('Donate', 'contact-form-7'),
                ...
                <div class="welcome-panel-column">
                    ...
                    <ul>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/getting-started-with-contact-form-7/',
                                                     'contact-form-7'),
                                                  __('Getting Started with Contact Form 7', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/admin-screen/', 'contact-form-7'),
                                                  __('Admin Screen', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/tag-syntax/', 'contact-form-7'),
                                                  __('How Tags Work', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/setting-up-mail/', 'contact-form-7'),
                                                  __('Setting Up Mail', 'contact-form-7')); ?></li>
                    </ul>
                </div>
                ...
                <div class="welcome-panel-column">
                    ...
                    <ul>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/spam-filtering-with-akismet/',
                                                     'contact-form-7'),
                                                  __('Spam Filtering with Akismet', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/save-submitted-messages-with-flamingo/',
                                                     'contact-form-7'),
                                                  __('Save Messages with Flamingo', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/selectable-recipient-with-pipes/',
                                                     'contact-form-7'),
                                                  __('Selectable Recipient with Pipes', 'contact-form-7')); ?></li>
                        <li><?php echo wpcf7_link(__('http://contactform7.com/tracking-form-submissions-with-google-analytics/',
                                                     'contact-form-7'),
                                                  __('Tracking with Google Analytics', 'contact-form-7')); ?></li>
                    </ul>
                </div>
            </div>
        </div>
...
function wpcf7_notice_config_errors() {
    ...
    if ($config_errors = $contact_form->get_config_errors()) {
        ...
        echo sprintf('<div class="notice notice-warning is-dismissible"><p>%s &raquo; %s</p></div>', esc_html($message),
                     $link);
    }
}
...
function wpcf7_notice_bulk_validate_config() {
    ...
    $message = __("Misconfiguration leads to mail delivery failure or other troubles. Validate your contact forms now.",
                  'contact-form-7');
    echo sprintf('<div class="notice notice-warning is-dismissible"><p>%s &raquo; %s</p></div>', esc_html($message),
                 $link);
}
