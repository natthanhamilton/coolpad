...
function wpcf7_add_shortcode_number() {
    wpcf7_add_shortcode(['number', 'number*', 'range', 'range*'],
...
function wpcf7_tag_generator_number($contact_form, $args = '') {
    ...
    $type = 'number';
    $description = __("Generate a form-tag for a field for numeric value input. For more details, see %s.",
                      'contact-form-7');
    $desc_link = wpcf7_link(__('http://contactform7.com/number-fields/', 'contact-form-7'),
                            __('Number Fields', 'contact-form-7'));
    ?>
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <fieldset>
                            ...
                            <select name="tagtype">
                                <option value="number"
                                        selected="selected"><?php echo esc_html(__('Spinbox',
                ...
                <tr>
                    ...
                    <td>
                        <fieldset>
                            <legend
                                class="screen-reader-text"><?php echo esc_html(__('Range',
                                                                                  'contact-form-7')); ?></legend>
                            <label>
