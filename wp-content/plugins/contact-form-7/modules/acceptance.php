...
function wpcf7_acceptance_filter($accepted) {
	...
	$fes = wpcf7_scan_shortcode(['type' => 'acceptance']);
	foreach ($fes as $fe) {
		$name    = $fe['name'];
...
function wpcf7_tag_generator_acceptance($contact_form, $args = '') {
	...
	$desc_link   = wpcf7_link(__('http://contactform7.com/acceptance-checkbox/', 'contact-form-7'),
	                          __('Acceptance Checkbox', 'contact-form-7'));
	?>
				...
				<tr>
					...
					<td>
						<fieldset>
							...
							<label><input type="checkbox" name="default:on"
							              class="option"/> <?php echo esc_html(__('Make this checkbox checked by default',
							                                                      'contact-form-7')); ?>
							</label><br/>
							<label><input type="checkbox" name="invert"
							              class="option"/> <?php echo esc_html(__('Make this work inversely',
							                                                      'contact-form-7')); ?>
							</label>
						</fieldset>
					</td>
