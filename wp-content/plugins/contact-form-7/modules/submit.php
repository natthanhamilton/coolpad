...
function wpcf7_add_tag_generator_submit() {
    ...
    $tag_generator->add('submit', __('submit', 'contact-form-7'),
                        'wpcf7_tag_generator_submit', ['nameless' => 1]);
}
...
function wpcf7_tag_generator_submit($contact_form, $args = '') {
    ...
    $desc_link = wpcf7_link(__('http://contactform7.com/submit-button/', 'contact-form-7'),
                            __('Submit Button', 'contact-form-7'));
    ?>
    <div class="control-box">
        <fieldset>
            ...
            <table class="form-table">
                ...
                <tr>
                    <th scope="row"><label
                            for="<?php echo esc_attr($args['content'] . '-values'); ?>"><?php echo esc_html(__('Label',
