...
function wpcf7_enqueue_scripts() {
	...
	wp_enqueue_script('contact-form-7',
	                  ...
	                  ['jquery', 'jquery-form'], WPCF7_VERSION, $in_footer);
	$_wpcf7 = [
...
function wpcf7_html5_fallback() {
	...
	if (wpcf7_style_is()) {
		wp_enqueue_style('jquery-ui-smoothness',
		                 wpcf7_plugin_url('includes/js/jquery-ui/themes/smoothness/jquery-ui.min.css'), [], '1.10.3',
		                 'screen');
	}
}
